...
* **[Serverless ★ 7951 ⧗ 0](https://github.com/serverless/serverless) ⭐ 46,923 | 🐛 1,213 | 🌐 JavaScript | 📅 2026-09-23** - Serverless is the application framework for building web, mobile and IoT applications exclusively on Amazon Web Services' Lambda and API Gateway.
* **[ESP-IDF ★ 2542 ⧗ 0](https://github.com/espressif/esp-idf) ⭐ 19,078 | 🐛 1,684 | 🌐 C | 📅 2026-09-22** - The official framework from Espressif to build Wi-Fi, BLE, and BT apps with ESP32.
...
* [Thingsboard IoT Gateway ★ 463 ⧗ 246](https://github.com/thingsboard/thingsboard-gateway) ⭐ 2,191 | 🐛 77 | 🌐 Python | 📅 2026-09-22 - open-source IoT Gateway - integrates devices connected to legacy and third-party systems with Thingsboard IoT Platform using OPC-UA and MQTT protocols.
...
* [Kura ★ 85 ⧗ 1](https://github.com/eclipse/kura) ⭐ 580 | 🐛 22 | 🌐 Java | 📅 2026-09-23 - an open-source framework for development of IoT applications
...
* [Jumpstarter ★ 28 ⧗ 0](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 221 | 🐛 144 | 🌐 Python | 📅 2026-09-23 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual IoT hardware with CI/CD integration.
...
* **[ESP8266 Arduino Core ★ 2588 ⧗ 0](https://github.com/esp8266/Arduino) ⭐ 16,688 | 🐛 405 | 🌐 C++ | 📅 2026-08-27** - Arduino core for ESP8266 WiFi chip.

* [Armbian build SDK ★ 630](https://github.com/armbian/build) ⭐ 5,440 | 🐛 119 | 🌐 Shell | 📅 2026-09-23 - for creating customized kernel and Debian based userspace for popular development boards.
...
* [PJON ★ 427 ⧗ 4](https://github.com/gioblu/PJON) ⭐ 2,829 | 🐛 60 | 🌐 C++ | 📅 2025-11-21 - Digital communication framework for Arduino and IOT.
...
* [LK ★ 312 ⧗ 0](https://github.com/littlekernel/lk) ⭐ 3,694 | 🐛 92 | 🌐 C | 📅 2026-09-20 - The LK embedded kernel. An SMP-aware kernel designed for small systems.
...
* [MCUBoot ★ 43 ⧗ 3](https://github.com/runtimeco/mcuboot) ⭐ 2,128 | 🐛 92 | 🌐 C | 📅 2026-09-22 - is a secure bootloader for 32-bit MCUs.
...
* [MQTTX ★ 12 ⧗ 0](https://github.com/emqx/MQTTX) ⭐ 5,064 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-23 - MQTTX is a cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows. It allows users to quickly and easily test MQTT / MQTTS connections, publish and subscribe to MQTT messages.
...
* [HStreamDB ★ 172](https://github.com/hstreamdb/hstream) ⭐ 723 | 🐛 11 | 🌐 Haskell | 📅 2024-12-26 - The streaming database built for IoT data storage and real-time processing.
...
* [Scanners-Box ★ 424 ⧗ 0](https://github.com/We5ter/Scanners-Box) ⭐ 9,060 | 🐛 0 | 📅 2026-09-23 - the toolbox of open source scanners.
...
* [OpenWrt ★ 230 ⧗ 173](https://github.com/openwrt/openwrt) ⭐ 28,501 | 🐛 4,522 | 🌐 C | 📅 2026-09-23 - OpenWrt is described as a Linux distribution for embedded devices.

* [Zephyr ★ 352 ⧗ 5](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,594 | 🐛 4,009 | 🌐 C | 📅 2026-09-23 -  is a small, scalable real-time operating system for use on resource-constrained systems supporting multiple architectures.

* [RT-Thread ★ 493 ⧗ 0](https://github.com/RT-Thread/rt-thread) ⭐ 12,236 | 🐛 492 | 🌐 C | 📅 2026-09-23 - RT-Thread is an open source real-time operating system for embedded devices from China.
...
* [Tock OS ★ 243 ⧗ 1](https://github.com/helena-project/tock) ⭐ 6,446 | 🐛 216 | 🌐 Rust | 📅 2026-09-23 -  is an operating system designed for running multiple concurrent, mutually distrustful applications on Cortex-M based embedded platforms.

* **[RIOT ★ 748 ⧗ 1](https://github.com/RIOT-OS/RIOT) ⭐ 5,805 | 🐛 890 | 🌐 C | 📅 2026-09-23** - The friendly Operating System for the Internet of Things

* **[seL4 Microkernel ★ 1344 ⧗ 1](https://github.com/seL4/seL4) ⭐ 5,762 | 🐛 222 | 🌐 C | 📅 2026-09-23** - The world's first operating-system kernel with an end-to-end proof of implementation correctness and security enforcement is available as open source.
...
* [TinyAra ★ 35 ⧗ 1](https://github.com/Samsung/TinyAra) ⭐ 648 | 🐛 222 | 🌐 C | 📅 2026-09-22 - is a lightweight RTOS-based platform to support low-end IoT devices.
...
* **[Thingsboard ★ 5102 ⧗ 1700](https://github.com/thingsboard/thingsboard) ⭐ 22,469 | 🐛 307 | 🌐 Java | 📅 2026-09-23** - Open-source IoT Platform - Device management, data collection, processing and visualization.
* **[PlatformIO ★ 980 ⧗ 0](https://github.com/platformio/platformio) ⭐ 9,481 | 🐛 275 | 🌐 Python | 📅 2026-09-23** - PlatformIO is a cross-platform code builder and the missing library manager.
* [Fuxa SCADA/HMI/Dashboard ★ 2115 ⧗ 632](https://github.com/frangoteam/FUXA) ⭐ 5,053 | 🐛 398 | 🌐 TypeScript | 📅 2026-09-17 - FUXA is a web-based Process Visualization (SCADA/HMI/Dashboard) software. With FUXA you can create modern process visualizations/dashboards with individual designs for your machines/IOT application with real-time data display. Supports MQTT, OPC-UA, Modbus RTU/TCP, Siemens S7 Protocol, BACnet IP, Ethernet/IP (Allen Bradley), WebAPI
...
* **[IoT DC3 ★ 650 ⧗ 0](https://github.com/pnoker/iot-dc3) ⭐ 1,288 | 🐛 12 | 🌐 Java | 📅 2026-09-23** - A fully open-source, distributed industrial IoT platform built on Spring Cloud, evolving for AI scenarios. Enables rapid IoT project development and connected-device management. [(Docs)](https://docs.dc3.site)
* [HiveMQ ★ 329 ⧗ 0](https://github.com/hivemq/hivemq-community-edition) ⭐ 1,212 | 🐛 28 | 🌐 Java | 📅 2026-09-23 - is an open source MQTT platform and MQTT broker.
...
* [United Manufacturing Hub ★ 9 ⧗ 0](https://github.com/united-manufacturing-hub/united-manufacturing-hub) ⭐ 392 | 🐛 20 | 🌐 Go | 📅 2026-09-23 - The Open-Source Manufacturing App Platform (combines various open source solutions and packages them in a Helm chart, for example nodered, VerneMQ and timescaleDB)
...
* [DeviceChain](https://github.com/devicechain-io/devicechain) ⭐ 4 | 🐛 12 | 🌐 Go | 📅 2026-09-23 - Apache-2.0 self-hosted IoT platform written in Go and React. Multi-tenant microservices on Kubernetes: MQTT/Sparkplug B/LwM2M ingest, TimescaleDB time-series storage, a CEL-based rule engine with alarms and outbound connectors, versioned dashboards, and GraphQL APIs. [(Docs)](https://docs.devicechain.io)
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,719 | 🐛 278 | 🌐 Java | 📅 2026-09-23 - A Multi-protocol event-native edge/service proxy that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* **[Kuzzle ★ 502 ⧗ 0](https://github.com/kuzzleio/kuzzle) ⭐ 1,673 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-23** - An open-source backend with advanced features like real-time pub/sub or geofencing and a multiprotocol interface that supports MQTT, LoRaWAN and more. [(Website)](https://kuzzle.io/solutions/technologies/iot-backend/)
...
* [Shifu ★ 312 ⧗ 0](https://github.com/Edgenesis/shifu) ⭐ 1,436 | 🐛 21 | 🌐 Go | 📅 2026-09-23 - Shifu is a Kubernetes native IoT development framework that supports multi-protocol device access.
...
* [Renode ★ 81 ⧗ 0](https://github.com/renode/renode) ⭐ 2,927 | 🐛 457 | 🌐 RobotFramework | 📅 2026-09-23 - a virtual development tool for multinode embedded networks.
...
* **[ECharts ★ 11457 ⧗ 0](https://github.com/ecomfe/echarts) ⭐ 67,381 | 🐛 1,496 | 🌐 TypeScript | 📅 2026-09-16** - Echarts is a commercial charting solution originally intended to address the report need of the Company's various business systems.
* **[HighCharts ★ 4949 ⧗ 0](https://github.com/highslide-software/highcharts.com) ⭐ 12,491 | 🐛 803 | 🌐 TypeScript | 📅 2026-09-23** - Highcharts JS, the JavaScript charting framework
...
* [Widora ★ 15 ⧗ 21](https://github.com/widora/openwrt_widora) ⭐ 174 | 🐛 5 | 🌐 C | 📅 2025-09-12 - Widora is open source WiFi development hardware prototype with sound card based on MT7688A running [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,501 | 🐛 4,522 | 🌐 C | 📅 2026-09-23.
...
* [Node-RED](https://github.com/node-red/node-red) ⭐ 23,681 | 🐛 350 | 🌐 JavaScript | 📅 2026-09-18 - Node-RED is a programming tool for wiring together hardware devices, APIs and online services in new and interesting ways.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 176 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-14 - Cross-platform Node.js service that reads BLE smart scales, calculates body composition, and exports readings to MQTT with Home Assistant auto-discovery, InfluxDB, Garmin Connect, and webhooks.
...
* **[AirSim ★ 2606 ⧗ 1](https://github.com/Microsoft/AirSim) ⭐ 18,513 | 🐛 781 | 🌐 C++ | 📅 2026-09-15** -  is a simulator for drones (and soon other vehicles) built on Unreal Engine.
...
* **[Sonoff-Tasmota ★ 4869 ⧗ 0](https://github.com/arendst/Sonoff-Tasmota) ⭐ 24,772 | 🐛 19 | 🌐 C | 📅 2026-09-22** - Provide ESP8266 based itead Sonoff with Web, MQTT and OTA firmware using Arduino IDE.
* **[Node-RED ★ 2513 ⧗ 0](https://github.com/node-red/node-red) ⭐ 23,681 | 🐛 350 | 🌐 JavaScript | 📅 2026-09-18** - A visual tool for wiring the Internet of Things.
* **[ESP8266 Deauther ★ 3806 ⧗ 0](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,996 | 🐛 99 | 🌐 C | 📅 2024-08-14** -  allows you to perform a deauth attack with an ESP8266 against selected networks.
* [fluent-bit ★ 90 ⧗ 4](https://github.com/fluent/fluent-bit) ⭐ 8,119 | 🐛 755 | 🌐 C | 📅 2026-09-23 - is a data collector for Linux, Embedded Linux, OSX and BSD family operating systems.
...
* [boto3-refresh-session](https://github.com/michaelthomasletts/boto3-refresh-session) ⭐ 52 | 🐛 1 | 🌐 Python | 📅 2026-09-23 - A drop-in replacement for `boto3.session.Session` for automatically refreshing temporary AWS credentials from the AWS IoT Core credential provider (using an X.509 certificate).
...
* **[MicroPython ★ 3070 ⧗ 0](https://github.com/micropython/micropython) ⭐ 22,089 | 🐛 1,524 | 🌐 C | 📅 2026-09-21** - MicroPython is a lean and fast implementation of the Python 3 programming language that is optimised to run on a microcontroller.
* **[JerryScript ★ 1244 ⧗ 0](https://github.com/Samsung/jerryscript) ⭐ 7,420 | 🐛 250 | 🌐 C | 📅 2025-10-08** - A JavaScript engine for Internet of Things.
* **[luvit ★ 2237 ⧗ 0](https://github.com/luvit/luvit) ⭐ 3,969 | 🐛 95 | 🌐 Lua | 📅 2026-04-02** - Node.JS for the Lua Inventor.
* **[Terra ★ 1248 ⧗ 0](https://github.com/zdevito/terra) ⭐ 2,911 | 🐛 101 | 🌐 C++ | 📅 2026-08-19** - is a low-level system programming language that is embedded in and meta-programmed by the Lua programming language.
* [AtomVM ★ 390 ⧗ 0](https://github.com/bettio/AtomVM) ⭐ 2,239 | 🐛 181 | 🌐 Erlang | 📅 2026-09-23 - AtomVM is a tiny portable virtual machine that allows Erlang and Elixir code to run on microcontrollers with less than 500KB of RAM such as the ESP32.
...
* **[mbed TLS ★ 601 ⧗ 0](https://github.com/ARMmbed/mbedtls) ⭐ 6,966 | 🐛 1,729 | 🌐 C | 📅 2026-09-22** - An open source, portable, easy to use, readable and flexible SSL library
...
* **[EMQX ★ 10300 ⧗ 1800](https://github.com/emqx/emqx) ⭐ 16,753 | 🐛 225 | 🌐 Erlang | 📅 2026-09-23** - An ultra-scalable open-source MQTT broker. Connect 100M+ IoT devices in one single cluster, move and process real-time IoT data with 1M msg/s throughput at 1ms latency.
* [Mosquitto ★ 158 ⧗ 0](https://github.com/eclipse/mosquitto) ⭐ 11,219 | 🐛 889 | 🌐 C | 📅 2026-09-03 - An Open Source MQTT v3.1/v3.1.1 Broker.
* **[MQTT.js ★ 1359 ⧗ 0](https://github.com/mqttjs/MQTT.js) ⭐ 9,114 | 🐛 36 | 🌐 TypeScript | 📅 2026-09-16** - The MQTT client for Node.js and the browser.
...
* **[VerneMQ ★ 561 ⧗ 1](https://github.com/erlio/vernemq) ⭐ 3,637 | 🐛 170 | 🌐 Erlang | 📅 2026-09-17** - A distributed MQTT message broker.
...
* [Node CoAP ★ 176 ⧗ 11](https://github.com/mcollina/node-coap) ⭐ 553 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-12 - node-coap is a client and server library for CoAP modeled after the http module.
...
* [java-coap ★ 3 ⧗ 0](https://github.com/open-coap/java-coap) ⭐ 34 | 🐛 8 | 🌐 Java | 📅 2026-09-23 - Complete CoAP implementation in java (it is a fork with lots of improvements).
...
* **[OpenThread ★ 1139 ⧗ 2](https://github.com/openthread/openthread) ⭐ 4,036 | 🐛 158 | 🌐 C++ | 📅 2026-09-23** - OpenThread is an open-source implementation of the Thread networking protocol.
* [OpenThread Border Router ★ 64 ⧗ 0](https://github.com/openthread/borderrouter) ⭐ 571 | 🐛 49 | 🌐 C++ | 📅 2026-09-22 - An open source border router, built to work with OpenThread.

### Others

* **[libimobiledevice ★ 2294 ⧗ 0](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,207 | 🐛 848 | 🌐 C | 📅 2026-06-10** - A library to communicate with services of Apple iOS devices using native protocols.
...
* [libmodbus ★ 2400 ⧗ 50](https://github.com/stephane/libmodbus) ⭐ 4,255 | 🐛 196 | 🌐 C | 📅 2026-07-02 - A Modbus library for Linux, Mac OS, FreeBSD, QNX and Windows, written in C.
* [pymodbus ★ 2400 ⧗ 100](https://github.com/pymodbus-dev/pymodbus) ⭐ 2,770 | 🐛 0 | 🌐 Python | 📅 2026-09-23 - A full Modbus protocol implementation for Python, supporting RTU, TCP, ASCII over serial and network transports.
...
* **[Servo ★ 7821 ⧗ 0](https://github.com/servo/servo) ⭐ 38,027 | 🐛 3,230 | 🌐 Rust | 📅 2026-09-23** -  is a prototype web browser engine written in the Rust language.
* **[Drake ★ 500 ⧗ 0](https://github.com/RobotLocomotion/drake) ⭐ 4,201 | 🐛 644 | 🌐 C++ | 📅 2026-09-23** -  is a toolbox maintained by the Robot Locomotion Group at the MIT Computer Science and Artificial Intelligence Lab (CSAIL).
* [ShellHub ★ 702 ⧗ 70](https://github.com/shellhub-io/shellhub) ⭐ 2,068 | 🐛 32 | 🌐 Go | 📅 2026-09-23 - Centralized SSH for the the edge and cloud computing.
...
* **[awesome-mqtt ★ 668 ⧗ 0](https://github.com/hobbyquaker/awesome-mqtt) ⭐ 2,399 | 🐛 1 | 📅 2026-09-23** - Curated list of MQTT related stuff.
...
* [100 Days 100 IoT Projects](https://github.com/kritishmohapatra/100_Days_100_IoT_Projects) ⭐ 1,223 | 🐛 0 | 🌐 Python | 📅 2026-07-17 - A 100-day challenge building real-world IoT projects with MicroPython on ESP32, ESP8266 and Raspberry Pi Pico 2W. Step-by-step documented with wiring diagrams and code for beginners.
...
* **[AREG SDK ★ 15 ⧗ 0](https://github.com/aregtech/areg-sdk) ⭐ 366 | 🐛 21 | 🌐 C++ | 📅 2026-09-22** - AREG SDK is a developer-friendly, an interface-centric real-time asynchronous communication engine to enable distributed- and [mist-computing](https://csrc.nist.gov/publications/detail/sp/500-325/final), where connected Things interact and provide services, as if they act like thin distributed servers.
* [Eden ★ 25 ⧗ 0](https://github.com/lf-edge/eden) ⭐ 55 | 🐛 54 | 🌐 Go | 📅 2026-09-23 - CLI for Edge Virtualization Engine (EVE)
...
* [CosmoEdge](https://github.com/cosmo-wander-ai/cosmo-edge) ⭐ 1,228 | 🐛 17 | 🌐 C | 📅 2026-09-23 - Production-oriented C++ edge video AI engine that connects RTSP streams to CV/VLM inference, visual orchestration, alarms, and MQTT/webhook events on Sophon and Rockchip NPUs.
...
* [Genesis 2](https://github.com/larionovavi-stack/genesis2-cascade-moe) ⭐ 2 | 🐛 0 | 🌐 HTML | 📅 2026-09-23 - Cascade MoE neural network for IoT edge deployments. CPU-only inference (18ms), no GPU required, patented architecture with zero catastrophic forgetting.
* [libdeep](https://github.com/bashrc/libdeep) - A deep learning library for C/C++.

## Analytics

* **[NetData ★ 18973 ⧗ 0](https://github.com/firehol/netdata) ⭐ 80,629 | 🐛 409 | 🌐 Go | 📅 2026-09-23** - is a system for distributed real-time performance and health monitoring.
* **[Piwik ★ 5374 ⧗ 0](https://github.com/piwik/piwik) ⭐ 21,893 | 🐛 2,565 | 🌐 PHP | 📅 2026-09-23** - Piwik is the leading Free/Libre open analytics platform.
...
* [Eclipse Ditto](https://github.com/eclipse/ditto) ⭐ 927 | 🐛 94 | 🌐 Java | 📅 2026-09-22 is the open-source project of Eclipse IoT that provides a ready-to-use functionality to manage the state of Digital Twins.
