...
* [Awesome IoT](https://github.com/HQarroum/awesome-iot) ⭐ 4,505 | 🐛 6 | 📅 2026-08-10 - A curated list of awesome Internet of Things projects and resources.
...
* **[Serverless ★ 7951 ⧗ 0](https://github.com/serverless/serverless) ⭐ 46,918 | 🐛 1,216 | 🌐 JavaScript | 📅 2026-09-17** - Serverless is the application framework for building web, mobile and IoT applications exclusively on Amazon Web Services' Lambda and API Gateway.
* **[ESP-IDF ★ 2542 ⧗ 0](https://github.com/espressif/esp-idf) ⭐ 19,040 | 🐛 1,679 | 🌐 C | 📅 2026-09-17** - The official framework from Espressif to build Wi-Fi, BLE, and BT apps with ESP32.
...
* **[GoBot ★ 2062 ⧗ 1](https://github.com/hybridgroup/gobot) ⭐ 9,472 | 🐛 100 | 🌐 Go | 📅 2026-01-07** - Golang framework for robotics, physical computing, and the Internet of Things.
...
* **[.NET Core IoT ★ 1193 ⧗ 292](https://github.com/dotnet/iot) ⭐ 2,411 | 🐛 89 | 🌐 C# | 📅 2026-09-17** - A set of libraries to interact with sensors, displays and input devices from .NET Core framework.
...
* [Thingsboard IoT Gateway ★ 463 ⧗ 246](https://github.com/thingsboard/thingsboard-gateway) ⭐ 2,188 | 🐛 78 | 🌐 Python | 📅 2026-09-17 - open-source IoT Gateway - integrates devices connected to legacy and third-party systems with Thingsboard IoT Platform using OPC-UA and MQTT protocols.
...
* [Kura ★ 85 ⧗ 1](https://github.com/eclipse/kura) ⭐ 575 | 🐛 18 | 🌐 Java | 📅 2026-09-17 - an open-source framework for development of IoT applications
...
* [Jumpstarter ★ 28 ⧗ 0](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 219 | 🐛 174 | 🌐 Python | 📅 2026-09-17 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual IoT hardware with CI/CD integration.
...
* **[ESP8266 Arduino Core ★ 2588 ⧗ 0](https://github.com/esp8266/Arduino) ⭐ 16,685 | 🐛 405 | 🌐 C++ | 📅 2026-08-27** - Arduino core for ESP8266 WiFi chip.

* [Armbian build SDK ★ 630](https://github.com/armbian/build) ⭐ 5,419 | 🐛 135 | 🌐 Shell | 📅 2026-09-17 - for creating customized kernel and Debian based userspace for popular development boards.
...
* **[ArduinoJson ★ 873 ⧗ 0](https://github.com/bblanchon/ArduinoJson) ⭐ 7,216 | 🐛 17 | 🌐 C++ | 📅 2026-08-15** - An elegant and efficient JSON library for embedded systems.
* [WiringPi ★ 455 ⧗ 11](https://github.com/WiringPi/WiringPi) ⭐ 3,342 | 🐛 41 | 🌐 C | 📅 2026-09-02 - Gordon's Arduino wiring-like WiringPi Library for the Raspberry Pi.
...
* [LK ★ 312 ⧗ 0](https://github.com/littlekernel/lk) ⭐ 3,692 | 🐛 92 | 🌐 C | 📅 2026-09-16 - The LK embedded kernel. An SMP-aware kernel designed for small systems.
* [inih ★ 312 ⧗ 3](https://github.com/benhoyt/inih) ⭐ 3,044 | 🐛 7 | 🌐 C++ | 📅 2026-01-30 - is a simple .INI file parser written in C.
* **[nexmon ★ 885 ⧗ 2](https://github.com/seemoo-lab/nexmon) ⭐ 2,888 | 🐛 347 | 🌐 C | 📅 2026-09-14** -  is our C-based firmware patching framework for Broadcom/Cypress WiFi chips.
* **[simbody ★ 540 ⧗ 0](https://github.com/simbody/simbody) ⭐ 2,550 | 🐛 159 | 🌐 C++ | 📅 2026-09-17** - High-performance C++ multibody dynamics/physics library for simulating articulated biomechanical and mechanical systems like vehicles, robots, and the human skeleton.
...
* [btstack ★ 151 ⧗ 1](https://github.com/bluekitchen/btstack) ⭐ 2,138 | 🐛 77 | 🌐 C | 📅 2026-09-17 - Dual-mode Bluetooth stack, with small memory footprint.
* [MCUBoot ★ 43 ⧗ 3](https://github.com/runtimeco/mcuboot) ⭐ 2,118 | 🐛 95 | 🌐 C | 📅 2026-09-15 - is a secure bootloader for 32-bit MCUs.
* [CocoaMQTT ★ 210 ⧗ 0](https://github.com/emqtt/CocoaMQTT) ⭐ 1,752 | 🐛 111 | 🌐 Swift | 📅 2026-09-08 - MQTT for iOS and OS X written with Swift.
* [SPIFFS ★ 174 ⧗ 0](https://github.com/pellepl/spiffs) ⭐ 1,628 | 🐛 104 | 🌐 C | 📅 2026-07-16 - Wear-leveled SPI flash file system for embedded devices.
...
* [XiPKI ★ 34 ⧗ 10](https://github.com/xipki/xipki) ⭐ 605 | 🐛 1 | 🌐 Java | 📅 2026-09-07 - eXtensible sImple Public Key Infrastructure consists of CA and OCSP responder.
* [xkcptun ★ 104 ⧗ 25](https://github.com/liudf0716/xkcptun) ⭐ 484 | 🐛 11 | 🌐 C | 📅 2026-09-06 - xkcptun is kcp tunnel for OpenWRT\&LEDE, implemented in c language
...
* [MQTTX ★ 12 ⧗ 0](https://github.com/emqx/MQTTX) ⭐ 5,059 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-16 - MQTTX is a cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows. It allows users to quickly and easily test MQTT / MQTTS connections, publish and subscribe to MQTT messages.
...
* [ReductStore ★ 360](https://github.com/reductstore/reductstore) ⭐ 371 | 🐛 12 | 🌐 Rust | 📅 2026-09-17 - high-performance blob and time-series storage for industrial IoT, with edge deployment, selective replication, and efficient querying of multimodal data.
* [AimDB ★ 2](https://github.com/aimdb-dev/aimdb) ⭐ 99 | 🐛 3 | 🌐 Rust | 📅 2026-09-15 - An async, in-memory data bridge that syncs records across microcontrollers, edge gateways and cloud instances. Define once, stream and sync everywhere.
...
* [Scanners-Box ★ 424 ⧗ 0](https://github.com/We5ter/Scanners-Box) ⭐ 9,049 | 🐛 0 | 📅 2026-09-17 - the toolbox of open source scanners.
...
* [OpenWrt ★ 230 ⧗ 173](https://github.com/openwrt/openwrt) ⭐ 28,440 | 🐛 4,469 | 🌐 C | 📅 2026-09-17 - OpenWrt is described as a Linux distribution for embedded devices.

* [Zephyr ★ 352 ⧗ 5](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,555 | 🐛 3,932 | 🌐 C | 📅 2026-09-17 -  is a small, scalable real-time operating system for use on resource-constrained systems supporting multiple architectures.

* [RT-Thread ★ 493 ⧗ 0](https://github.com/RT-Thread/rt-thread) ⭐ 12,223 | 🐛 487 | 🌐 C | 📅 2026-09-17 - RT-Thread is an open source real-time operating system for embedded devices from China.
...
* [Tock OS ★ 243 ⧗ 1](https://github.com/helena-project/tock) ⭐ 6,444 | 🐛 221 | 🌐 Rust | 📅 2026-09-17 -  is an operating system designed for running multiple concurrent, mutually distrustful applications on Cortex-M based embedded platforms.

* **[RIOT ★ 748 ⧗ 1](https://github.com/RIOT-OS/RIOT) ⭐ 5,801 | 🐛 879 | 🌐 C | 📅 2026-09-17** - The friendly Operating System for the Internet of Things

* **[seL4 Microkernel ★ 1344 ⧗ 1](https://github.com/seL4/seL4) ⭐ 5,748 | 🐛 221 | 🌐 C | 📅 2026-09-17** - The world's first operating-system kernel with an end-to-end proof of implementation correctness and security enforcement is available as open source.
...
* [Lua-RTOS-ESP32 ★ 131 ⧗ 2](https://github.com/whitecatboard/Lua-RTOS-ESP32) ⭐ 1,332 | 🐛 42 | 🌐 C | 📅 2026-04-29 - is a real-time operating system designed to run on embedded systems, with minimal requirements of FLASH and RAM memory.
...
* [Mynewt](https://github.com/apache/mynewt-core) ⭐ 891 | 🐛 98 | 🌐 C | 📅 2026-09-17 is an open-source operating system for tiny embedded devices. Its goal is to make it easy to develop applications for microcontroller environments where power and cost are driving factors.
...
* [TinyAra ★ 35 ⧗ 1](https://github.com/Samsung/TinyAra) ⭐ 648 | 🐛 216 | 🌐 C | 📅 2026-09-17 - is a lightweight RTOS-based platform to support low-end IoT devices.
...
* **[Thingsboard ★ 5102 ⧗ 1700](https://github.com/thingsboard/thingsboard) ⭐ 22,437 | 🐛 314 | 🌐 Java | 📅 2026-09-17** - Open-source IoT Platform - Device management, data collection, processing and visualization.
* **[PlatformIO ★ 980 ⧗ 0](https://github.com/platformio/platformio) ⭐ 9,465 | 🐛 275 | 🌐 Python | 📅 2026-09-15** - PlatformIO is a cross-platform code builder and the missing library manager.
* [Fuxa SCADA/HMI/Dashboard ★ 2115 ⧗ 632](https://github.com/frangoteam/FUXA) ⭐ 5,027 | 🐛 398 | 🌐 TypeScript | 📅 2026-09-12 - FUXA is a web-based Process Visualization (SCADA/HMI/Dashboard) software. With FUXA you can create modern process visualizations/dashboards with individual designs for your machines/IOT application with real-time data display. Supports MQTT, OPC-UA, Modbus RTU/TCP, Siemens S7 Protocol, BACnet IP, Ethernet/IP (Allen Bradley), WebAPI
...
* **[IoT DC3 ★ 650 ⧗ 0](https://github.com/pnoker/iot-dc3) ⭐ 1,275 | 🐛 32 | 🌐 Java | 📅 2026-09-08** - A fully open-source, distributed industrial IoT platform built on Spring Cloud, evolving for AI scenarios. Enables rapid IoT project development and connected-device management. [(Docs)](https://docs.dc3.site)
* [HiveMQ ★ 329 ⧗ 0](https://github.com/hivemq/hivemq-community-edition) ⭐ 1,209 | 🐛 27 | 🌐 Java | 📅 2026-09-17 - is an open source MQTT platform and MQTT broker.
...
* [United Manufacturing Hub ★ 9 ⧗ 0](https://github.com/united-manufacturing-hub/united-manufacturing-hub) ⭐ 391 | 🐛 23 | 🌐 Go | 📅 2026-09-17 - The Open-Source Manufacturing App Platform (combines various open source solutions and packages them in a Helm chart, for example nodered, VerneMQ and timescaleDB)
...
* [DeviceChain](https://github.com/devicechain-io/devicechain) ⭐ 3 | 🐛 15 | 🌐 Go | 📅 2026-09-17 - Apache-2.0 self-hosted IoT platform written in Go and React. Multi-tenant microservices on Kubernetes: MQTT/Sparkplug B/LwM2M ingest, TimescaleDB time-series storage, a CEL-based rule engine with alarms and outbound connectors, versioned dashboards, and GraphQL APIs. [(Docs)](https://docs.devicechain.io)
...
* [ForestHub](https://foresthub.ai) - Edge AI agent platform; its open-source runtime [edge-agents](https://github.com/ForestHubAI/edge-agents) ⭐ 103 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 runs AI agents offline on Linux edge gateways with local SLMs, cloud LLMs and MQTT as first-class nodes.
...
* [OGC SensorThings API ★ 21 ⧗ 15](https://github.com/opengeospatial/sensorthings) ⭐ 169 | 🐛 95 | 📅 2026-09-15 - The OGC SensorThings API is an OGC standard specification for providing an open and unified way to interconnect IoT devices, data, and applications over the Web
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,724 | 🐛 258 | 🌐 Java | 📅 2026-09-17 - A Multi-protocol event-native edge/service proxy that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* **[Kuzzle ★ 502 ⧗ 0](https://github.com/kuzzleio/kuzzle) ⭐ 1,673 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-17** - An open-source backend with advanced features like real-time pub/sub or geofencing and a multiprotocol interface that supports MQTT, LoRaWAN and more. [(Website)](https://kuzzle.io/solutions/technologies/iot-backend/)
* [Kaa ★ 234 ⧗ 0](https://github.com/kaaproject/kaa) ⭐ 1,436 | 🐛 9 | 📅 2024-11-05 - Kaa open-source middleware platform for building, managing, and integrating connected products with the Internet of Everything.
* [Shifu ★ 312 ⧗ 0](https://github.com/Edgenesis/shifu) ⭐ 1,435 | 🐛 26 | 🌐 Go | 📅 2026-09-14 - Shifu is a Kubernetes native IoT development framework that supports multi-protocol device access.
...
* [Renode ★ 81 ⧗ 0](https://github.com/renode/renode) ⭐ 2,904 | 🐛 451 | 🌐 RobotFramework | 📅 2026-09-17 - a virtual development tool for multinode embedded networks.
...
* [Electrum ★ 4 ⧗ 1](https://github.com/yoelf22/electrum) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2026-07-17 - A structured, AI-assisted toolkit for defining hardware products that have software inside — from concept through engineering spec to presentation-ready materials in eight phases.
...
* **[D3.JS ★ 49188 ⧗ 0](https://github.com/mbostock/d3) ⭐ 113,741 | 🐛 20 | 🌐 Shell | 📅 2026-05-28** - A JavaScript visualization library for HTML and SVG
* **[ECharts ★ 11457 ⧗ 0](https://github.com/ecomfe/echarts) ⭐ 67,346 | 🐛 1,505 | 🌐 TypeScript | 📅 2026-09-16** - Echarts is a commercial charting solution originally intended to address the report need of the Company's various business systems.
* **[HighCharts ★ 4949 ⧗ 0](https://github.com/highslide-software/highcharts.com) ⭐ 12,490 | 🐛 805 | 🌐 TypeScript | 📅 2026-09-17** - Highcharts JS, the JavaScript charting framework
...
* [Widora ★ 15 ⧗ 21](https://github.com/widora/openwrt_widora) ⭐ 174 | 🐛 5 | 🌐 C | 📅 2025-09-12 - Widora is open source WiFi development hardware prototype with sound card based on MT7688A running [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,440 | 🐛 4,469 | 🌐 C | 📅 2026-09-17.
...
* **[Homebridge ★ 3030 ⧗ 0](https://github.com/nfarina/homebridge) ⭐ 25,494 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-30** - Homebridge is a lightweight NodeJS server you can run on your home network that emulates the iOS HomeKit API.
* [Node-RED](https://github.com/node-red/node-red) ⭐ 23,660 | 🐛 345 | 🌐 JavaScript | 📅 2026-09-09 - Node-RED is a programming tool for wiring together hardware devices, APIs and online services in new and interesting ways.
...
* **[heimcontrol.js ★ 1306 ⧗ 4](https://github.com/ni-c/heimcontrol.js) ⚠️ Archived** -  Home-Automation with node.js and Raspberry PI
* **[openHAB ★ 2536 ⧗ 0](https://github.com/openhab/openhab-distro) ⭐ 1,391 | 🐛 71 | 🌐 PowerShell | 📅 2026-09-15** - a vendor and technology agnostic open source automation software for your home.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 173 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-14 - Cross-platform Node.js service that reads BLE smart scales, calculates body composition, and exports readings to MQTT with Home Assistant auto-discovery, InfluxDB, Garmin Connect, and webhooks.
...
* [homebridge-blink-security](https://github.com/BitWise-0x/homebridge-blink-security) ⭐ 14 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-15 - Homebridge plugin for Blink cameras, doorbells, and sirens with live streaming, arm/disarm, and motion detection via Apple HomeKit.
* [homebridge-smartrent](https://github.com/BitWise-0x/homebridge-smartrent) ⭐ 4 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-15 - Homebridge plugin for SmartRent locks, thermostats, leak sensors, and switches with real-time WebSocket updates via Apple HomeKit.
...
* **[AirSim ★ 2606 ⧗ 1](https://github.com/Microsoft/AirSim) ⭐ 18,490 | 🐛 780 | 🌐 C++ | 📅 2026-09-15** -  is a simulator for drones (and soon other vehicles) built on Unreal Engine.
...
* **[Sonoff-Tasmota ★ 4869 ⧗ 0](https://github.com/arendst/Sonoff-Tasmota) ⭐ 24,762 | 🐛 22 | 🌐 C | 📅 2026-09-13** - Provide ESP8266 based itead Sonoff with Web, MQTT and OTA firmware using Arduino IDE.
* **[Node-RED ★ 2513 ⧗ 0](https://github.com/node-red/node-red) ⭐ 23,660 | 🐛 345 | 🌐 JavaScript | 📅 2026-09-09** - A visual tool for wiring the Internet of Things.
* **[ESP8266 Deauther ★ 3806 ⧗ 0](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,977 | 🐛 99 | 🌐 C | 📅 2024-08-14** -  allows you to perform a deauth attack with an ESP8266 against selected networks.
* [fluent-bit ★ 90 ⧗ 4](https://github.com/fluent/fluent-bit) ⭐ 8,111 | 🐛 760 | 🌐 C | 📅 2026-09-17 - is a data collector for Linux, Embedded Linux, OSX and BSD family operating systems.
...
* [boto3-refresh-session](https://github.com/michaelthomasletts/boto3-refresh-session) ⭐ 52 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - A drop-in replacement for `boto3.session.Session` for automatically refreshing temporary AWS credentials from the AWS IoT Core credential provider (using an X.509 certificate).
...
* **[MicroPython ★ 3070 ⧗ 0](https://github.com/micropython/micropython) ⭐ 22,069 | 🐛 1,533 | 🌐 C | 📅 2026-09-16** - MicroPython is a lean and fast implementation of the Python 3 programming language that is optimised to run on a microcontroller.
...
* [AtomVM ★ 390 ⧗ 0](https://github.com/bettio/AtomVM) ⭐ 2,234 | 🐛 186 | 🌐 Erlang | 📅 2026-09-15 - AtomVM is a tiny portable virtual machine that allows Erlang and Elixir code to run on microcontrollers with less than 500KB of RAM such as the ESP32.
* **[PikaScript ★ 660 ⧗ 36](https://github.com/pikasTech/pikaScript) ⭐ 1,754 | 🐛 28 | 🌐 C | 📅 2026-09-11** - PikaScript is a extremely lightweight python engine that can run with less than 4KB of RAM such as stm32g030c8 and stm32f103c8. It is zero dependency, zero configuration, easy to deploy and expand.
...
* **[mbed TLS ★ 601 ⧗ 0](https://github.com/ARMmbed/mbedtls) ⭐ 6,958 | 🐛 1,655 | 🌐 C | 📅 2026-09-17** - An open source, portable, easy to use, readable and flexible SSL library
* **[UniK ★ 593 ⧗ 0](https://github.com/emc-advanced-dev/unik) ⭐ 2,824 | 🐛 51 | 🌐 Go | 📅 2023-04-27** -  is a tool for compiling application sources into unikernels (lightweight bootable disk images) rather than binaries.
...
* **[EMQX ★ 10300 ⧗ 1800](https://github.com/emqx/emqx) ⭐ 16,735 | 🐛 210 | 🌐 Erlang | 📅 2026-09-17** - An ultra-scalable open-source MQTT broker. Connect 100M+ IoT devices in one single cluster, move and process real-time IoT data with 1M msg/s throughput at 1ms latency.
* [Mosquitto ★ 158 ⧗ 0](https://github.com/eclipse/mosquitto) ⭐ 11,197 | 🐛 827 | 🌐 C | 📅 2026-09-03 - An Open Source MQTT v3.1/v3.1.1 Broker.
* **[MQTT.js ★ 1359 ⧗ 0](https://github.com/mqttjs/MQTT.js) ⭐ 9,115 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-16** - The MQTT client for Node.js and the browser.
...
* **[VerneMQ ★ 561 ⧗ 1](https://github.com/erlio/vernemq) ⭐ 3,633 | 🐛 168 | 🌐 Erlang | 📅 2026-09-17** - A distributed MQTT message broker.
...
* [Eclipse Paho MQTT C client ★ 142 ⧗ 3](https://github.com/eclipse/paho.mqtt.c) ⭐ 2,369 | 🐛 222 | 🌐 C | 📅 2026-09-09 - This code builds libraries which enable applications to connect to an MQTT broker to publish messages, and to subscribe to topics and receive published messages.
...
* [WolfSSL MQTT ★ 155 ⧗ 14](https://github.com/wolfSSL/wolfMQTT) ⭐ 593 | 🐛 5 | 🌐 C | 📅 2026-09-16 - A C MQTT library that works with WolfSSL.
...
* [Californium ★ 36 ⧗ 0](https://github.com/eclipse/californium) ⭐ 778 | 🐛 24 | 🌐 Java | 📅 2026-09-14 - Californium is a Java implementation of CoAP for the IoT backend and less constrained IoT devices.
...
* **[OpenThread ★ 1139 ⧗ 2](https://github.com/openthread/openthread) ⭐ 4,032 | 🐛 157 | 🌐 C++ | 📅 2026-09-17** - OpenThread is an open-source implementation of the Thread networking protocol.
* [OpenThread Border Router ★ 64 ⧗ 0](https://github.com/openthread/borderrouter) ⭐ 570 | 🐛 47 | 🌐 C++ | 📅 2026-09-17 - An open source border router, built to work with OpenThread.

### Others

* **[libimobiledevice ★ 2294 ⧗ 0](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,194 | 🐛 846 | 🌐 C | 📅 2026-06-10** - A library to communicate with services of Apple iOS devices using native protocols.
...
* [libmodbus ★ 2400 ⧗ 50](https://github.com/stephane/libmodbus) ⭐ 4,251 | 🐛 190 | 🌐 C | 📅 2026-07-02 - A Modbus library for Linux, Mac OS, FreeBSD, QNX and Windows, written in C.
* [pymodbus ★ 2400 ⧗ 100](https://github.com/pymodbus-dev/pymodbus) ⭐ 2,768 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - A full Modbus protocol implementation for Python, supporting RTU, TCP, ASCII over serial and network transports.
...
* [libnfc ★ 119 ⧗ 4](https://github.com/nfc-tools/libnfc) ⭐ 1,989 | 🐛 120 | 🌐 C | 📅 2025-03-05 - Platform independent Near Field Communication library.
* [RFIDIOt ★ 314 ⧗ 6](https://github.com/AdamLaurie/RFIDIOt) ⭐ 1,119 | 🐛 23 | 🌐 Python | 📅 2026-09-14 - python RFID / NFC library & tools.
...
* **[Servo ★ 7821 ⧗ 0](https://github.com/servo/servo) ⭐ 38,002 | 🐛 3,200 | 🌐 Rust | 📅 2026-09-17** -  is a prototype web browser engine written in the Rust language.
* **[Drake ★ 500 ⧗ 0](https://github.com/RobotLocomotion/drake) ⭐ 4,193 | 🐛 645 | 🌐 C++ | 📅 2026-09-17** -  is a toolbox maintained by the Robot Locomotion Group at the MIT Computer Science and Artificial Intelligence Lab (CSAIL).
* [ShellHub ★ 702 ⧗ 70](https://github.com/shellhub-io/shellhub) ⭐ 2,067 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-17 - Centralized SSH for the the edge and cloud computing.
* [The Things Stack ★ 887 ⧗ 4](https://github.com/TheThingsNetwork/lorawan-stack) ⭐ 1,162 | 🐛 185 | 🌐 Go | 📅 2026-09-15 - The Things Stack, an open source LoRaWAN network server created by The Things Industries. Creators of the global open crowdsourced Internet of Things data network The Things Network.
...
* [Balena ★ 329 ⧗ 3](https://github.com/resin-os/balena) ⭐ 742 | 🐛 94 | 🌐 Go | 📅 2026-09-17 -  is a new container engine purpose-built for embedded and IoT use cases and compatible with Docker containers.
...
* **[awesome-mqtt ★ 668 ⧗ 0](https://github.com/hobbyquaker/awesome-mqtt) ⭐ 2,398 | 🐛 2 | 📅 2026-09-01** - Curated list of MQTT related stuff.
...
* **[AREG SDK ★ 15 ⧗ 0](https://github.com/aregtech/areg-sdk) ⭐ 366 | 🐛 24 | 🌐 C++ | 📅 2026-09-14** - AREG SDK is a developer-friendly, an interface-centric real-time asynchronous communication engine to enable distributed- and [mist-computing](https://csrc.nist.gov/publications/detail/sp/500-325/final), where connected Things interact and provide services, as if they act like thin distributed servers.
* [Eden ★ 25 ⧗ 0](https://github.com/lf-edge/eden) ⭐ 55 | 🐛 50 | 🌐 Go | 📅 2026-09-16 - CLI for Edge Virtualization Engine (EVE)
...
* [CosmoEdge](https://github.com/cosmo-wander-ai/cosmo-edge) ⭐ 1,160 | 🐛 10 | 🌐 C | 📅 2026-09-17 - Production-oriented C++ edge video AI engine that connects RTSP streams to CV/VLM inference, visual orchestration, alarms, and MQTT/webhook events on Sophon and Rockchip NPUs.
...
* [platformio.mcp](https://github.com/powerdragonfire/platformio.mcp) ⭐ 3 | 🐛 2 | 🌐 Python | 📅 2026-09-16 - MCP server that gives AI coding agents hands on embedded hardware through PlatformIO: build, flash, serial monitor, crash backtrace decoding, firmware size reports, unit tests and static analysis for ESP32, Arduino, STM32, RP2040 and other boards.
...
* **[NetData ★ 18973 ⧗ 0](https://github.com/firehol/netdata) ⭐ 80,560 | 🐛 402 | 🌐 Go | 📅 2026-09-17** - is a system for distributed real-time performance and health monitoring.
* **[Piwik ★ 5374 ⧗ 0](https://github.com/piwik/piwik) ⭐ 21,880 | 🐛 2,572 | 🌐 PHP | 📅 2026-09-17** - Piwik is the leading Free/Libre open analytics platform.
...
* [Eclipse Ditto](https://github.com/eclipse/ditto) ⭐ 923 | 🐛 95 | 🌐 Java | 📅 2026-09-17 is the open-source project of Eclipse IoT that provides a ready-to-use functionality to manage the state of Digital Twins.
