...
* **[Serverless ★ 7951 ⧗ 0](https://github.com/serverless/serverless) ⭐ 46,920 | 🐛 1,216 | 🌐 JavaScript | 📅 2026-08-12** - Serverless is the application framework for building web, mobile and IoT applications exclusively on Amazon Web Services' Lambda and API Gateway.
* **[ESP-IDF ★ 2542 ⧗ 0](https://github.com/espressif/esp-idf) ⭐ 18,771 | 🐛 1,671 | 🌐 C | 📅 2026-08-12** - The official framework from Espressif to build Wi-Fi, BLE, and BT apps with ESP32.
...
* **[GoBot ★ 2062 ⧗ 1](https://github.com/hybridgroup/gobot) ⭐ 9,446 | 🐛 99 | 🌐 Go | 📅 2026-01-07** - Golang framework for robotics, physical computing, and the Internet of Things.
...
* **[.NET Core IoT ★ 1193 ⧗ 292](https://github.com/dotnet/iot) ⭐ 2,403 | 🐛 90 | 🌐 C# | 📅 2026-08-13** - A set of libraries to interact with sensors, displays and input devices from .NET Core framework.
...
* [Kura ★ 85 ⧗ 1](https://github.com/eclipse/kura) ⭐ 571 | 🐛 20 | 🌐 Java | 📅 2026-08-13 - an open-source framework for development of IoT applications
...
* [Jumpstarter ★ 28 ⧗ 0](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 209 | 🐛 178 | 🌐 Python | 📅 2026-08-13 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual IoT hardware with CI/CD integration.
...
* **[ESP8266 Arduino Core ★ 2588 ⧗ 0](https://github.com/esp8266/Arduino) ⭐ 16,664 | 🐛 405 | 🌐 C++ | 📅 2026-07-29** - Arduino core for ESP8266 WiFi chip.

* [Armbian build SDK ★ 630](https://github.com/armbian/build) ⭐ 5,351 | 🐛 116 | 🌐 Shell | 📅 2026-08-13 - for creating customized kernel and Debian based userspace for popular development boards.
...
* **[ArduinoJson ★ 873 ⧗ 0](https://github.com/bblanchon/ArduinoJson) ⭐ 7,204 | 🐛 17 | 🌐 C++ | 📅 2026-08-11** - An elegant and efficient JSON library for embedded systems.
...
* [LK ★ 312 ⧗ 0](https://github.com/littlekernel/lk) ⭐ 3,660 | 🐛 100 | 🌐 C | 📅 2026-08-13 - The LK embedded kernel. An SMP-aware kernel designed for small systems.
...
* **[simbody ★ 540 ⧗ 0](https://github.com/simbody/simbody) ⭐ 2,545 | 🐛 161 | 🌐 C++ | 📅 2026-08-12** - High-performance C++ multibody dynamics/physics library for simulating articulated biomechanical and mechanical systems like vehicles, robots, and the human skeleton.
* [Ladon ★ 114 ⧗ 2](https://github.com/ory-am/ladon) ⭐ 2,459 | 🐛 2 | 🌐 Go | 📅 2025-10-22 - is a library written in Go for access control policies, similar to Role Based Access Control or Access Control Lists.
...
* [MCUBoot ★ 43 ⧗ 3](https://github.com/runtimeco/mcuboot) ⭐ 2,028 | 🐛 97 | 🌐 C | 📅 2026-08-13 - is a secure bootloader for 32-bit MCUs.
...
* [xkcptun ★ 104 ⧗ 25](https://github.com/liudf0716/xkcptun) ⭐ 476 | 🐛 11 | 🌐 C | 📅 2026-06-15 - xkcptun is kcp tunnel for OpenWRT\&LEDE, implemented in c language
...
* [MQTTX ★ 12 ⧗ 0](https://github.com/emqx/MQTTX) ⭐ 5,017 | 🐛 110 | 🌐 TypeScript | 📅 2026-08-13 - MQTTX is a cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows. It allows users to quickly and easily test MQTT / MQTTS connections, publish and subscribe to MQTT messages.
...
* [AimDB ★ 2](https://github.com/aimdb-dev/aimdb) ⭐ 98 | 🐛 7 | 🌐 Rust | 📅 2026-08-13 - An async, in-memory data bridge that syncs records across microcontrollers, edge gateways and cloud instances. Define once, stream and sync everywhere.
...
* [OpenWrt ★ 230 ⧗ 173](https://github.com/openwrt/openwrt) ⭐ 27,977 | 🐛 4,322 | 🌐 C | 📅 2026-08-13 - OpenWrt is described as a Linux distribution for embedded devices.

* [Zephyr ★ 352 ⧗ 5](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,199 | 🐛 3,856 | 🌐 C | 📅 2026-08-13 -  is a small, scalable real-time operating system for use on resource-constrained systems supporting multiple architectures.

* [RT-Thread ★ 493 ⧗ 0](https://github.com/RT-Thread/rt-thread) ⭐ 12,147 | 🐛 485 | 🌐 C | 📅 2026-08-13 - RT-Thread is an open source real-time operating system for embedded devices from China.

* **[NodeOS ★ 3605 ⧗ 0](https://github.com/nodeos/nodeos) ⭐ 7,346 | 🐛 163 | 🌐 Shell | 📅 2023-03-07** - Lightweight operating system using Node.js as userspace.
...
* **[RIOT ★ 748 ⧗ 1](https://github.com/RIOT-OS/RIOT) ⭐ 5,775 | 🐛 868 | 🌐 C | 📅 2026-08-13** - The friendly Operating System for the Internet of Things
...
* [TinyAra ★ 35 ⧗ 1](https://github.com/Samsung/TinyAra) ⭐ 647 | 🐛 208 | 🌐 C | 📅 2026-08-12 - is a lightweight RTOS-based platform to support low-end IoT devices.
...
* **[Thingsboard ★ 5102 ⧗ 1700](https://github.com/thingsboard/thingsboard) ⭐ 22,243 | 🐛 284 | 🌐 Java | 📅 2026-08-13** - Open-source IoT Platform - Device management, data collection, processing and visualization.
* **[PlatformIO ★ 980 ⧗ 0](https://github.com/platformio/platformio) ⭐ 9,399 | 🐛 316 | 🌐 Python | 📅 2026-08-11** - PlatformIO is a cross-platform code builder and the missing library manager.
...
* **[IoT DC3 ★ 650 ⧗ 0](https://github.com/pnoker/iot-dc3) ⭐ 697 | 🐛 34 | 🌐 Java | 📅 2026-08-11** - A fully open-source, distributed industrial IoT platform built on Spring Cloud, evolving for AI scenarios. Enables rapid IoT project development and connected-device management. [(Docs)](https://docs.dc3.site)
...
* [United Manufacturing Hub ★ 9 ⧗ 0](https://github.com/united-manufacturing-hub/united-manufacturing-hub) ⭐ 389 | 🐛 26 | 🌐 Go | 📅 2026-08-13 - The Open-Source Manufacturing App Platform (combines various open source solutions and packages them in a Helm chart, for example nodered, VerneMQ and timescaleDB)
...
* [DeviceChain](https://github.com/devicechain-io/devicechain) ⭐ 3 | 🐛 4 | 🌐 Go | 📅 2026-08-13 - Apache-2.0 self-hosted IoT platform written in Go and React. Multi-tenant microservices on Kubernetes: MQTT/Sparkplug B/LwM2M ingest, TimescaleDB time-series storage, a CEL-based rule engine with alarms and outbound connectors, versioned dashboards, and GraphQL APIs. [(Docs)](https://docs.devicechain.io)
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,046 | 🐛 229 | 🌐 Java | 📅 2026-08-13 - A Multi-protocol event-native edge/service proxy that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [SiteWhere ★ 61 ⧗ 0](https://github.com/sitewhere/sitewhere) ⭐ 1,044 | 🐛 124 | 🌐 Java | 📅 2026-07-31 - SiteWhere open-source IoT platform for device connectivity & management, data persistence, processing, integration, and analytics -- both in cloud and on-premise.
...
* [Renode ★ 81 ⧗ 0](https://github.com/renode/renode) ⭐ 2,722 | 🐛 419 | 🌐 RobotFramework | 📅 2026-08-13 - a virtual development tool for multinode embedded networks.
...
* **[D3.JS ★ 49188 ⧗ 0](https://github.com/mbostock/d3) ⭐ 113,447 | 🐛 20 | 🌐 Shell | 📅 2026-05-28** - A JavaScript visualization library for HTML and SVG
* **[ECharts ★ 11457 ⧗ 0](https://github.com/ecomfe/echarts) ⭐ 67,065 | 🐛 1,560 | 🌐 TypeScript | 📅 2026-08-04** - Echarts is a commercial charting solution originally intended to address the report need of the Company's various business systems.
* **[HighCharts ★ 4949 ⧗ 0](https://github.com/highslide-software/highcharts.com) ⭐ 12,478 | 🐛 658 | 🌐 TypeScript | 📅 2026-08-13** - Highcharts JS, the JavaScript charting framework
...
* [PULPino ★ 201 ⧗ 0](https://github.com/pulp-platform/pulpino) ⭐ 1,058 | 🐛 129 | 🌐 C | 📅 2024-02-06 - PULPino is an open-source microcontroller system, based on a small 32-bit RISC-V core developed at ETH Zurich.
...
* [Widora ★ 15 ⧗ 21](https://github.com/widora/openwrt_widora) ⭐ 174 | 🐛 5 | 🌐 C | 📅 2025-09-12 - Widora is open source WiFi development hardware prototype with sound card based on MT7688A running [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 27,977 | 🐛 4,322 | 🌐 C | 📅 2026-08-13.
...
* **[Homebridge ★ 3030 ⧗ 0](https://github.com/nfarina/homebridge) ⭐ 25,446 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-13** - Homebridge is a lightweight NodeJS server you can run on your home network that emulates the iOS HomeKit API.
* [Node-RED](https://github.com/node-red/node-red) ⭐ 23,527 | 🐛 320 | 🌐 JavaScript | 📅 2026-08-01 - Node-RED is a programming tool for wiring together hardware devices, APIs and online services in new and interesting ways.
...
* **[heimcontrol.js ★ 1306 ⧗ 4](https://github.com/ni-c/heimcontrol.js) ⚠️ Archived** -  Home-Automation with node.js and Raspberry PI
* **[openHAB ★ 2536 ⧗ 0](https://github.com/openhab/openhab-distro) ⭐ 1,389 | 🐛 72 | 🌐 PowerShell | 📅 2026-08-10** - a vendor and technology agnostic open source automation software for your home.
...
* **[AirSim ★ 2606 ⧗ 1](https://github.com/Microsoft/AirSim) ⭐ 18,396 | 🐛 780 | 🌐 C++ | 📅 2026-06-30** -  is a simulator for drones (and soon other vehicles) built on Unreal Engine.
...
* **[Sonoff-Tasmota ★ 4869 ⧗ 0](https://github.com/arendst/Sonoff-Tasmota) ⭐ 24,691 | 🐛 11 | 🌐 C | 📅 2026-08-13** - Provide ESP8266 based itead Sonoff with Web, MQTT and OTA firmware using Arduino IDE.
* **[Node-RED ★ 2513 ⧗ 0](https://github.com/node-red/node-red) ⭐ 23,527 | 🐛 320 | 🌐 JavaScript | 📅 2026-08-01** - A visual tool for wiring the Internet of Things.
...
* [fluent-bit ★ 90 ⧗ 4](https://github.com/fluent/fluent-bit) ⭐ 8,029 | 🐛 769 | 🌐 C | 📅 2026-08-13 - is a data collector for Linux, Embedded Linux, OSX and BSD family operating systems.
...
* **[MicroPython ★ 3070 ⧗ 0](https://github.com/micropython/micropython) ⭐ 21,989 | 🐛 1,536 | 🌐 C | 📅 2026-08-13** - MicroPython is a lean and fast implementation of the Python 3 programming language that is optimised to run on a microcontroller.
* **[JerryScript ★ 1244 ⧗ 0](https://github.com/Samsung/jerryscript) ⭐ 7,413 | 🐛 246 | 🌐 C | 📅 2025-10-08** - A JavaScript engine for Internet of Things.
* **[luvit ★ 2237 ⧗ 0](https://github.com/luvit/luvit) ⭐ 3,959 | 🐛 95 | 🌐 Lua | 📅 2026-04-02** - Node.JS for the Lua Inventor.
* **[Terra ★ 1248 ⧗ 0](https://github.com/zdevito/terra) ⭐ 2,901 | 🐛 101 | 🌐 C++ | 📅 2026-08-10** - is a low-level system programming language that is embedded in and meta-programmed by the Lua programming language.
...
* **[PikaScript ★ 660 ⧗ 36](https://github.com/pikasTech/pikaScript) ⭐ 1,743 | 🐛 29 | 🌐 C | 📅 2026-08-07** - PikaScript is a extremely lightweight python engine that can run with less than 4KB of RAM such as stm32g030c8 and stm32f103c8. It is zero dependency, zero configuration, easy to deploy and expand.
...
* [eLua ★ 393 ⧗ 1](https://github.com/elua/elua) ⭐ 981 | 🐛 41 | 🌐 C | 📅 2024-03-25 - Quickly prototype and develop embedded software applications with the power of Lua and run them on a wide range of microcontroller architectures.
...
* **[mbed TLS ★ 601 ⧗ 0](https://github.com/ARMmbed/mbedtls) ⭐ 6,870 | 🐛 1,734 | 🌐 C | 📅 2026-08-13** - An open source, portable, easy to use, readable and flexible SSL library
...
* **[EMQX ★ 10300 ⧗ 1800](https://github.com/emqx/emqx) ⭐ 16,617 | 🐛 255 | 🌐 Erlang | 📅 2026-08-13** - An ultra-scalable open-source MQTT broker. Connect 100M+ IoT devices in one single cluster, move and process real-time IoT data with 1M msg/s throughput at 1ms latency.
* [Mosquitto ★ 158 ⧗ 0](https://github.com/eclipse/mosquitto) ⭐ 11,116 | 🐛 865 | 🌐 C | 📅 2026-07-30 - An Open Source MQTT v3.1/v3.1.1 Broker.
...
* [moquette ★ 2239 ⧗ 2](https://github.com/moquette-io/moquette) ⭐ 2,451 | 🐛 138 | 🌐 Java | 📅 2026-08-01 - Java MQTT lightweight broker.
* [Eclipse Paho MQTT C client ★ 142 ⧗ 3](https://github.com/eclipse/paho.mqtt.c) ⭐ 2,348 | 🐛 211 | 🌐 C | 📅 2026-07-21 - This code builds libraries which enable applications to connect to an MQTT broker to publish messages, and to subscribe to topics and receive published messages.
...
* [WolfSSL MQTT ★ 155 ⧗ 14](https://github.com/wolfSSL/wolfMQTT) ⭐ 590 | 🐛 6 | 🌐 C | 📅 2026-08-13 - A C MQTT library that works with WolfSSL.
...
* **[OpenThread ★ 1139 ⧗ 2](https://github.com/openthread/openthread) ⭐ 4,013 | 🐛 165 | 🌐 C++ | 📅 2026-08-13** - OpenThread is an open-source implementation of the Thread networking protocol.
* [OpenThread Border Router ★ 64 ⧗ 0](https://github.com/openthread/borderrouter) ⭐ 562 | 🐛 70 | 🌐 C++ | 📅 2026-08-13 - An open source border router, built to work with OpenThread.

### Others

* **[libimobiledevice ★ 2294 ⧗ 0](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,103 | 🐛 840 | 🌐 C | 📅 2026-06-10** - A library to communicate with services of Apple iOS devices using native protocols.
...
* [libmodbus ★ 2400 ⧗ 50](https://github.com/stephane/libmodbus) ⭐ 4,230 | 🐛 187 | 🌐 C | 📅 2026-07-02 - A Modbus library for Linux, Mac OS, FreeBSD, QNX and Windows, written in C.
* [pymodbus ★ 2400 ⧗ 100](https://github.com/pymodbus-dev/pymodbus) ⭐ 2,753 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - A full Modbus protocol implementation for Python, supporting RTU, TCP, ASCII over serial and network transports.
...
* **[Servo ★ 7821 ⧗ 0](https://github.com/servo/servo) ⭐ 37,688 | 🐛 3,141 | 🌐 Rust | 📅 2026-08-13** -  is a prototype web browser engine written in the Rust language.
* **[Drake ★ 500 ⧗ 0](https://github.com/RobotLocomotion/drake) ⭐ 4,148 | 🐛 650 | 🌐 C++ | 📅 2026-08-13** -  is a toolbox maintained by the Robot Locomotion Group at the MIT Computer Science and Artificial Intelligence Lab (CSAIL).
* [ShellHub ★ 702 ⧗ 70](https://github.com/shellhub-io/shellhub) ⭐ 2,060 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-13 - Centralized SSH for the the edge and cloud computing.
* [The Things Stack ★ 887 ⧗ 4](https://github.com/TheThingsNetwork/lorawan-stack) ⭐ 1,160 | 🐛 182 | 🌐 Go | 📅 2026-08-13 - The Things Stack, an open source LoRaWAN network server created by The Things Industries. Creators of the global open crowdsourced Internet of Things data network The Things Network.
...
* **[NetData ★ 18973 ⧗ 0](https://github.com/firehol/netdata) ⭐ 80,171 | 🐛 382 | 🌐 Go | 📅 2026-08-13** - is a system for distributed real-time performance and health monitoring.
* **[Piwik ★ 5374 ⧗ 0](https://github.com/piwik/piwik) ⭐ 21,762 | 🐛 2,562 | 🌐 PHP | 📅 2026-08-13** - Piwik is the leading Free/Libre open analytics platform.
