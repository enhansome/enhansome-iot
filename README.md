...
* [Awesome IoT](https://github.com/HQarroum/awesome-iot) ⭐ 4,459 | 🐛 8 | 📅 2026-08-10 - A curated list of awesome Internet of Things projects and resources.
...
* **[Serverless ★ 7951 ⧗ 0](https://github.com/serverless/serverless) ⭐ 46,921 | 🐛 1,216 | 🌐 JavaScript | 📅 2026-08-12** - Serverless is the application framework for building web, mobile and IoT applications exclusively on Amazon Web Services' Lambda and API Gateway.
* **[ESP-IDF ★ 2542 ⧗ 0](https://github.com/espressif/esp-idf) ⭐ 18,777 | 🐛 1,671 | 🌐 C | 📅 2026-08-13** - The official framework from Espressif to build Wi-Fi, BLE, and BT apps with ESP32.
...
* **[GoBot ★ 2062 ⧗ 1](https://github.com/hybridgroup/gobot) ⭐ 9,447 | 🐛 99 | 🌐 Go | 📅 2026-01-07** - Golang framework for robotics, physical computing, and the Internet of Things.
...
* **[.NET Core IoT ★ 1193 ⧗ 292](https://github.com/dotnet/iot) ⭐ 2,403 | 🐛 89 | 🌐 C# | 📅 2026-08-13** - A set of libraries to interact with sensors, displays and input devices from .NET Core framework.
...
* [Thingsboard IoT Gateway ★ 463 ⧗ 246](https://github.com/thingsboard/thingsboard-gateway) ⭐ 2,173 | 🐛 88 | 🌐 Python | 📅 2026-08-12 - open-source IoT Gateway - integrates devices connected to legacy and third-party systems with Thingsboard IoT Platform using OPC-UA and MQTT protocols.
...
* [Kura ★ 85 ⧗ 1](https://github.com/eclipse/kura) ⭐ 571 | 🐛 20 | 🌐 Java | 📅 2026-08-14 - an open-source framework for development of IoT applications
...
* [Jumpstarter ★ 28 ⧗ 0](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 210 | 🐛 180 | 🌐 Python | 📅 2026-08-14 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual IoT hardware with CI/CD integration.
...
* [Simgrid ★ 46 ⧗ 53](https://github.com/simgrid/simgrid) ⭐ 194 | 🐛 20 | 🌐 C++ | 📅 2026-08-06 -  is a scientific instrument to study the behavior of large-scale distributed systems such as Grids, Clouds, HPC or P2P systems.
...
* **[ESP8266 Arduino Core ★ 2588 ⧗ 0](https://github.com/esp8266/Arduino) ⭐ 16,665 | 🐛 405 | 🌐 C++ | 📅 2026-07-29** - Arduino core for ESP8266 WiFi chip.

* [Armbian build SDK ★ 630](https://github.com/armbian/build) ⭐ 5,351 | 🐛 108 | 🌐 Shell | 📅 2026-08-14 - for creating customized kernel and Debian based userspace for popular development boards.
...
* **[ArduinoJson ★ 873 ⧗ 0](https://github.com/bblanchon/ArduinoJson) ⭐ 7,203 | 🐛 17 | 🌐 C++ | 📅 2026-08-11** - An elegant and efficient JSON library for embedded systems.
...
* [LK ★ 312 ⧗ 0](https://github.com/littlekernel/lk) ⭐ 3,661 | 🐛 100 | 🌐 C | 📅 2026-08-14 - The LK embedded kernel. An SMP-aware kernel designed for small systems.
...
* [MCUBoot ★ 43 ⧗ 3](https://github.com/runtimeco/mcuboot) ⭐ 2,029 | 🐛 102 | 🌐 C | 📅 2026-08-13 - is a secure bootloader for 32-bit MCUs.
...
* [MQTTX ★ 12 ⧗ 0](https://github.com/emqx/MQTTX) ⭐ 5,019 | 🐛 110 | 🌐 TypeScript | 📅 2026-08-13 - MQTTX is a cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows. It allows users to quickly and easily test MQTT / MQTTS connections, publish and subscribe to MQTT messages.
...
* [ReductStore ★ 360](https://github.com/reductstore/reductstore) ⭐ 366 | 🐛 15 | 🌐 Rust | 📅 2026-08-08 - high-performance blob and time-series storage for industrial IoT, with edge deployment, selective replication, and efficient querying of multimodal data.
...
* [Scanners-Box ★ 424 ⧗ 0](https://github.com/We5ter/Scanners-Box) ⭐ 9,009 | 🐛 0 | 📅 2026-08-12 - the toolbox of open source scanners.
...
* [HookProbe](https://github.com/hookprobe/hookprobe) ⭐ 44 | 🐛 1 | 🌐 Python | 📅 2026-07-27 - Edge-first autonomous SOC and AI-native IDS for IoT network security. Runs on Raspberry Pi.
...
* [OpenWrt ★ 230 ⧗ 173](https://github.com/openwrt/openwrt) ⭐ 27,979 | 🐛 4,319 | 🌐 C | 📅 2026-08-14 - OpenWrt is described as a Linux distribution for embedded devices.

* [Zephyr ★ 352 ⧗ 5](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,210 | 🐛 3,839 | 🌐 C | 📅 2026-08-14 -  is a small, scalable real-time operating system for use on resource-constrained systems supporting multiple architectures.

* [RT-Thread ★ 493 ⧗ 0](https://github.com/RT-Thread/rt-thread) ⭐ 12,149 | 🐛 481 | 🌐 C | 📅 2026-08-14 - RT-Thread is an open source real-time operating system for embedded devices from China.
...
* [Tock OS ★ 243 ⧗ 1](https://github.com/helena-project/tock) ⭐ 6,410 | 🐛 209 | 🌐 Rust | 📅 2026-08-14 -  is an operating system designed for running multiple concurrent, mutually distrustful applications on Cortex-M based embedded platforms.

* **[RIOT ★ 748 ⧗ 1](https://github.com/RIOT-OS/RIOT) ⭐ 5,777 | 🐛 866 | 🌐 C | 📅 2026-08-14** - The friendly Operating System for the Internet of Things

* **[seL4 Microkernel ★ 1344 ⧗ 1](https://github.com/seL4/seL4) ⭐ 5,690 | 🐛 212 | 🌐 C | 📅 2026-08-06** - The world's first operating-system kernel with an end-to-end proof of implementation correctness and security enforcement is available as open source.

* [Huawei LiteOS ★ 341 ⧗ 3](https://github.com/LITEOS/LiteOS_Kernel) ⭐ 4,905 | 🐛 51 | 🌐 C | 📅 2022-05-31 - Huawei LiteOS Kernel.

* **[ARM mbed ★ 629 ⧗ 0](https://github.com/mbedmicro/mbed) ⭐ 4,867 | 🐛 211 | 🌐 C | 📅 2024-10-08** - The ARM® mbed™ IoT Device Platform provides the operating system, cloud services, tools and developer ecosystem to make the creation and deployment of commercial, standards-based IoT solutions possible at scale.

* **[Contiki ★ 1813 ⧗ 0](https://github.com/contiki-os/contiki) ⭐ 3,805 | 🐛 649 | 🌐 C | 📅 2024-04-06** - The Open Source OS for the Internet of Things
...
* [TinyAra ★ 35 ⧗ 1](https://github.com/Samsung/TinyAra) ⭐ 647 | 🐛 209 | 🌐 C | 📅 2026-08-12 - is a lightweight RTOS-based platform to support low-end IoT devices.
...
* **[Thingsboard ★ 5102 ⧗ 1700](https://github.com/thingsboard/thingsboard) ⭐ 22,246 | 🐛 284 | 🌐 Java | 📅 2026-08-13** - Open-source IoT Platform - Device management, data collection, processing and visualization.
* **[PlatformIO ★ 980 ⧗ 0](https://github.com/platformio/platformio) ⭐ 9,400 | 🐛 316 | 🌐 Python | 📅 2026-08-11** - PlatformIO is a cross-platform code builder and the missing library manager.
* [Fuxa SCADA/HMI/Dashboard ★ 2115 ⧗ 632](https://github.com/frangoteam/FUXA) ⭐ 4,907 | 🐛 385 | 🌐 TypeScript | 📅 2026-08-13 - FUXA is a web-based Process Visualization (SCADA/HMI/Dashboard) software. With FUXA you can create modern process visualizations/dashboards with individual designs for your machines/IOT application with real-time data display. Supports MQTT, OPC-UA, Modbus RTU/TCP, Siemens S7 Protocol, BACnet IP, Ethernet/IP (Allen Bradley), WebAPI
...
* [HiveMQ ★ 329 ⧗ 0](https://github.com/hivemq/hivemq-community-edition) ⭐ 1,204 | 🐛 27 | 🌐 Java | 📅 2026-08-14 - is an open source MQTT platform and MQTT broker.
* **[IoT DC3 ★ 650 ⧗ 0](https://github.com/pnoker/iot-dc3) ⭐ 725 | 🐛 34 | 🌐 Java | 📅 2026-08-14** - A fully open-source, distributed industrial IoT platform built on Spring Cloud, evolving for AI scenarios. Enables rapid IoT project development and connected-device management. [(Docs)](https://docs.dc3.site)
...
* [United Manufacturing Hub ★ 9 ⧗ 0](https://github.com/united-manufacturing-hub/united-manufacturing-hub) ⭐ 391 | 🐛 26 | 🌐 Go | 📅 2026-08-14 - The Open-Source Manufacturing App Platform (combines various open source solutions and packages them in a Helm chart, for example nodered, VerneMQ and timescaleDB)
...
* [Simple IoT](https://github.com/dingdaoyi/simple-iot) ⭐ 27 | 🐛 0 | 🌐 Java | 📅 2026-08-03 - Single-binary, self-hosted IoT platform built with Spring Boot 4 + Vue 3. Built-in MQTT broker, visual rule engine, hot-loaded Java/JS/Groovy/Lua protocol scripts, InfluxDB 3 time-series storage. One-command deploy on a 2 GB VPS.
...
* [DeviceChain](https://github.com/devicechain-io/devicechain) ⭐ 3 | 🐛 5 | 🌐 Go | 📅 2026-08-14 - Apache-2.0 self-hosted IoT platform written in Go and React. Multi-tenant microservices on Kubernetes: MQTT/Sparkplug B/LwM2M ingest, TimescaleDB time-series storage, a CEL-based rule engine with alarms and outbound connectors, versioned dashboards, and GraphQL APIs. [(Docs)](https://docs.devicechain.io)
...
* [ForestHub](https://foresthub.ai) - Edge AI agent platform; its open-source runtime [edge-agents](https://github.com/ForestHubAI/edge-agents) ⭐ 97 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-29 runs AI agents offline on Linux edge gateways with local SLMs, cloud LLMs and MQTT as first-class nodes.
...
* [Shifu ★ 312 ⧗ 0](https://github.com/Edgenesis/shifu) ⭐ 1,431 | 🐛 22 | 🌐 Go | 📅 2026-08-13 - Shifu is a Kubernetes native IoT development framework that supports multi-protocol device access.
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,054 | 🐛 225 | 🌐 Java | 📅 2026-08-14 - A Multi-protocol event-native edge/service proxy that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [OpenIoT ★ 205 ⧗ 0](https://github.com/OpenIotOrg/openiot) ⭐ 470 | 🐛 98 | 🌐 Java | 📅 2023-02-22 - The OpenIoT middleware infrastructure will support flexible configuration and deployment of algorithms for collection
...
* [Renode ★ 81 ⧗ 0](https://github.com/renode/renode) ⭐ 2,720 | 🐛 420 | 🌐 RobotFramework | 📅 2026-08-14 - a virtual development tool for multinode embedded networks.
...
* **[D3.JS ★ 49188 ⧗ 0](https://github.com/mbostock/d3) ⭐ 113,450 | 🐛 20 | 🌐 Shell | 📅 2026-05-28** - A JavaScript visualization library for HTML and SVG
* **[ECharts ★ 11457 ⧗ 0](https://github.com/ecomfe/echarts) ⭐ 67,067 | 🐛 1,558 | 🌐 TypeScript | 📅 2026-08-04** - Echarts is a commercial charting solution originally intended to address the report need of the Company's various business systems.
* **[HighCharts ★ 4949 ⧗ 0](https://github.com/highslide-software/highcharts.com) ⭐ 12,480 | 🐛 664 | 🌐 TypeScript | 📅 2026-08-14** - Highcharts JS, the JavaScript charting framework
...
* **[Freeboard ★ 3034 ⧗ 0](https://github.com/Freeboard/freeboard) ⭐ 6,503 | 🐛 166 | 🌐 JavaScript | 📅 2023-09-23** - A damn-sexy, open source real-time dashboard builder for IOT and other web mashups. A free open-source alternative to Geckoboard.
...
* [PULPino ★ 201 ⧗ 0](https://github.com/pulp-platform/pulpino) ⭐ 1,059 | 🐛 129 | 🌐 C | 📅 2024-02-06 - PULPino is an open-source microcontroller system, based on a small 32-bit RISC-V core developed at ETH Zurich.
...
* [Widora ★ 15 ⧗ 21](https://github.com/widora/openwrt_widora) ⭐ 174 | 🐛 5 | 🌐 C | 📅 2025-09-12 - Widora is open source WiFi development hardware prototype with sound card based on MT7688A running [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 27,979 | 🐛 4,319 | 🌐 C | 📅 2026-08-14.
...
* **[Homebridge ★ 3030 ⧗ 0](https://github.com/nfarina/homebridge) ⭐ 25,451 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-13** - Homebridge is a lightweight NodeJS server you can run on your home network that emulates the iOS HomeKit API.
* [Node-RED](https://github.com/node-red/node-red) ⭐ 23,530 | 🐛 320 | 🌐 JavaScript | 📅 2026-08-13 - Node-RED is a programming tool for wiring together hardware devices, APIs and online services in new and interesting ways.
...
* **[heimcontrol.js ★ 1306 ⧗ 4](https://github.com/ni-c/heimcontrol.js) ⚠️ Archived** -  Home-Automation with node.js and Raspberry PI
* **[openHAB ★ 2536 ⧗ 0](https://github.com/openhab/openhab-distro) ⭐ 1,390 | 🐛 72 | 🌐 PowerShell | 📅 2026-08-10** - a vendor and technology agnostic open source automation software for your home.
...
* [homebridge-blink-security](https://github.com/BitWise-0x/homebridge-blink-security) ⭐ 12 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-14 - Homebridge plugin for Blink cameras, doorbells, and sirens with live streaming, arm/disarm, and motion detection via Apple HomeKit.
...
* **[AirSim ★ 2606 ⧗ 1](https://github.com/Microsoft/AirSim) ⭐ 18,400 | 🐛 780 | 🌐 C++ | 📅 2026-06-30** -  is a simulator for drones (and soon other vehicles) built on Unreal Engine.
* **[hubot ★ 10481 ⧗ 0](https://github.com/github/hubot) ⭐ 16,795 | 🐛 6 | 🌐 JavaScript | 📅 2026-07-22** - A customizable life embetterment robot.
...
* **[Sonoff-Tasmota ★ 4869 ⧗ 0](https://github.com/arendst/Sonoff-Tasmota) ⭐ 24,697 | 🐛 12 | 🌐 C | 📅 2026-08-14** - Provide ESP8266 based itead Sonoff with Web, MQTT and OTA firmware using Arduino IDE.
* **[Node-RED ★ 2513 ⧗ 0](https://github.com/node-red/node-red) ⭐ 23,530 | 🐛 320 | 🌐 JavaScript | 📅 2026-08-13** - A visual tool for wiring the Internet of Things.
...
* [fluent-bit ★ 90 ⧗ 4](https://github.com/fluent/fluent-bit) ⭐ 8,029 | 🐛 770 | 🌐 C | 📅 2026-08-14 - is a data collector for Linux, Embedded Linux, OSX and BSD family operating systems.
...
* **[MicroPython ★ 3070 ⧗ 0](https://github.com/micropython/micropython) ⭐ 21,992 | 🐛 1,530 | 🌐 C | 📅 2026-08-14** - MicroPython is a lean and fast implementation of the Python 3 programming language that is optimised to run on a microcontroller.
...
* **[Terra ★ 1248 ⧗ 0](https://github.com/zdevito/terra) ⭐ 2,901 | 🐛 100 | 🌐 C++ | 📅 2026-08-14** - is a low-level system programming language that is embedded in and meta-programmed by the Lua programming language.
* [AtomVM ★ 390 ⧗ 0](https://github.com/bettio/AtomVM) ⭐ 2,196 | 🐛 178 | 🌐 Erlang | 📅 2026-07-31 - AtomVM is a tiny portable virtual machine that allows Erlang and Elixir code to run on microcontrollers with less than 500KB of RAM such as the ESP32.
* **[PikaScript ★ 660 ⧗ 36](https://github.com/pikasTech/pikaScript) ⭐ 1,744 | 🐛 29 | 🌐 C | 📅 2026-08-07** - PikaScript is a extremely lightweight python engine that can run with less than 4KB of RAM such as stm32g030c8 and stm32f103c8. It is zero dependency, zero configuration, easy to deploy and expand.
...
* **[mbed TLS ★ 601 ⧗ 0](https://github.com/ARMmbed/mbedtls) ⭐ 6,869 | 🐛 1,729 | 🌐 C | 📅 2026-08-14** - An open source, portable, easy to use, readable and flexible SSL library
...
* **[EMQX ★ 10300 ⧗ 1800](https://github.com/emqx/emqx) ⭐ 16,617 | 🐛 252 | 🌐 Erlang | 📅 2026-08-13** - An ultra-scalable open-source MQTT broker. Connect 100M+ IoT devices in one single cluster, move and process real-time IoT data with 1M msg/s throughput at 1ms latency.
* [Mosquitto ★ 158 ⧗ 0](https://github.com/eclipse/mosquitto) ⭐ 11,119 | 🐛 866 | 🌐 C | 📅 2026-07-30 - An Open Source MQTT v3.1/v3.1.1 Broker.
* **[MQTT.js ★ 1359 ⧗ 0](https://github.com/mqttjs/MQTT.js) ⭐ 9,104 | 🐛 33 | 🌐 TypeScript | 📅 2026-07-20** - The MQTT client for Node.js and the browser.
...
* **[VerneMQ ★ 561 ⧗ 1](https://github.com/erlio/vernemq) ⭐ 3,620 | 🐛 161 | 🌐 Erlang | 📅 2026-08-09** - A distributed MQTT message broker.
* **[mosca ★ 1097 ⧗ 0](https://github.com/mcollina/mosca) ⚠️ Archived** - Mosca is a node.js mqtt broker.
* [NanoMQ](https://github.com/nanomq/nanomq) ⭐ 2,587 | 🐛 63 | 🌐 C | 📅 2026-08-14 - A light-weight and Blazing-fast MQTT Broker for IoT Edge platform.
* [moquette ★ 2239 ⧗ 2](https://github.com/moquette-io/moquette) ⭐ 2,451 | 🐛 138 | 🌐 Java | 📅 2026-08-01 - Java MQTT lightweight broker.
* [Eclipse Paho MQTT C client ★ 142 ⧗ 3](https://github.com/eclipse/paho.mqtt.c) ⭐ 2,349 | 🐛 211 | 🌐 C | 📅 2026-07-21 - This code builds libraries which enable applications to connect to an MQTT broker to publish messages, and to subscribe to topics and receive published messages.
...
* [WolfSSL MQTT ★ 155 ⧗ 14](https://github.com/wolfSSL/wolfMQTT) ⭐ 590 | 🐛 5 | 🌐 C | 📅 2026-08-13 - A C MQTT library that works with WolfSSL.
...
* [Californium ★ 36 ⧗ 0](https://github.com/eclipse/californium) ⭐ 775 | 🐛 19 | 🌐 Java | 📅 2026-08-14 - Californium is a Java implementation of CoAP for the IoT backend and less constrained IoT devices.
...
* **[OpenThread ★ 1139 ⧗ 2](https://github.com/openthread/openthread) ⭐ 4,013 | 🐛 167 | 🌐 C++ | 📅 2026-08-13** - OpenThread is an open-source implementation of the Thread networking protocol.
* [OpenThread Border Router ★ 64 ⧗ 0](https://github.com/openthread/borderrouter) ⭐ 562 | 🐛 66 | 🌐 C++ | 📅 2026-08-14 - An open source border router, built to work with OpenThread.

### Others

* **[libimobiledevice ★ 2294 ⧗ 0](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,104 | 🐛 840 | 🌐 C | 📅 2026-06-10** - A library to communicate with services of Apple iOS devices using native protocols.
* **[MeQ ★ 920 ⧗ 1](https://github.com/teamsaas/meq) ⭐ 3,965 | 🐛 46 | 🌐 TypeScript | 📅 2025-03-04** - is a real-time communication service for connecting online devices.
...
* [libmodbus ★ 2400 ⧗ 50](https://github.com/stephane/libmodbus) ⭐ 4,228 | 🐛 187 | 🌐 C | 📅 2026-07-02 - A Modbus library for Linux, Mac OS, FreeBSD, QNX and Windows, written in C.
* [pymodbus ★ 2400 ⧗ 100](https://github.com/pymodbus-dev/pymodbus) ⭐ 2,754 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - A full Modbus protocol implementation for Python, supporting RTU, TCP, ASCII over serial and network transports.
...
* **[Servo ★ 7821 ⧗ 0](https://github.com/servo/servo) ⭐ 37,701 | 🐛 3,152 | 🌐 Rust | 📅 2026-08-14** -  is a prototype web browser engine written in the Rust language.
* **[Drake ★ 500 ⧗ 0](https://github.com/RobotLocomotion/drake) ⭐ 4,150 | 🐛 647 | 🌐 C++ | 📅 2026-08-14** -  is a toolbox maintained by the Robot Locomotion Group at the MIT Computer Science and Artificial Intelligence Lab (CSAIL).
...
* [The Things Stack ★ 887 ⧗ 4](https://github.com/TheThingsNetwork/lorawan-stack) ⭐ 1,160 | 🐛 181 | 🌐 Go | 📅 2026-08-13 - The Things Stack, an open source LoRaWAN network server created by The Things Industries. Creators of the global open crowdsourced Internet of Things data network The Things Network.
...
* **[Processing ★ 2644 ⧗ 0](https://github.com/processing/processing) ⭐ 6,484 | 🐛 0 | 🌐 Java | 📅 2026-07-15** - Processing is a flexible software sketchbook and a language for learning how to code within the context of the visual arts.
* [Copper ★ 46 ⧗ 14](https://github.com/mkovatsc/Copper) ⭐ 95 | 🐛 8 | 🌐 JavaScript | 📅 2018-10-18 - A Firefox add-on to browse the Internet of Things

## Tools

* [Smart.js ★ 487 ⧗ 0](https://github.com/cesanta/smart.js) ⭐ 2,662 | 🐛 97 | 🌐 C | 📅 2026-07-26 - Embedded Javascript engine for C/C++ with networking, file, database and device interfaces
...
* **[NetData ★ 18973 ⧗ 0](https://github.com/firehol/netdata) ⭐ 80,198 | 🐛 388 | 🌐 Go | 📅 2026-08-14** - is a system for distributed real-time performance and health monitoring.
* **[Piwik ★ 5374 ⧗ 0](https://github.com/piwik/piwik) ⭐ 21,767 | 🐛 2,554 | 🌐 PHP | 📅 2026-08-14** - Piwik is the leading Free/Libre open analytics platform.
...
* [Eclipse Ditto](https://github.com/eclipse/ditto) ⭐ 914 | 🐛 100 | 🌐 Java | 📅 2026-08-14 is the open-source project of Eclipse IoT that provides a ready-to-use functionality to manage the state of Digital Twins.
