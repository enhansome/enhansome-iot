...
* [Awesome OpenIoT](https://github.com/Agile-IoT/awesome-open-iot) ⭐ 708 | 🐛 8 | 📅 2023-12-21 - A curated list of awesome open source IoT frameworks, libraries and software.
...
* **[Serverless ★ 7951 ⧗ 0](https://github.com/serverless/serverless) ⭐ 46,916 | 🐛 1,219 | 🌐 JavaScript | 📅 2026-09-08** - Serverless is the application framework for building web, mobile and IoT applications exclusively on Amazon Web Services' Lambda and API Gateway.
* **[ESP-IDF ★ 2542 ⧗ 0](https://github.com/espressif/esp-idf) ⭐ 18,972 | 🐛 1,679 | 🌐 C | 📅 2026-09-07** - The official framework from Espressif to build Wi-Fi, BLE, and BT apps with ESP32.
* **[johnny-five ★ 6024 ⧗ 0](https://github.com/rwaldron/johnny-five) ⭐ 13,412 | 🐛 64 | 🌐 JavaScript | 📅 2023-10-24** - JavaScript Robotics and IoT programming framework, developed at Bocoup, Firmata Protocol.
* **[GoBot ★ 2062 ⧗ 1](https://github.com/hybridgroup/gobot) ⭐ 9,464 | 🐛 100 | 🌐 Go | 📅 2026-01-07** - Golang framework for robotics, physical computing, and the Internet of Things.
...
* **[.NET Core IoT ★ 1193 ⧗ 292](https://github.com/dotnet/iot) ⭐ 2,405 | 🐛 94 | 🌐 C# | 📅 2026-09-07** - A set of libraries to interact with sensors, displays and input devices from .NET Core framework.
...
* [Thingsboard IoT Gateway ★ 463 ⧗ 246](https://github.com/thingsboard/thingsboard-gateway) ⭐ 2,183 | 🐛 85 | 🌐 Python | 📅 2026-09-08 - open-source IoT Gateway - integrates devices connected to legacy and third-party systems with Thingsboard IoT Platform using OPC-UA and MQTT protocols.
* **[Sming ★ 1800 ⧗ 0](https://github.com/SmingHub/Sming) ⭐ 1,569 | 🐛 82 | 🌐 C++ | 📅 2026-09-06** - Sming is an asynchronous C/C++ framework with superb performance and multiple network features. Sming is open source and is tailored towards embedded devices.
...
* [Kura ★ 85 ⧗ 1](https://github.com/eclipse/kura) ⭐ 574 | 🐛 19 | 🌐 Java | 📅 2026-09-08 - an open-source framework for development of IoT applications
...
* [WTX](https://github.com/c410-f3r/wtx) ⭐ 400 | 🐛 6 | 🌐 Rust | 📅 2026-09-08 - A framework for web-oriented applications
* **[AREG SDK ★ 15 ⧗ 0](https://github.com/aregtech/areg-sdk) ⭐ 365 | 🐛 24 | 🌐 C++ | 📅 2026-09-08** - AREG SDK is a developer-friendly, an interface-centric real-time asynchronous communication engine to enable distributed- and [mist-computing](https://csrc.nist.gov/publications/detail/sp/500-325/final), where connected Things interact and provide services, as if they act like thin distributed servers.
...
* [Jumpstarter ★ 28 ⧗ 0](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 216 | 🐛 180 | 🌐 Python | 📅 2026-09-08 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual IoT hardware with CI/CD integration.
...
* **[ESP8266 Arduino Core ★ 2588 ⧗ 0](https://github.com/esp8266/Arduino) ⭐ 16,677 | 🐛 404 | 🌐 C++ | 📅 2026-08-27** - Arduino core for ESP8266 WiFi chip.

* [Armbian build SDK ★ 630](https://github.com/armbian/build) ⭐ 5,406 | 🐛 131 | 🌐 Shell | 📅 2026-09-08 - for creating customized kernel and Debian based userspace for popular development boards.
...
* **[ArduinoJson ★ 873 ⧗ 0](https://github.com/bblanchon/ArduinoJson) ⭐ 7,210 | 🐛 17 | 🌐 C++ | 📅 2026-08-15** - An elegant and efficient JSON library for embedded systems.
* [WiringPi ★ 455 ⧗ 11](https://github.com/WiringPi/WiringPi) ⭐ 3,340 | 🐛 39 | 🌐 C | 📅 2026-09-02 - Gordon's Arduino wiring-like WiringPi Library for the Raspberry Pi.
* [PJON ★ 427 ⧗ 4](https://github.com/gioblu/PJON) ⭐ 2,824 | 🐛 60 | 🌐 C++ | 📅 2025-11-21 - Digital communication framework for Arduino and IOT.
...
* [LK ★ 312 ⧗ 0](https://github.com/littlekernel/lk) ⭐ 3,673 | 🐛 93 | 🌐 C | 📅 2026-09-07 - The LK embedded kernel. An SMP-aware kernel designed for small systems.
* [inih ★ 312 ⧗ 3](https://github.com/benhoyt/inih) ⭐ 3,041 | 🐛 6 | 🌐 C++ | 📅 2026-01-30 - is a simple .INI file parser written in C.
* **[nexmon ★ 885 ⧗ 2](https://github.com/seemoo-lab/nexmon) ⭐ 2,885 | 🐛 347 | 🌐 C | 📅 2026-07-13** -  is our C-based firmware patching framework for Broadcom/Cypress WiFi chips.
* **[simbody ★ 540 ⧗ 0](https://github.com/simbody/simbody) ⭐ 2,547 | 🐛 162 | 🌐 C++ | 📅 2026-09-06** - High-performance C++ multibody dynamics/physics library for simulating articulated biomechanical and mechanical systems like vehicles, robots, and the human skeleton.
...
* [btstack ★ 151 ⧗ 1](https://github.com/bluekitchen/btstack) ⭐ 2,133 | 🐛 76 | 🌐 C | 📅 2026-09-04 - Dual-mode Bluetooth stack, with small memory footprint.
* [MCUBoot ★ 43 ⧗ 3](https://github.com/runtimeco/mcuboot) ⭐ 2,096 | 🐛 95 | 🌐 C | 📅 2026-09-08 - is a secure bootloader for 32-bit MCUs.
* [CocoaMQTT ★ 210 ⧗ 0](https://github.com/emqtt/CocoaMQTT) ⭐ 1,752 | 🐛 111 | 🌐 Swift | 📅 2026-09-08 - MQTT for iOS and OS X written with Swift.
* [SPIFFS ★ 174 ⧗ 0](https://github.com/pellepl/spiffs) ⭐ 1,624 | 🐛 104 | 🌐 C | 📅 2026-07-16 - Wear-leveled SPI flash file system for embedded devices.
...
* [uIP ★ 246 ⧗ 3](https://github.com/adamdunkels/uip) ⭐ 1,083 | 🐛 5 | 🌐 C | 📅 2017-01-09 - uIP is a very small implementation of the TCP/IP stack.
...
* [XiPKI ★ 34 ⧗ 10](https://github.com/xipki/xipki) ⭐ 606 | 🐛 1 | 🌐 Java | 📅 2026-09-07 - eXtensible sImple Public Key Infrastructure consists of CA and OCSP responder.
* [xkcptun ★ 104 ⧗ 25](https://github.com/liudf0716/xkcptun) ⭐ 481 | 🐛 11 | 🌐 C | 📅 2026-09-06 - xkcptun is kcp tunnel for OpenWRT\&LEDE, implemented in c language
* [aWOT ★ 69 ⧗ 8](https://github.com/lasselukkari/aWOT) ⭐ 313 | 🐛 7 | 🌐 C++ | 📅 2025-01-16 - Web server library for Arduino, Teensy, ESP8266 and ESP32
* [Devices ★ 134 ⧗ 0](https://github.com/goiot/devices) ⭐ 264 | 🐛 9 | 🌐 Go | 📅 2016-07-10 - Suite of libraries for IoT devices (written in Go).
...
* [MQTTX ★ 12 ⧗ 0](https://github.com/emqx/MQTTX) ⭐ 5,045 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-17 - MQTTX is a cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows. It allows users to quickly and easily test MQTT / MQTTS connections, publish and subscribe to MQTT messages.
...
* [ReductStore ★ 360](https://github.com/reductstore/reductstore) ⭐ 368 | 🐛 18 | 🌐 Rust | 📅 2026-09-08 - high-performance blob and time-series storage for industrial IoT, with edge deployment, selective replication, and efficient querying of multimodal data.
* [AimDB ★ 2](https://github.com/aimdb-dev/aimdb) ⭐ 99 | 🐛 8 | 🌐 Rust | 📅 2026-09-08 - An async, in-memory data bridge that syncs records across microcontrollers, edge gateways and cloud instances. Define once, stream and sync everywhere.
...
* [Scanners-Box ★ 424 ⧗ 0](https://github.com/We5ter/Scanners-Box) ⭐ 9,038 | 🐛 0 | 📅 2026-08-12 - the toolbox of open source scanners.
...
* [nShield ★ 66 ⧗ 35](https://github.com/fnzv/nShield) ⭐ 252 | 🐛 6 | 🌐 Go | 📅 2021-11-09 - An Easy and Simple Anti-DDoS solution for VPS,Dedicated Servers and IoT devices based on iptables.

* [HookProbe](https://github.com/hookprobe/hookprobe) ⭐ 45 | 🐛 0 | 🌐 Python | 📅 2026-08-19 - Edge-first autonomous SOC and AI-native IDS for IoT network security. Runs on Raspberry Pi.
...
* [OpenWrt ★ 230 ⧗ 173](https://github.com/openwrt/openwrt) ⭐ 28,328 | 🐛 4,435 | 🌐 C | 📅 2026-09-08 - OpenWrt is described as a Linux distribution for embedded devices.

* [Zephyr ★ 352 ⧗ 5](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,447 | 🐛 3,854 | 🌐 C | 📅 2026-09-08 -  is a small, scalable real-time operating system for use on resource-constrained systems supporting multiple architectures.

* [RT-Thread ★ 493 ⧗ 0](https://github.com/RT-Thread/rt-thread) ⭐ 12,202 | 🐛 494 | 🌐 C | 📅 2026-09-08 - RT-Thread is an open source real-time operating system for embedded devices from China.
...
* [Tock OS ★ 243 ⧗ 1](https://github.com/helena-project/tock) ⭐ 6,435 | 🐛 207 | 🌐 Rust | 📅 2026-09-08 -  is an operating system designed for running multiple concurrent, mutually distrustful applications on Cortex-M based embedded platforms.

* **[RIOT ★ 748 ⧗ 1](https://github.com/RIOT-OS/RIOT) ⭐ 5,788 | 🐛 874 | 🌐 C | 📅 2026-09-08** - The friendly Operating System for the Internet of Things

* **[seL4 Microkernel ★ 1344 ⧗ 1](https://github.com/seL4/seL4) ⭐ 5,733 | 🐛 216 | 🌐 C | 📅 2026-08-25** - The world's first operating-system kernel with an end-to-end proof of implementation correctness and security enforcement is available as open source.

* [Huawei LiteOS ★ 341 ⧗ 3](https://github.com/LITEOS/LiteOS_Kernel) ⭐ 4,905 | 🐛 51 | 🌐 C | 📅 2022-05-31 - Huawei LiteOS Kernel.

* **[ARM mbed ★ 629 ⧗ 0](https://github.com/mbedmicro/mbed) ⭐ 4,872 | 🐛 211 | 🌐 C | 📅 2024-10-08** - The ARM® mbed™ IoT Device Platform provides the operating system, cloud services, tools and developer ecosystem to make the creation and deployment of commercial, standards-based IoT solutions possible at scale.

* **[Contiki ★ 1813 ⧗ 0](https://github.com/contiki-os/contiki) ⭐ 3,805 | 🐛 647 | 🌐 C | 📅 2024-04-06** - The Open Source OS for the Internet of Things
...
* [Mynewt](https://github.com/apache/mynewt-core) ⭐ 890 | 🐛 98 | 🌐 C | 📅 2026-09-08 is an open-source operating system for tiny embedded devices. Its goal is to make it easy to develop applications for microcontroller environments where power and cost are driving factors.

* [f9-kernel ★ 316 ⧗ 4](https://github.com/f9micro/f9-kernel) ⭐ 765 | 🐛 26 | 🌐 C | 📅 2026-03-25 - An efficient and secure microkernel built for ARM Cortex-M cores, inspired by L4

* [TinyAra ★ 35 ⧗ 1](https://github.com/Samsung/TinyAra) ⭐ 648 | 🐛 212 | 🌐 C | 📅 2026-09-08 - is a lightweight RTOS-based platform to support low-end IoT devices.
...
* **[Thingsboard ★ 5102 ⧗ 1700](https://github.com/thingsboard/thingsboard) ⭐ 22,386 | 🐛 296 | 🌐 Java | 📅 2026-09-08** - Open-source IoT Platform - Device management, data collection, processing and visualization.
* **[PlatformIO ★ 980 ⧗ 0](https://github.com/platformio/platformio) ⭐ 9,448 | 🐛 277 | 🌐 Python | 📅 2026-09-07** - PlatformIO is a cross-platform code builder and the missing library manager.
* [Fuxa SCADA/HMI/Dashboard ★ 2115 ⧗ 632](https://github.com/frangoteam/FUXA) ⭐ 4,993 | 🐛 398 | 🌐 TypeScript | 📅 2026-09-03 - FUXA is a web-based Process Visualization (SCADA/HMI/Dashboard) software. With FUXA you can create modern process visualizations/dashboards with individual designs for your machines/IOT application with real-time data display. Supports MQTT, OPC-UA, Modbus RTU/TCP, Siemens S7 Protocol, BACnet IP, Ethernet/IP (Allen Bradley), WebAPI
* [Mongoose IoT ★ 487 ⧗ 0](https://github.com/cesanta/iot) ⭐ 2,665 | 🐛 97 | 🌐 C | 📅 2026-07-26 -  is a full-stack IoT platform including firmware and cloud components available for ESP8266.
* **[IoT.js ★ 921 ⧗ 0](https://github.com/Samsung/iotjs) ⭐ 2,599 | 🐛 52 | 🌐 C | 📅 2021-06-18** - Platform for Internet of Things with JavaScript.
* **[IoT DC3 ★ 650 ⧗ 0](https://github.com/pnoker/iot-dc3) ⭐ 1,237 | 🐛 31 | 🌐 Java | 📅 2026-09-08** - A fully open-source, distributed industrial IoT platform built on Spring Cloud, evolving for AI scenarios. Enables rapid IoT project development and connected-device management. [(Docs)](https://docs.dc3.site)
* [HiveMQ ★ 329 ⧗ 0](https://github.com/hivemq/hivemq-community-edition) ⭐ 1,208 | 🐛 27 | 🌐 Java | 📅 2026-09-08 - is an open source MQTT platform and MQTT broker.
...
* [United Manufacturing Hub ★ 9 ⧗ 0](https://github.com/united-manufacturing-hub/united-manufacturing-hub) ⭐ 393 | 🐛 24 | 🌐 Go | 📅 2026-09-08 - The Open-Source Manufacturing App Platform (combines various open source solutions and packages them in a Helm chart, for example nodered, VerneMQ and timescaleDB)
...
* [Mobius ★ 46 ⧗ 2](https://github.com/IoTKETI/Mobius) ⭐ 152 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-07 -  is the open source IoT server platform based on the oneM2M standard.
...
* [DeviceChain](https://github.com/devicechain-io/devicechain) ⭐ 3 | 🐛 18 | 🌐 Go | 📅 2026-09-08 - Apache-2.0 self-hosted IoT platform written in Go and React. Multi-tenant microservices on Kubernetes: MQTT/Sparkplug B/LwM2M ingest, TimescaleDB time-series storage, a CEL-based rule engine with alarms and outbound connectors, versioned dashboards, and GraphQL APIs. [(Docs)](https://docs.devicechain.io)
...
* [IoTSharp](https://github.com/IoTSharp/IoTSharp) ⭐ 1,375 | 🐛 5 | 🌐 C# | 📅 2026-09-05 - IoTSharp is an open-source IoT platform.
...
* [ForestHub](https://foresthub.ai) - Edge AI agent platform; its open-source runtime [edge-agents](https://github.com/ForestHubAI/edge-agents) ⭐ 101 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-24 runs AI agents offline on Linux edge gateways with local SLMs, cloud LLMs and MQTT as first-class nodes.
...
* [OGC SensorThings API ★ 21 ⧗ 15](https://github.com/opengeospatial/sensorthings) ⭐ 168 | 🐛 95 | 📅 2026-09-07 - The OGC SensorThings API is an OGC standard specification for providing an open and unified way to interconnect IoT devices, data, and applications over the Web
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,730 | 🐛 244 | 🌐 Java | 📅 2026-09-08 - A Multi-protocol event-native edge/service proxy that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* **[Kuzzle ★ 502 ⧗ 0](https://github.com/kuzzleio/kuzzle) ⭐ 1,673 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-08** - An open-source backend with advanced features like real-time pub/sub or geofencing and a multiprotocol interface that supports MQTT, LoRaWAN and more. [(Website)](https://kuzzle.io/solutions/technologies/iot-backend/)
* [Shifu ★ 312 ⧗ 0](https://github.com/Edgenesis/shifu) ⭐ 1,435 | 🐛 28 | 🌐 Go | 📅 2026-08-31 - Shifu is a Kubernetes native IoT development framework that supports multi-protocol device access.
...
* [Renode ★ 81 ⧗ 0](https://github.com/renode/renode) ⭐ 2,862 | 🐛 437 | 🌐 RobotFramework | 📅 2026-09-08 - a virtual development tool for multinode embedded networks.
...
* [Electrum ★ 4 ⧗ 1](https://github.com/yoelf22/electrum) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-07-17 - A structured, AI-assisted toolkit for defining hardware products that have software inside — from concept through engineering spec to presentation-ready materials in eight phases.
...
* **[D3.JS ★ 49188 ⧗ 0](https://github.com/mbostock/d3) ⭐ 113,683 | 🐛 20 | 🌐 Shell | 📅 2026-05-28** - A JavaScript visualization library for HTML and SVG
* **[ECharts ★ 11457 ⧗ 0](https://github.com/ecomfe/echarts) ⭐ 67,267 | 🐛 1,510 | 🌐 TypeScript | 📅 2026-09-04** - Echarts is a commercial charting solution originally intended to address the report need of the Company's various business systems.
* **[HighCharts ★ 4949 ⧗ 0](https://github.com/highslide-software/highcharts.com) ⭐ 12,488 | 🐛 816 | 🌐 TypeScript | 📅 2026-09-08** - Highcharts JS, the JavaScript charting framework
...
* [PULPino ★ 201 ⧗ 0](https://github.com/pulp-platform/pulpino) ⭐ 1,064 | 🐛 130 | 🌐 C | 📅 2024-02-06 - PULPino is an open-source microcontroller system, based on a small 32-bit RISC-V core developed at ETH Zurich.
...
* [Widora ★ 15 ⧗ 21](https://github.com/widora/openwrt_widora) ⭐ 174 | 🐛 5 | 🌐 C | 📅 2025-09-12 - Widora is open source WiFi development hardware prototype with sound card based on MT7688A running [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,328 | 🐛 4,435 | 🌐 C | 📅 2026-09-08.
...
* **[Homebridge ★ 3030 ⧗ 0](https://github.com/nfarina/homebridge) ⭐ 25,482 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-30** - Homebridge is a lightweight NodeJS server you can run on your home network that emulates the iOS HomeKit API.
* [Node-RED](https://github.com/node-red/node-red) ⭐ 23,636 | 🐛 325 | 🌐 JavaScript | 📅 2026-09-08 - Node-RED is a programming tool for wiring together hardware devices, APIs and online services in new and interesting ways.
* **[Smart Mirror ★ 1181 ⧗ 0](https://github.com/evancohen/smart-mirror) ⭐ 2,821 | 🐛 19 | 🌐 JavaScript | 📅 2024-07-02** - The fairest of them all. A DIY voice controlled smart mirror with IoT integration.
...
* **[heimcontrol.js ★ 1306 ⧗ 4](https://github.com/ni-c/heimcontrol.js) ⚠️ Archived** -  Home-Automation with node.js and Raspberry PI
* **[openHAB ★ 2536 ⧗ 0](https://github.com/openhab/openhab-distro) ⭐ 1,390 | 🐛 70 | 🌐 PowerShell | 📅 2026-09-07** - a vendor and technology agnostic open source automation software for your home.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 169 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-08 - Cross-platform Node.js service that reads BLE smart scales, calculates body composition, and exports readings to MQTT with Home Assistant auto-discovery, InfluxDB, Garmin Connect, and webhooks.
...
* [homebridge-blink-security](https://github.com/BitWise-0x/homebridge-blink-security) ⭐ 14 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-04 - Homebridge plugin for Blink cameras, doorbells, and sirens with live streaming, arm/disarm, and motion detection via Apple HomeKit.
* [homebridge-smartrent](https://github.com/BitWise-0x/homebridge-smartrent) ⭐ 4 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-05 - Homebridge plugin for SmartRent locks, thermostats, leak sensors, and switches with real-time WebSocket updates via Apple HomeKit.
...
* [DevIoT ★ 70 ⧗ 1](https://github.com/gepd/Deviot) ⭐ 311 | 🐛 93 | 🌐 Python | 📅 2024-01-15 - Sublime Text plugin for IoT development.
...
* **[AirSim ★ 2606 ⧗ 1](https://github.com/Microsoft/AirSim) ⭐ 18,461 | 🐛 780 | 🌐 C++ | 📅 2026-06-30** -  is a simulator for drones (and soon other vehicles) built on Unreal Engine.
* **[hubot ★ 10481 ⧗ 0](https://github.com/github/hubot) ⭐ 16,797 | 🐛 7 | 🌐 JavaScript | 📅 2026-09-03** - A customizable life embetterment robot.
* **[artoo ★ 1269 ⧗ 0](https://github.com/hybridgroup/artoo) ⭐ 1,540 | 🐛 21 | 🌐 Ruby | 📅 2023-12-19** - Ruby framework for robotics and the Internet of Things.

## Others

for embedded systems (IoT in mind).

* **[Sonoff-Tasmota ★ 4869 ⧗ 0](https://github.com/arendst/Sonoff-Tasmota) ⭐ 24,742 | 🐛 16 | 🌐 C | 📅 2026-09-08** - Provide ESP8266 based itead Sonoff with Web, MQTT and OTA firmware using Arduino IDE.
* **[Node-RED ★ 2513 ⧗ 0](https://github.com/node-red/node-red) ⭐ 23,636 | 🐛 325 | 🌐 JavaScript | 📅 2026-09-08** - A visual tool for wiring the Internet of Things.
* **[ESP8266 Deauther ★ 3806 ⧗ 0](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,962 | 🐛 99 | 🌐 C | 📅 2024-08-14** -  allows you to perform a deauth attack with an ESP8266 against selected networks.
* [fluent-bit ★ 90 ⧗ 4](https://github.com/fluent/fluent-bit) ⭐ 8,085 | 🐛 760 | 🌐 C | 📅 2026-09-08 - is a data collector for Linux, Embedded Linux, OSX and BSD family operating systems.
...
* [boto3-refresh-session](https://github.com/michaelthomasletts/boto3-refresh-session) ⭐ 52 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - A drop-in replacement for `boto3.session.Session` for automatically refreshing temporary AWS credentials from the AWS IoT Core credential provider (using an X.509 certificate).
...
* [FoundryNet Canonical Schema](https://github.com/FoundryNet/canonical-schema) ⭐ 0 | 🐛 0 | 📅 2026-08-26 - Open universal schema for industrial equipment telemetry normalization. 366 canonical fields, 16,908 cross-vendor mappings across 18 OEM families. MIT licensed.
...
* **[MicroPython ★ 3070 ⧗ 0](https://github.com/micropython/micropython) ⭐ 22,051 | 🐛 1,522 | 🌐 C | 📅 2026-09-08** - MicroPython is a lean and fast implementation of the Python 3 programming language that is optimised to run on a microcontroller.
...
* **[luvit ★ 2237 ⧗ 0](https://github.com/luvit/luvit) ⭐ 3,966 | 🐛 95 | 🌐 Lua | 📅 2026-04-02** - Node.JS for the Lua Inventor.
...
* [AtomVM ★ 390 ⧗ 0](https://github.com/bettio/AtomVM) ⭐ 2,225 | 🐛 184 | 🌐 Erlang | 📅 2026-07-31 - AtomVM is a tiny portable virtual machine that allows Erlang and Elixir code to run on microcontrollers with less than 500KB of RAM such as the ESP32.
* **[PikaScript ★ 660 ⧗ 36](https://github.com/pikasTech/pikaScript) ⭐ 1,754 | 🐛 28 | 🌐 C | 📅 2026-09-02** - PikaScript is a extremely lightweight python engine that can run with less than 4KB of RAM such as stm32g030c8 and stm32f103c8. It is zero dependency, zero configuration, easy to deploy and expand.
...
* [eLua ★ 393 ⧗ 1](https://github.com/elua/elua) ⭐ 984 | 🐛 41 | 🌐 C | 📅 2024-03-25 - Quickly prototype and develop embedded software applications with the power of Lua and run them on a wide range of microcontroller architectures.
...
* **[mbed TLS ★ 601 ⧗ 0](https://github.com/ARMmbed/mbedtls) ⭐ 6,951 | 🐛 1,721 | 🌐 C | 📅 2026-09-08** - An open source, portable, easy to use, readable and flexible SSL library
* **[UniK ★ 593 ⧗ 0](https://github.com/emc-advanced-dev/unik) ⭐ 2,823 | 🐛 51 | 🌐 Go | 📅 2023-04-27** -  is a tool for compiling application sources into unikernels (lightweight bootable disk images) rather than binaries.
...
* **[EMQX ★ 10300 ⧗ 1800](https://github.com/emqx/emqx) ⭐ 16,699 | 🐛 190 | 🌐 Erlang | 📅 2026-09-08** - An ultra-scalable open-source MQTT broker. Connect 100M+ IoT devices in one single cluster, move and process real-time IoT data with 1M msg/s throughput at 1ms latency.
* [Mosquitto ★ 158 ⧗ 0](https://github.com/eclipse/mosquitto) ⭐ 11,185 | 🐛 881 | 🌐 C | 📅 2026-09-03 - An Open Source MQTT v3.1/v3.1.1 Broker.
* **[MQTT.js ★ 1359 ⧗ 0](https://github.com/mqttjs/MQTT.js) ⭐ 9,114 | 🐛 36 | 🌐 TypeScript | 📅 2026-07-20** - The MQTT client for Node.js and the browser.
* **[PubSub Client ★ 684 ⧗ 0](https://github.com/knolleary/pubsubclient) ⭐ 4,015 | 🐛 568 | 🌐 C++ | 📅 2026-06-10** - A client library for the Arduino Ethernet Shield that provides support for MQTT.
* **[VerneMQ ★ 561 ⧗ 1](https://github.com/erlio/vernemq) ⭐ 3,628 | 🐛 171 | 🌐 Erlang | 📅 2026-09-04** - A distributed MQTT message broker.
...
* [moquette ★ 2239 ⧗ 2](https://github.com/moquette-io/moquette) ⭐ 2,454 | 🐛 141 | 🌐 Java | 📅 2026-08-31 - Java MQTT lightweight broker.
* [Eclipse Paho MQTT C client ★ 142 ⧗ 3](https://github.com/eclipse/paho.mqtt.c) ⭐ 2,366 | 🐛 214 | 🌐 C | 📅 2026-07-21 - This code builds libraries which enable applications to connect to an MQTT broker to publish messages, and to subscribe to topics and receive published messages.
* [Homie for ESP8266 ★ 115 ⧗ 1](https://github.com/marvinroger/homie-esp8266) ⭐ 1,372 | 🐛 89 | 🌐 HTML | 📅 2026-03-06 - An Arduino for ESP8266 implementation of Homie, an MQTT convention for the IoT.
...
* [ESP8266 MQTT ★ 440 ⧗ 0](https://github.com/tuanpmt/esp_mqtt) ⭐ 1,171 | 🐛 41 | 🌐 C | 📅 2020-12-22 - MQTT client library for ESP8266 Soc
* [arduino-mqtt ★ 95 ⧗ 6](https://github.com/256dpi/arduino-mqtt) ⭐ 1,095 | 🐛 24 | 🌐 C | 📅 2026-04-16 - MQTT library for Arduino based on the Eclipse Paho projects.
...
* [WolfSSL MQTT ★ 155 ⧗ 14](https://github.com/wolfSSL/wolfMQTT) ⭐ 593 | 🐛 36 | 🌐 C | 📅 2026-08-26 - A C MQTT library that works with WolfSSL.
* [paho.mqtt.wxapp ★ 196 ⧗ 0](https://github.com/tennessine/paho.mqtt.wxapp) ⭐ 308 | 🐛 3 | 🌐 JavaScript | 📅 2021-12-03 - paho.mqtt.javascript可以让你在微信小程序里连接MQTT broker，实现在小程序里控制硬件，也可用于游戏。
...
* [Californium ★ 36 ⧗ 0](https://github.com/eclipse/californium) ⭐ 777 | 🐛 22 | 🌐 Java | 📅 2026-08-30 - Californium is a Java implementation of CoAP for the IoT backend and less constrained IoT devices.
* [Node CoAP ★ 176 ⧗ 11](https://github.com/mcollina/node-coap) ⭐ 552 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-12 - node-coap is a client and server library for CoAP modeled after the http module.
...
* [java-coap ★ 3 ⧗ 0](https://github.com/open-coap/java-coap) ⭐ 34 | 🐛 8 | 🌐 Java | 📅 2026-09-08 - Complete CoAP implementation in java (it is a fork with lots of improvements).
...
* [LowCostLoRaGw ★ 161 ⧗ 4](https://github.com/CongducPham/LowCostLoRaGw) ⭐ 748 | 🐛 228 | 🌐 C | 📅 2026-04-21 - Low-cost LoRa IoT & gateway with SX1272/76, Raspberry and Arduino.
...
* **[OpenThread ★ 1139 ⧗ 2](https://github.com/openthread/openthread) ⭐ 4,027 | 🐛 160 | 🌐 C++ | 📅 2026-09-08** - OpenThread is an open-source implementation of the Thread networking protocol.
* [OpenThread Border Router ★ 64 ⧗ 0](https://github.com/openthread/borderrouter) ⭐ 568 | 🐛 53 | 🌐 C++ | 📅 2026-09-08 - An open source border router, built to work with OpenThread.

### Others

* **[libimobiledevice ★ 2294 ⧗ 0](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,173 | 🐛 846 | 🌐 C | 📅 2026-06-10** - A library to communicate with services of Apple iOS devices using native protocols.
...
* [Anjay ★ 16 ⧗ 23](https://github.com/AVSystem/Anjay) ⭐ 219 | 🐛 0 | 🌐 C | 📅 2026-07-09 - is a C library that aims to be the reference implementation of the OMA Lightweight Machine-to-Machine (LwM2M) device management protocol.
...
* [libmodbus ★ 2400 ⧗ 50](https://github.com/stephane/libmodbus) ⭐ 4,246 | 🐛 188 | 🌐 C | 📅 2026-07-02 - A Modbus library for Linux, Mac OS, FreeBSD, QNX and Windows, written in C.
* [pymodbus ★ 2400 ⧗ 100](https://github.com/pymodbus-dev/pymodbus) ⭐ 2,765 | 🐛 1 | 🌐 Python | 📅 2026-09-02 - A full Modbus protocol implementation for Python, supporting RTU, TCP, ASCII over serial and network transports.
...
* [libnfc ★ 119 ⧗ 4](https://github.com/nfc-tools/libnfc) ⭐ 1,988 | 🐛 120 | 🌐 C | 📅 2025-03-05 - Platform independent Near Field Communication library.
* [RFIDIOt ★ 314 ⧗ 6](https://github.com/AdamLaurie/RFIDIOt) ⭐ 1,117 | 🐛 23 | 🌐 Python | 📅 2024-10-25 - python RFID / NFC library & tools.
...
* [LibLogicalAccess ★ 53 ⧗ 17](https://github.com/islog/liblogicalaccess) ⭐ 275 | 🐛 18 | 🌐 C++ | 📅 2026-08-17 - C++ RFID Library for Windows/Linux/Mac. For PC/SC, NFC, ISO compliant and proprietary hardware.
...
* **[Servo ★ 7821 ⧗ 0](https://github.com/servo/servo) ⭐ 37,941 | 🐛 3,207 | 🌐 Rust | 📅 2026-09-08** -  is a prototype web browser engine written in the Rust language.
* **[Drake ★ 500 ⧗ 0](https://github.com/RobotLocomotion/drake) ⭐ 4,181 | 🐛 673 | 🌐 C++ | 📅 2026-09-08** -  is a toolbox maintained by the Robot Locomotion Group at the MIT Computer Science and Artificial Intelligence Lab (CSAIL).
* [ShellHub ★ 702 ⧗ 70](https://github.com/shellhub-io/shellhub) ⭐ 2,065 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-08 - Centralized SSH for the the edge and cloud computing.
* [The Things Stack ★ 887 ⧗ 4](https://github.com/TheThingsNetwork/lorawan-stack) ⭐ 1,162 | 🐛 185 | 🌐 Go | 📅 2026-09-08 - The Things Stack, an open source LoRaWAN network server created by The Things Industries. Creators of the global open crowdsourced Internet of Things data network The Things Network.
...
* [Balena ★ 329 ⧗ 3](https://github.com/resin-os/balena) ⭐ 742 | 🐛 94 | 🌐 Go | 📅 2026-09-01 -  is a new container engine purpose-built for embedded and IoT use cases and compatible with Docker containers.
...
* [Smart.js ★ 487 ⧗ 0](https://github.com/cesanta/smart.js) ⭐ 2,665 | 🐛 97 | 🌐 C | 📅 2026-07-26 - Embedded Javascript engine for C/C++ with networking, file, database and device interfaces
...
* **[Design IoT ★ 594 ⧗ 0](https://github.com/phodal/designiot) ⭐ 2,225 | 🐛 2 | 🌐 HTML | 📅 2021-06-25** - A Ebook to tech your create IoT System step by step.
...
* **[awesome-mqtt ★ 668 ⧗ 0](https://github.com/hobbyquaker/awesome-mqtt) ⭐ 2,394 | 🐛 0 | 📅 2026-09-01** - Curated list of MQTT related stuff.
...
* [100 Days 100 IoT Projects](https://github.com/kritishmohapatra/100_Days_100_IoT_Projects) ⭐ 1,183 | 🐛 0 | 🌐 Python | 📅 2026-07-17 - A 100-day challenge building real-world IoT projects with MicroPython on ESP32, ESP8266 and Raspberry Pi Pico 2W. Step-by-step documented with wiring diagrams and code for beginners.
...
* **[AREG SDK ★ 15 ⧗ 0](https://github.com/aregtech/areg-sdk) ⭐ 365 | 🐛 24 | 🌐 C++ | 📅 2026-09-08** - AREG SDK is a developer-friendly, an interface-centric real-time asynchronous communication engine to enable distributed- and [mist-computing](https://csrc.nist.gov/publications/detail/sp/500-325/final), where connected Things interact and provide services, as if they act like thin distributed servers.
* [Eden ★ 25 ⧗ 0](https://github.com/lf-edge/eden) ⭐ 55 | 🐛 51 | 🌐 Go | 📅 2026-09-02 - CLI for Edge Virtualization Engine (EVE)
...
* [CosmoEdge](https://github.com/cosmo-wander-ai/cosmo-edge) ⭐ 724 | 🐛 10 | 🌐 C | 📅 2026-09-08 - Production-oriented C++ edge video AI engine that connects RTSP streams to CV/VLM inference, visual orchestration, alarms, and MQTT/webhook events on Sophon and Rockchip NPUs.
...
* [Genesis 2](https://github.com/larionovavi-stack/genesis2-cascade-moe) ⭐ 1 | 🐛 0 | 🌐 HTML | 📅 2026-09-06 - Cascade MoE neural network for IoT edge deployments. CPU-only inference (18ms), no GPU required, patented architecture with zero catastrophic forgetting.
* [libdeep](https://github.com/bashrc/libdeep) - A deep learning library for C/C++.

## Analytics

* **[NetData ★ 18973 ⧗ 0](https://github.com/firehol/netdata) ⭐ 80,466 | 🐛 399 | 🌐 Go | 📅 2026-09-08** - is a system for distributed real-time performance and health monitoring.
* **[Piwik ★ 5374 ⧗ 0](https://github.com/piwik/piwik) ⭐ 21,846 | 🐛 2,571 | 🌐 PHP | 📅 2026-09-08** - Piwik is the leading Free/Libre open analytics platform.
...
* [Eclipse Ditto](https://github.com/eclipse/ditto) ⭐ 920 | 🐛 88 | 🌐 Java | 📅 2026-09-08 is the open-source project of Eclipse IoT that provides a ready-to-use functionality to manage the state of Digital Twins.
