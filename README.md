...
* **[Serverless ★ 7951 ⧗ 0](https://github.com/serverless/serverless) ⭐ 46,918 | 🐛 1,218 | 🌐 JavaScript | 📅 2026-09-07** - Serverless is the application framework for building web, mobile and IoT applications exclusively on Amazon Web Services' Lambda and API Gateway.
* **[ESP-IDF ★ 2542 ⧗ 0](https://github.com/espressif/esp-idf) ⭐ 18,963 | 🐛 1,678 | 🌐 C | 📅 2026-09-07** - The official framework from Espressif to build Wi-Fi, BLE, and BT apps with ESP32.
...
* **[.NET Core IoT ★ 1193 ⧗ 292](https://github.com/dotnet/iot) ⭐ 2,406 | 🐛 94 | 🌐 C# | 📅 2026-09-07** - A set of libraries to interact with sensors, displays and input devices from .NET Core framework.
...
* [Thingsboard IoT Gateway ★ 463 ⧗ 246](https://github.com/thingsboard/thingsboard-gateway) ⭐ 2,183 | 🐛 85 | 🌐 Python | 📅 2026-09-07 - open-source IoT Gateway - integrates devices connected to legacy and third-party systems with Thingsboard IoT Platform using OPC-UA and MQTT protocols.
...
* [Kura ★ 85 ⧗ 1](https://github.com/eclipse/kura) ⭐ 574 | 🐛 19 | 🌐 Java | 📅 2026-09-07 - an open-source framework for development of IoT applications
...
* [Jumpstarter ★ 28 ⧗ 0](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 216 | 🐛 182 | 🌐 Python | 📅 2026-09-07 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual IoT hardware with CI/CD integration.
...
* [Armbian build SDK ★ 630](https://github.com/armbian/build) ⭐ 5,404 | 🐛 125 | 🌐 Shell | 📅 2026-09-07 - for creating customized kernel and Debian based userspace for popular development boards.
...
* [MCUBoot ★ 43 ⧗ 3](https://github.com/runtimeco/mcuboot) ⭐ 2,094 | 🐛 96 | 🌐 C | 📅 2026-09-07 - is a secure bootloader for 32-bit MCUs.
...
* [ReductStore ★ 360](https://github.com/reductstore/reductstore) ⭐ 368 | 🐛 20 | 🌐 Rust | 📅 2026-09-07 - high-performance blob and time-series storage for industrial IoT, with edge deployment, selective replication, and efficient querying of multimodal data.
* [AimDB ★ 2](https://github.com/aimdb-dev/aimdb) ⭐ 99 | 🐛 8 | 🌐 Rust | 📅 2026-09-06 - An async, in-memory data bridge that syncs records across microcontrollers, edge gateways and cloud instances. Define once, stream and sync everywhere.
...
* [OpenWrt ★ 230 ⧗ 173](https://github.com/openwrt/openwrt) ⭐ 28,315 | 🐛 4,438 | 🌐 C | 📅 2026-09-07 - OpenWrt is described as a Linux distribution for embedded devices.

* [Zephyr ★ 352 ⧗ 5](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,431 | 🐛 3,889 | 🌐 C | 📅 2026-09-07 -  is a small, scalable real-time operating system for use on resource-constrained systems supporting multiple architectures.

* [RT-Thread ★ 493 ⧗ 0](https://github.com/RT-Thread/rt-thread) ⭐ 12,200 | 🐛 493 | 🌐 C | 📅 2026-09-07 - RT-Thread is an open source real-time operating system for embedded devices from China.
...
* [Tock OS ★ 243 ⧗ 1](https://github.com/helena-project/tock) ⭐ 6,434 | 🐛 209 | 🌐 Rust | 📅 2026-09-04 -  is an operating system designed for running multiple concurrent, mutually distrustful applications on Cortex-M based embedded platforms.

* **[RIOT ★ 748 ⧗ 1](https://github.com/RIOT-OS/RIOT) ⭐ 5,785 | 🐛 871 | 🌐 C | 📅 2026-09-07** - The friendly Operating System for the Internet of Things
...
* [Mynewt](https://github.com/apache/mynewt-core) ⭐ 890 | 🐛 101 | 🌐 C | 📅 2026-09-02 is an open-source operating system for tiny embedded devices. Its goal is to make it easy to develop applications for microcontroller environments where power and cost are driving factors.
...
* [TinyAra ★ 35 ⧗ 1](https://github.com/Samsung/TinyAra) ⭐ 648 | 🐛 216 | 🌐 C | 📅 2026-09-04 - is a lightweight RTOS-based platform to support low-end IoT devices.
...
* **[Thingsboard ★ 5102 ⧗ 1700](https://github.com/thingsboard/thingsboard) ⭐ 22,379 | 🐛 299 | 🌐 Java | 📅 2026-09-04** - Open-source IoT Platform - Device management, data collection, processing and visualization.
* **[PlatformIO ★ 980 ⧗ 0](https://github.com/platformio/platformio) ⭐ 9,443 | 🐛 277 | 🌐 Python | 📅 2026-09-07** - PlatformIO is a cross-platform code builder and the missing library manager.
* [Fuxa SCADA/HMI/Dashboard ★ 2115 ⧗ 632](https://github.com/frangoteam/FUXA) ⭐ 4,988 | 🐛 398 | 🌐 TypeScript | 📅 2026-09-03 - FUXA is a web-based Process Visualization (SCADA/HMI/Dashboard) software. With FUXA you can create modern process visualizations/dashboards with individual designs for your machines/IOT application with real-time data display. Supports MQTT, OPC-UA, Modbus RTU/TCP, Siemens S7 Protocol, BACnet IP, Ethernet/IP (Allen Bradley), WebAPI
...
* **[IoT DC3 ★ 650 ⧗ 0](https://github.com/pnoker/iot-dc3) ⭐ 1,232 | 🐛 33 | 🌐 Java | 📅 2026-09-04** - A fully open-source, distributed industrial IoT platform built on Spring Cloud, evolving for AI scenarios. Enables rapid IoT project development and connected-device management. [(Docs)](https://docs.dc3.site)
...
* [United Manufacturing Hub ★ 9 ⧗ 0](https://github.com/united-manufacturing-hub/united-manufacturing-hub) ⭐ 393 | 🐛 26 | 🌐 Go | 📅 2026-09-07 - The Open-Source Manufacturing App Platform (combines various open source solutions and packages them in a Helm chart, for example nodered, VerneMQ and timescaleDB)
...
* [Mobius ★ 46 ⧗ 2](https://github.com/IoTKETI/Mobius) ⭐ 151 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-07 -  is the open source IoT server platform based on the oneM2M standard.
...
* [DeviceChain](https://github.com/devicechain-io/devicechain) ⭐ 3 | 🐛 12 | 🌐 Go | 📅 2026-09-07 - Apache-2.0 self-hosted IoT platform written in Go and React. Multi-tenant microservices on Kubernetes: MQTT/Sparkplug B/LwM2M ingest, TimescaleDB time-series storage, a CEL-based rule engine with alarms and outbound connectors, versioned dashboards, and GraphQL APIs. [(Docs)](https://docs.devicechain.io)
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,730 | 🐛 242 | 🌐 Java | 📅 2026-09-07 - A Multi-protocol event-native edge/service proxy that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [Shifu ★ 312 ⧗ 0](https://github.com/Edgenesis/shifu) ⭐ 1,434 | 🐛 28 | 🌐 Go | 📅 2026-08-31 - Shifu is a Kubernetes native IoT development framework that supports multi-protocol device access.
...
* [Renode ★ 81 ⧗ 0](https://github.com/renode/renode) ⭐ 2,856 | 🐛 437 | 🌐 RobotFramework | 📅 2026-09-07 - a virtual development tool for multinode embedded networks.
...
* **[D3.JS ★ 49188 ⧗ 0](https://github.com/mbostock/d3) ⭐ 113,673 | 🐛 20 | 🌐 Shell | 📅 2026-05-28** - A JavaScript visualization library for HTML and SVG
* **[ECharts ★ 11457 ⧗ 0](https://github.com/ecomfe/echarts) ⭐ 67,262 | 🐛 1,516 | 🌐 TypeScript | 📅 2026-09-04** - Echarts is a commercial charting solution originally intended to address the report need of the Company's various business systems.
* **[HighCharts ★ 4949 ⧗ 0](https://github.com/highslide-software/highcharts.com) ⭐ 12,488 | 🐛 816 | 🌐 TypeScript | 📅 2026-09-07** - Highcharts JS, the JavaScript charting framework
...
* [Widora ★ 15 ⧗ 21](https://github.com/widora/openwrt_widora) ⭐ 174 | 🐛 5 | 🌐 C | 📅 2025-09-12 - Widora is open source WiFi development hardware prototype with sound card based on MT7688A running [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,315 | 🐛 4,438 | 🌐 C | 📅 2026-09-07.
...
* **[Homebridge ★ 3030 ⧗ 0](https://github.com/nfarina/homebridge) ⭐ 25,480 | 🐛 16 | 🌐 TypeScript | 📅 2026-08-30** - Homebridge is a lightweight NodeJS server you can run on your home network that emulates the iOS HomeKit API.
* [Node-RED](https://github.com/node-red/node-red) ⭐ 23,632 | 🐛 324 | 🌐 JavaScript | 📅 2026-09-07 - Node-RED is a programming tool for wiring together hardware devices, APIs and online services in new and interesting ways.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 168 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-07 - Cross-platform Node.js service that reads BLE smart scales, calculates body composition, and exports readings to MQTT with Home Assistant auto-discovery, InfluxDB, Garmin Connect, and webhooks.
...
* **[AirSim ★ 2606 ⧗ 1](https://github.com/Microsoft/AirSim) ⭐ 18,458 | 🐛 780 | 🌐 C++ | 📅 2026-06-30** -  is a simulator for drones (and soon other vehicles) built on Unreal Engine.
...
* **[Sonoff-Tasmota ★ 4869 ⧗ 0](https://github.com/arendst/Sonoff-Tasmota) ⭐ 24,740 | 🐛 13 | 🌐 C | 📅 2026-09-07** - Provide ESP8266 based itead Sonoff with Web, MQTT and OTA firmware using Arduino IDE.
* **[Node-RED ★ 2513 ⧗ 0](https://github.com/node-red/node-red) ⭐ 23,632 | 🐛 324 | 🌐 JavaScript | 📅 2026-09-07** - A visual tool for wiring the Internet of Things.
* **[ESP8266 Deauther ★ 3806 ⧗ 0](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,960 | 🐛 99 | 🌐 C | 📅 2024-08-14** -  allows you to perform a deauth attack with an ESP8266 against selected networks.
* [fluent-bit ★ 90 ⧗ 4](https://github.com/fluent/fluent-bit) ⭐ 8,082 | 🐛 753 | 🌐 C | 📅 2026-09-07 - is a data collector for Linux, Embedded Linux, OSX and BSD family operating systems.
...
* **[MicroPython ★ 3070 ⧗ 0](https://github.com/micropython/micropython) ⭐ 22,048 | 🐛 1,526 | 🌐 C | 📅 2026-09-07** - MicroPython is a lean and fast implementation of the Python 3 programming language that is optimised to run on a microcontroller.
...
* **[PikaScript ★ 660 ⧗ 36](https://github.com/pikasTech/pikaScript) ⭐ 1,753 | 🐛 28 | 🌐 C | 📅 2026-09-02** - PikaScript is a extremely lightweight python engine that can run with less than 4KB of RAM such as stm32g030c8 and stm32f103c8. It is zero dependency, zero configuration, easy to deploy and expand.
...
* **[mbed TLS ★ 601 ⧗ 0](https://github.com/ARMmbed/mbedtls) ⭐ 6,947 | 🐛 1,720 | 🌐 C | 📅 2026-09-03** - An open source, portable, easy to use, readable and flexible SSL library
...
* **[EMQX ★ 10300 ⧗ 1800](https://github.com/emqx/emqx) ⭐ 16,699 | 🐛 189 | 🌐 Erlang | 📅 2026-09-07** - An ultra-scalable open-source MQTT broker. Connect 100M+ IoT devices in one single cluster, move and process real-time IoT data with 1M msg/s throughput at 1ms latency.
* [Mosquitto ★ 158 ⧗ 0](https://github.com/eclipse/mosquitto) ⭐ 11,187 | 🐛 880 | 🌐 C | 📅 2026-09-03 - An Open Source MQTT v3.1/v3.1.1 Broker.
...
* [Eclipse Paho MQTT C client ★ 142 ⧗ 3](https://github.com/eclipse/paho.mqtt.c) ⭐ 2,365 | 🐛 214 | 🌐 C | 📅 2026-07-21 - This code builds libraries which enable applications to connect to an MQTT broker to publish messages, and to subscribe to topics and receive published messages.
...
* [arduino-mqtt ★ 95 ⧗ 6](https://github.com/256dpi/arduino-mqtt) ⭐ 1,094 | 🐛 24 | 🌐 C | 📅 2026-04-16 - MQTT library for Arduino based on the Eclipse Paho projects.
...
* **[OpenThread ★ 1139 ⧗ 2](https://github.com/openthread/openthread) ⭐ 4,027 | 🐛 160 | 🌐 C++ | 📅 2026-09-07** - OpenThread is an open-source implementation of the Thread networking protocol.
* [OpenThread Border Router ★ 64 ⧗ 0](https://github.com/openthread/borderrouter) ⭐ 568 | 🐛 55 | 🌐 C++ | 📅 2026-09-07 - An open source border router, built to work with OpenThread.

### Others

* **[libimobiledevice ★ 2294 ⧗ 0](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,172 | 🐛 846 | 🌐 C | 📅 2026-06-10** - A library to communicate with services of Apple iOS devices using native protocols.
...
* **[Servo ★ 7821 ⧗ 0](https://github.com/servo/servo) ⭐ 37,936 | 🐛 3,196 | 🌐 Rust | 📅 2026-09-07** -  is a prototype web browser engine written in the Rust language.
* **[Drake ★ 500 ⧗ 0](https://github.com/RobotLocomotion/drake) ⭐ 4,179 | 🐛 674 | 🌐 C++ | 📅 2026-09-07** -  is a toolbox maintained by the Robot Locomotion Group at the MIT Computer Science and Artificial Intelligence Lab (CSAIL).
* [ShellHub ★ 702 ⧗ 70](https://github.com/shellhub-io/shellhub) ⭐ 2,065 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-06 - Centralized SSH for the the edge and cloud computing.
* [The Things Stack ★ 887 ⧗ 4](https://github.com/TheThingsNetwork/lorawan-stack) ⭐ 1,162 | 🐛 182 | 🌐 Go | 📅 2026-09-07 - The Things Stack, an open source LoRaWAN network server created by The Things Industries. Creators of the global open crowdsourced Internet of Things data network The Things Network.
...
* [CosmoEdge](https://github.com/cosmo-wander-ai/cosmo-edge) ⭐ 658 | 🐛 11 | 🌐 C | 📅 2026-09-07 - Production-oriented C++ edge video AI engine that connects RTSP streams to CV/VLM inference, visual orchestration, alarms, and MQTT/webhook events on Sophon and Rockchip NPUs.
...
* **[NetData ★ 18973 ⧗ 0](https://github.com/firehol/netdata) ⭐ 80,456 | 🐛 398 | 🌐 Go | 📅 2026-09-07** - is a system for distributed real-time performance and health monitoring.
* **[Piwik ★ 5374 ⧗ 0](https://github.com/piwik/piwik) ⭐ 21,845 | 🐛 2,570 | 🌐 PHP | 📅 2026-09-07** - Piwik is the leading Free/Libre open analytics platform.
...
* [Eclipse Ditto](https://github.com/eclipse/ditto) ⭐ 921 | 🐛 90 | 🌐 Java | 📅 2026-09-07 is the open-source project of Eclipse IoT that provides a ready-to-use functionality to manage the state of Digital Twins.
