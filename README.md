...
* [Awesome IoT](https://github.com/HQarroum/awesome-iot) ⭐ 4,513 | 🐛 5 | 📅 2026-08-10 - A curated list of awesome Internet of Things projects and resources.
...
* **[Serverless ★ 7951 ⧗ 0](https://github.com/serverless/serverless) ⭐ 46,920 | 🐛 1,219 | 🌐 JavaScript | 📅 2026-09-17** - Serverless is the application framework for building web, mobile and IoT applications exclusively on Amazon Web Services' Lambda and API Gateway.
* **[ESP-IDF ★ 2542 ⧗ 0](https://github.com/espressif/esp-idf) ⭐ 19,071 | 🐛 1,679 | 🌐 C | 📅 2026-09-21** - The official framework from Espressif to build Wi-Fi, BLE, and BT apps with ESP32.
...
* **[.NET Core IoT ★ 1193 ⧗ 292](https://github.com/dotnet/iot) ⭐ 2,411 | 🐛 89 | 🌐 C# | 📅 2026-09-21** - A set of libraries to interact with sensors, displays and input devices from .NET Core framework.
...
* [Thingsboard IoT Gateway ★ 463 ⧗ 246](https://github.com/thingsboard/thingsboard-gateway) ⭐ 2,191 | 🐛 75 | 🌐 Python | 📅 2026-09-21 - open-source IoT Gateway - integrates devices connected to legacy and third-party systems with Thingsboard IoT Platform using OPC-UA and MQTT protocols.
...
* [Kura ★ 85 ⧗ 1](https://github.com/eclipse/kura) ⭐ 579 | 🐛 17 | 🌐 Java | 📅 2026-09-21 - an open-source framework for development of IoT applications
...
* [Jumpstarter ★ 28 ⧗ 0](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 221 | 🐛 158 | 🌐 Python | 📅 2026-09-21 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual IoT hardware with CI/CD integration.
...
* **[ESP8266 Arduino Core ★ 2588 ⧗ 0](https://github.com/esp8266/Arduino) ⭐ 16,687 | 🐛 405 | 🌐 C++ | 📅 2026-08-27** - Arduino core for ESP8266 WiFi chip.

* [Armbian build SDK ★ 630](https://github.com/armbian/build) ⭐ 5,422 | 🐛 121 | 🌐 Shell | 📅 2026-09-21 - for creating customized kernel and Debian based userspace for popular development boards.
...
* **[ArduinoJson ★ 873 ⧗ 0](https://github.com/bblanchon/ArduinoJson) ⭐ 7,218 | 🐛 17 | 🌐 C++ | 📅 2026-08-15** - An elegant and efficient JSON library for embedded systems.
* [WiringPi ★ 455 ⧗ 11](https://github.com/WiringPi/WiringPi) ⭐ 3,341 | 🐛 40 | 🌐 C | 📅 2026-09-02 - Gordon's Arduino wiring-like WiringPi Library for the Raspberry Pi.
...
* **[nexmon ★ 885 ⧗ 2](https://github.com/seemoo-lab/nexmon) ⭐ 2,889 | 🐛 347 | 🌐 C | 📅 2026-09-14** -  is our C-based firmware patching framework for Broadcom/Cypress WiFi chips.
...
* [btstack ★ 151 ⧗ 1](https://github.com/bluekitchen/btstack) ⭐ 2,139 | 🐛 77 | 🌐 C | 📅 2026-09-21 - Dual-mode Bluetooth stack, with small memory footprint.
* [MCUBoot ★ 43 ⧗ 3](https://github.com/runtimeco/mcuboot) ⭐ 2,122 | 🐛 95 | 🌐 C | 📅 2026-09-18 - is a secure bootloader for 32-bit MCUs.
...
* [MQTTX ★ 12 ⧗ 0](https://github.com/emqx/MQTTX) ⭐ 5,060 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-20 - MQTTX is a cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows. It allows users to quickly and easily test MQTT / MQTTS connections, publish and subscribe to MQTT messages.
...
* [AimDB ★ 2](https://github.com/aimdb-dev/aimdb) ⭐ 100 | 🐛 5 | 🌐 Rust | 📅 2026-09-21 - An async, in-memory data bridge that syncs records across microcontrollers, edge gateways and cloud instances. Define once, stream and sync everywhere.
...
* [Scanners-Box ★ 424 ⧗ 0](https://github.com/We5ter/Scanners-Box) ⭐ 9,054 | 🐛 0 | 📅 2026-09-21 - the toolbox of open source scanners.
...
* [OpenWrt ★ 230 ⧗ 173](https://github.com/openwrt/openwrt) ⭐ 28,475 | 🐛 4,489 | 🌐 C | 📅 2026-09-21 - OpenWrt is described as a Linux distribution for embedded devices.

* [Zephyr ★ 352 ⧗ 5](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,580 | 🐛 4,055 | 🌐 C | 📅 2026-09-21 -  is a small, scalable real-time operating system for use on resource-constrained systems supporting multiple architectures.

* [RT-Thread ★ 493 ⧗ 0](https://github.com/RT-Thread/rt-thread) ⭐ 12,226 | 🐛 481 | 🌐 C | 📅 2026-09-21 - RT-Thread is an open source real-time operating system for embedded devices from China.
...
* [Tock OS ★ 243 ⧗ 1](https://github.com/helena-project/tock) ⭐ 6,444 | 🐛 216 | 🌐 Rust | 📅 2026-09-19 -  is an operating system designed for running multiple concurrent, mutually distrustful applications on Cortex-M based embedded platforms.

* **[RIOT ★ 748 ⧗ 1](https://github.com/RIOT-OS/RIOT) ⭐ 5,802 | 🐛 886 | 🌐 C | 📅 2026-09-21** - The friendly Operating System for the Internet of Things

* **[seL4 Microkernel ★ 1344 ⧗ 1](https://github.com/seL4/seL4) ⭐ 5,757 | 🐛 224 | 🌐 C | 📅 2026-09-21** - The world's first operating-system kernel with an end-to-end proof of implementation correctness and security enforcement is available as open source.
...
* **[Contiki ★ 1813 ⧗ 0](https://github.com/contiki-os/contiki) ⭐ 3,805 | 🐛 646 | 🌐 C | 📅 2024-04-06** - The Open Source OS for the Internet of Things
...
* [TinyAra ★ 35 ⧗ 1](https://github.com/Samsung/TinyAra) ⭐ 648 | 🐛 221 | 🌐 C | 📅 2026-09-21 - is a lightweight RTOS-based platform to support low-end IoT devices.
...
* **[Thingsboard ★ 5102 ⧗ 1700](https://github.com/thingsboard/thingsboard) ⭐ 22,458 | 🐛 314 | 🌐 Java | 📅 2026-09-21** - Open-source IoT Platform - Device management, data collection, processing and visualization.
* **[PlatformIO ★ 980 ⧗ 0](https://github.com/platformio/platformio) ⭐ 9,475 | 🐛 272 | 🌐 Python | 📅 2026-09-19** - PlatformIO is a cross-platform code builder and the missing library manager.
* [Fuxa SCADA/HMI/Dashboard ★ 2115 ⧗ 632](https://github.com/frangoteam/FUXA) ⭐ 5,041 | 🐛 396 | 🌐 TypeScript | 📅 2026-09-17 - FUXA is a web-based Process Visualization (SCADA/HMI/Dashboard) software. With FUXA you can create modern process visualizations/dashboards with individual designs for your machines/IOT application with real-time data display. Supports MQTT, OPC-UA, Modbus RTU/TCP, Siemens S7 Protocol, BACnet IP, Ethernet/IP (Allen Bradley), WebAPI
...
* **[IoT DC3 ★ 650 ⧗ 0](https://github.com/pnoker/iot-dc3) ⭐ 1,288 | 🐛 17 | 🌐 Java | 📅 2026-09-21** - A fully open-source, distributed industrial IoT platform built on Spring Cloud, evolving for AI scenarios. Enables rapid IoT project development and connected-device management. [(Docs)](https://docs.dc3.site)
* [HiveMQ ★ 329 ⧗ 0](https://github.com/hivemq/hivemq-community-edition) ⭐ 1,211 | 🐛 29 | 🌐 Java | 📅 2026-09-21 - is an open source MQTT platform and MQTT broker.
...
* [United Manufacturing Hub ★ 9 ⧗ 0](https://github.com/united-manufacturing-hub/united-manufacturing-hub) ⭐ 391 | 🐛 22 | 🌐 Go | 📅 2026-09-21 - The Open-Source Manufacturing App Platform (combines various open source solutions and packages them in a Helm chart, for example nodered, VerneMQ and timescaleDB)
...
* [DeviceChain](https://github.com/devicechain-io/devicechain) ⭐ 4 | 🐛 15 | 🌐 Go | 📅 2026-09-21 - Apache-2.0 self-hosted IoT platform written in Go and React. Multi-tenant microservices on Kubernetes: MQTT/Sparkplug B/LwM2M ingest, TimescaleDB time-series storage, a CEL-based rule engine with alarms and outbound connectors, versioned dashboards, and GraphQL APIs. [(Docs)](https://docs.devicechain.io)
...
* [IoTSharp](https://github.com/IoTSharp/IoTSharp) ⭐ 1,379 | 🐛 5 | 🌐 C# | 📅 2026-09-05 - IoTSharp is an open-source IoT platform.
...
* [OGC SensorThings API ★ 21 ⧗ 15](https://github.com/opengeospatial/sensorthings) ⭐ 169 | 🐛 95 | 📅 2026-09-21 - The OGC SensorThings API is an OGC standard specification for providing an open and unified way to interconnect IoT devices, data, and applications over the Web
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,721 | 🐛 277 | 🌐 Java | 📅 2026-09-21 - A Multi-protocol event-native edge/service proxy that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* **[Kuzzle ★ 502 ⧗ 0](https://github.com/kuzzleio/kuzzle) ⭐ 1,673 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-21** - An open-source backend with advanced features like real-time pub/sub or geofencing and a multiprotocol interface that supports MQTT, LoRaWAN and more. [(Website)](https://kuzzle.io/solutions/technologies/iot-backend/)
...
* [Renode ★ 81 ⧗ 0](https://github.com/renode/renode) ⭐ 2,918 | 🐛 457 | 🌐 RobotFramework | 📅 2026-09-21 - a virtual development tool for multinode embedded networks.
...
* **[D3.JS ★ 49188 ⧗ 0](https://github.com/mbostock/d3) ⭐ 113,751 | 🐛 19 | 🌐 Shell | 📅 2026-05-28** - A JavaScript visualization library for HTML and SVG
* **[ECharts ★ 11457 ⧗ 0](https://github.com/ecomfe/echarts) ⭐ 67,365 | 🐛 1,494 | 🌐 TypeScript | 📅 2026-09-16** - Echarts is a commercial charting solution originally intended to address the report need of the Company's various business systems.
* **[HighCharts ★ 4949 ⧗ 0](https://github.com/highslide-software/highcharts.com) ⭐ 12,491 | 🐛 810 | 🌐 TypeScript | 📅 2026-09-21** - Highcharts JS, the JavaScript charting framework
...
* [Widora ★ 15 ⧗ 21](https://github.com/widora/openwrt_widora) ⭐ 174 | 🐛 5 | 🌐 C | 📅 2025-09-12 - Widora is open source WiFi development hardware prototype with sound card based on MT7688A running [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,475 | 🐛 4,489 | 🌐 C | 📅 2026-09-21.
...
* **[Homebridge ★ 3030 ⧗ 0](https://github.com/nfarina/homebridge) ⭐ 25,498 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-30** - Homebridge is a lightweight NodeJS server you can run on your home network that emulates the iOS HomeKit API.
* [Node-RED](https://github.com/node-red/node-red) ⭐ 23,677 | 🐛 348 | 🌐 JavaScript | 📅 2026-09-18 - Node-RED is a programming tool for wiring together hardware devices, APIs and online services in new and interesting ways.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 174 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-14 - Cross-platform Node.js service that reads BLE smart scales, calculates body composition, and exports readings to MQTT with Home Assistant auto-discovery, InfluxDB, Garmin Connect, and webhooks.
...
* [ZHAC](https://github.com/zhac-project/zhac-platform) ⭐ 0 | 🐛 0 | 🌐 Just | 📅 2026-09-21 - A dual-chip ESP32-P4 + ESP32-S3 Zigbee home automation controller with a Lua rule engine, local web UI, and MQTT gateway.
...
* **[AirSim ★ 2606 ⧗ 1](https://github.com/Microsoft/AirSim) ⭐ 18,503 | 🐛 781 | 🌐 C++ | 📅 2026-09-15** -  is a simulator for drones (and soon other vehicles) built on Unreal Engine.
...
* **[Sonoff-Tasmota ★ 4869 ⧗ 0](https://github.com/arendst/Sonoff-Tasmota) ⭐ 24,769 | 🐛 21 | 🌐 C | 📅 2026-09-21** - Provide ESP8266 based itead Sonoff with Web, MQTT and OTA firmware using Arduino IDE.
* **[Node-RED ★ 2513 ⧗ 0](https://github.com/node-red/node-red) ⭐ 23,677 | 🐛 348 | 🌐 JavaScript | 📅 2026-09-18** - A visual tool for wiring the Internet of Things.
* **[ESP8266 Deauther ★ 3806 ⧗ 0](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,992 | 🐛 99 | 🌐 C | 📅 2024-08-14** -  allows you to perform a deauth attack with an ESP8266 against selected networks.
* [fluent-bit ★ 90 ⧗ 4](https://github.com/fluent/fluent-bit) ⭐ 8,115 | 🐛 756 | 🌐 C | 📅 2026-09-21 - is a data collector for Linux, Embedded Linux, OSX and BSD family operating systems.
...
* **[MicroPython ★ 3070 ⧗ 0](https://github.com/micropython/micropython) ⭐ 22,076 | 🐛 1,525 | 🌐 C | 📅 2026-09-21** - MicroPython is a lean and fast implementation of the Python 3 programming language that is optimised to run on a microcontroller.
...
* [AtomVM ★ 390 ⧗ 0](https://github.com/bettio/AtomVM) ⭐ 2,237 | 🐛 184 | 🌐 Erlang | 📅 2026-09-21 - AtomVM is a tiny portable virtual machine that allows Erlang and Elixir code to run on microcontrollers with less than 500KB of RAM such as the ESP32.
...
* **[mbed TLS ★ 601 ⧗ 0](https://github.com/ARMmbed/mbedtls) ⭐ 6,963 | 🐛 1,725 | 🌐 C | 📅 2026-09-21** - An open source, portable, easy to use, readable and flexible SSL library
* **[UniK ★ 593 ⧗ 0](https://github.com/emc-advanced-dev/unik) ⭐ 2,826 | 🐛 51 | 🌐 Go | 📅 2023-04-27** -  is a tool for compiling application sources into unikernels (lightweight bootable disk images) rather than binaries.
...
* **[EMQX ★ 10300 ⧗ 1800](https://github.com/emqx/emqx) ⭐ 16,746 | 🐛 221 | 🌐 Erlang | 📅 2026-09-21** - An ultra-scalable open-source MQTT broker. Connect 100M+ IoT devices in one single cluster, move and process real-time IoT data with 1M msg/s throughput at 1ms latency.
* [Mosquitto ★ 158 ⧗ 0](https://github.com/eclipse/mosquitto) ⭐ 11,214 | 🐛 889 | 🌐 C | 📅 2026-09-03 - An Open Source MQTT v3.1/v3.1.1 Broker.
* **[MQTT.js ★ 1359 ⧗ 0](https://github.com/mqttjs/MQTT.js) ⭐ 9,115 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-16** - The MQTT client for Node.js and the browser.
...
* **[VerneMQ ★ 561 ⧗ 1](https://github.com/erlio/vernemq) ⭐ 3,636 | 🐛 171 | 🌐 Erlang | 📅 2026-09-17** - A distributed MQTT message broker.
...
* [Eclipse Paho MQTT C client ★ 142 ⧗ 3](https://github.com/eclipse/paho.mqtt.c) ⭐ 2,372 | 🐛 224 | 🌐 C | 📅 2026-09-09 - This code builds libraries which enable applications to connect to an MQTT broker to publish messages, and to subscribe to topics and receive published messages.
...
* [Californium ★ 36 ⧗ 0](https://github.com/eclipse/californium) ⭐ 778 | 🐛 25 | 🌐 Java | 📅 2026-09-21 - Californium is a Java implementation of CoAP for the IoT backend and less constrained IoT devices.
...
* [java-coap ★ 3 ⧗ 0](https://github.com/open-coap/java-coap) ⭐ 34 | 🐛 8 | 🌐 Java | 📅 2026-09-21 - Complete CoAP implementation in java (it is a fork with lots of improvements).
...
* **[OpenThread ★ 1139 ⧗ 2](https://github.com/openthread/openthread) ⭐ 4,035 | 🐛 158 | 🌐 C++ | 📅 2026-09-21** - OpenThread is an open-source implementation of the Thread networking protocol.
* [OpenThread Border Router ★ 64 ⧗ 0](https://github.com/openthread/borderrouter) ⭐ 570 | 🐛 48 | 🌐 C++ | 📅 2026-09-21 - An open source border router, built to work with OpenThread.

### Others

* **[libimobiledevice ★ 2294 ⧗ 0](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,204 | 🐛 846 | 🌐 C | 📅 2026-06-10** - A library to communicate with services of Apple iOS devices using native protocols.
...
* [libmodbus ★ 2400 ⧗ 50](https://github.com/stephane/libmodbus) ⭐ 4,253 | 🐛 190 | 🌐 C | 📅 2026-07-02 - A Modbus library for Linux, Mac OS, FreeBSD, QNX and Windows, written in C.
* [pymodbus ★ 2400 ⧗ 100](https://github.com/pymodbus-dev/pymodbus) ⭐ 2,771 | 🐛 0 | 🌐 Python | 📅 2026-09-20 - A full Modbus protocol implementation for Python, supporting RTU, TCP, ASCII over serial and network transports.
...
* [libnfc ★ 119 ⧗ 4](https://github.com/nfc-tools/libnfc) ⭐ 1,990 | 🐛 120 | 🌐 C | 📅 2025-03-05 - Platform independent Near Field Communication library.
...
* [LibLogicalAccess ★ 53 ⧗ 17](https://github.com/islog/liblogicalaccess) ⭐ 275 | 🐛 17 | 🌐 C++ | 📅 2026-09-21 - C++ RFID Library for Windows/Linux/Mac. For PC/SC, NFC, ISO compliant and proprietary hardware.
...
* **[Servo ★ 7821 ⧗ 0](https://github.com/servo/servo) ⭐ 38,023 | 🐛 3,223 | 🌐 Rust | 📅 2026-09-21** -  is a prototype web browser engine written in the Rust language.
* **[Drake ★ 500 ⧗ 0](https://github.com/RobotLocomotion/drake) ⭐ 4,199 | 🐛 645 | 🌐 C++ | 📅 2026-09-21** -  is a toolbox maintained by the Robot Locomotion Group at the MIT Computer Science and Artificial Intelligence Lab (CSAIL).
* [ShellHub ★ 702 ⧗ 70](https://github.com/shellhub-io/shellhub) ⭐ 2,068 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-21 - Centralized SSH for the the edge and cloud computing.
...
* [100 Days 100 IoT Projects](https://github.com/kritishmohapatra/100_Days_100_IoT_Projects) ⭐ 1,216 | 🐛 0 | 🌐 Python | 📅 2026-07-17 - A 100-day challenge building real-world IoT projects with MicroPython on ESP32, ESP8266 and Raspberry Pi Pico 2W. Step-by-step documented with wiring diagrams and code for beginners.
...
* [CosmoEdge](https://github.com/cosmo-wander-ai/cosmo-edge) ⭐ 1,220 | 🐛 12 | 🌐 C | 📅 2026-09-21 - Production-oriented C++ edge video AI engine that connects RTSP streams to CV/VLM inference, visual orchestration, alarms, and MQTT/webhook events on Sophon and Rockchip NPUs.
...
* [Genesis 2](https://github.com/larionovavi-stack/genesis2-cascade-moe) ⭐ 1 | 🐛 0 | 🌐 HTML | 📅 2026-09-21 - Cascade MoE neural network for IoT edge deployments. CPU-only inference (18ms), no GPU required, patented architecture with zero catastrophic forgetting.
* [libdeep](https://github.com/bashrc/libdeep) - A deep learning library for C/C++.

## Analytics

* **[NetData ★ 18973 ⧗ 0](https://github.com/firehol/netdata) ⭐ 80,617 | 🐛 405 | 🌐 Go | 📅 2026-09-21** - is a system for distributed real-time performance and health monitoring.
* **[Piwik ★ 5374 ⧗ 0](https://github.com/piwik/piwik) ⭐ 21,892 | 🐛 2,573 | 🌐 PHP | 📅 2026-09-21** - Piwik is the leading Free/Libre open analytics platform.
...
* [Eclipse Ditto](https://github.com/eclipse/ditto) ⭐ 926 | 🐛 94 | 🌐 Java | 📅 2026-09-21 is the open-source project of Eclipse IoT that provides a ready-to-use functionality to manage the state of Digital Twins.
