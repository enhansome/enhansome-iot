...
* **[Serverless ★ 7951 ⧗ 0](https://github.com/serverless/serverless) ⭐ 46,920 | 🐛 1,215 | 🌐 JavaScript | 📅 2026-08-12** - Serverless is the application framework for building web, mobile and IoT applications exclusively on Amazon Web Services' Lambda and API Gateway.
* **[ESP-IDF ★ 2542 ⧗ 0](https://github.com/espressif/esp-idf) ⭐ 18,766 | 🐛 1,667 | 🌐 C | 📅 2026-08-12** - The official framework from Espressif to build Wi-Fi, BLE, and BT apps with ESP32.
* **[johnny-five ★ 6024 ⧗ 0](https://github.com/rwaldron/johnny-five) ⭐ 13,411 | 🐛 64 | 🌐 JavaScript | 📅 2023-10-24** - JavaScript Robotics and IoT programming framework, developed at Bocoup, Firmata Protocol.
* **[GoBot ★ 2062 ⧗ 1](https://github.com/hybridgroup/gobot) ⭐ 9,445 | 🐛 99 | 🌐 Go | 📅 2026-01-07** - Golang framework for robotics, physical computing, and the Internet of Things.
...
* **[.NET Core IoT ★ 1193 ⧗ 292](https://github.com/dotnet/iot) ⭐ 2,403 | 🐛 91 | 🌐 C# | 📅 2026-08-12** - A set of libraries to interact with sensors, displays and input devices from .NET Core framework.
...
* [Thingsboard IoT Gateway ★ 463 ⧗ 246](https://github.com/thingsboard/thingsboard-gateway) ⭐ 2,173 | 🐛 87 | 🌐 Python | 📅 2026-08-12 - open-source IoT Gateway - integrates devices connected to legacy and third-party systems with Thingsboard IoT Platform using OPC-UA and MQTT protocols.
...
* [Kura ★ 85 ⧗ 1](https://github.com/eclipse/kura) ⭐ 571 | 🐛 19 | 🌐 Java | 📅 2026-08-12 - an open-source framework for development of IoT applications
...
* [WTX](https://github.com/c410-f3r/wtx) ⭐ 394 | 🐛 8 | 🌐 Rust | 📅 2026-08-10 - A framework for web-oriented applications
* **[AREG SDK ★ 15 ⧗ 0](https://github.com/aregtech/areg-sdk) ⭐ 362 | 🐛 39 | 🌐 C++ | 📅 2026-08-13** - AREG SDK is a developer-friendly, an interface-centric real-time asynchronous communication engine to enable distributed- and [mist-computing](https://csrc.nist.gov/publications/detail/sp/500-325/final), where connected Things interact and provide services, as if they act like thin distributed servers.
...
* [Jumpstarter ★ 28 ⧗ 0](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 209 | 🐛 180 | 🌐 Python | 📅 2026-08-13 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual IoT hardware with CI/CD integration.
...
* [Simgrid ★ 46 ⧗ 53](https://github.com/simgrid/simgrid) ⭐ 193 | 🐛 20 | 🌐 C++ | 📅 2026-08-06 -  is a scientific instrument to study the behavior of large-scale distributed systems such as Grids, Clouds, HPC or P2P systems.
...
* **[ESP8266 Arduino Core ★ 2588 ⧗ 0](https://github.com/esp8266/Arduino) ⭐ 16,663 | 🐛 405 | 🌐 C++ | 📅 2026-07-29** - Arduino core for ESP8266 WiFi chip.

* [Armbian build SDK ★ 630](https://github.com/armbian/build) ⭐ 5,350 | 🐛 115 | 🌐 Shell | 📅 2026-08-12 - for creating customized kernel and Debian based userspace for popular development boards.
...
* **[ArduinoJson ★ 873 ⧗ 0](https://github.com/bblanchon/ArduinoJson) ⭐ 7,202 | 🐛 17 | 🌐 C++ | 📅 2026-08-11** - An elegant and efficient JSON library for embedded systems.
* [WiringPi ★ 455 ⧗ 11](https://github.com/WiringPi/WiringPi) ⭐ 3,327 | 🐛 41 | 🌐 C | 📅 2026-08-07 - Gordon's Arduino wiring-like WiringPi Library for the Raspberry Pi.
* [PJON ★ 427 ⧗ 4](https://github.com/gioblu/PJON) ⭐ 2,814 | 🐛 60 | 🌐 C++ | 📅 2025-11-21 - Digital communication framework for Arduino and IOT.
...
* **[libui ★ 8021 ⧗ 1](https://github.com/andlabs/libui) ⭐ 10,895 | 🐛 249 | 🌐 C | 📅 2024-05-29** - Simple and portable (but not inflexible) GUI library in C that uses the native GUI technologies of each platform it supports.
* [LK ★ 312 ⧗ 0](https://github.com/littlekernel/lk) ⭐ 3,660 | 🐛 100 | 🌐 C | 📅 2026-08-11 - The LK embedded kernel. An SMP-aware kernel designed for small systems.
* [inih ★ 312 ⧗ 3](https://github.com/benhoyt/inih) ⭐ 3,030 | 🐛 5 | 🌐 C++ | 📅 2026-01-30 - is a simple .INI file parser written in C.
* **[nexmon ★ 885 ⧗ 2](https://github.com/seemoo-lab/nexmon) ⭐ 2,870 | 🐛 344 | 🌐 C | 📅 2026-07-13** -  is our C-based firmware patching framework for Broadcom/Cypress WiFi chips.
* **[simbody ★ 540 ⧗ 0](https://github.com/simbody/simbody) ⭐ 2,544 | 🐛 161 | 🌐 C++ | 📅 2026-08-12** - High-performance C++ multibody dynamics/physics library for simulating articulated biomechanical and mechanical systems like vehicles, robots, and the human skeleton.
* [Ladon ★ 114 ⧗ 2](https://github.com/ory-am/ladon) ⭐ 2,460 | 🐛 2 | 🌐 Go | 📅 2025-10-22 - is a library written in Go for access control policies, similar to Role Based Access Control or Access Control Lists.
* [btstack ★ 151 ⧗ 1](https://github.com/bluekitchen/btstack) ⭐ 2,124 | 🐛 76 | 🌐 C | 📅 2026-08-05 - Dual-mode Bluetooth stack, with small memory footprint.
* [MCUBoot ★ 43 ⧗ 3](https://github.com/runtimeco/mcuboot) ⭐ 2,025 | 🐛 97 | 🌐 C | 📅 2026-08-11 - is a secure bootloader for 32-bit MCUs.
* [CocoaMQTT ★ 210 ⧗ 0](https://github.com/emqtt/CocoaMQTT) ⭐ 1,748 | 🐛 111 | 🌐 Swift | 📅 2026-07-31 - MQTT for iOS and OS X written with Swift.
* [SPIFFS ★ 174 ⧗ 0](https://github.com/pellepl/spiffs) ⭐ 1,620 | 🐛 104 | 🌐 C | 📅 2026-07-16 - Wear-leveled SPI flash file system for embedded devices.
* [SwiftyGPIO ★ 407 ⧗ 1](https://github.com/uraimo/SwiftyGPIO) ⭐ 1,370 | 🐛 36 | 🌐 Swift | 📅 2024-05-02 - a Swift library to interact with Linux GPIO/SPI on ARM.
* [uIP ★ 246 ⧗ 3](https://github.com/adamdunkels/uip) ⭐ 1,079 | 🐛 5 | 🌐 C | 📅 2017-01-09 - uIP is a very small implementation of the TCP/IP stack.
...
* [XiPKI ★ 34 ⧗ 10](https://github.com/xipki/xipki) ⭐ 602 | 🐛 7 | 🌐 Java | 📅 2026-08-01 - eXtensible sImple Public Key Infrastructure consists of CA and OCSP responder.
* [xkcptun ★ 104 ⧗ 25](https://github.com/liudf0716/xkcptun) ⭐ 477 | 🐛 11 | 🌐 C | 📅 2026-06-15 - xkcptun is kcp tunnel for OpenWRT\&LEDE, implemented in c language
* [aWOT ★ 69 ⧗ 8](https://github.com/lasselukkari/aWOT) ⭐ 312 | 🐛 7 | 🌐 C++ | 📅 2025-01-16 - Web server library for Arduino, Teensy, ESP8266 and ESP32
* [Devices ★ 134 ⧗ 0](https://github.com/goiot/devices) ⭐ 266 | 🐛 9 | 🌐 Go | 📅 2016-07-10 - Suite of libraries for IoT devices (written in Go).
...
* [Pelion Device Management Client ★ 19 ⧗ 41](https://github.com/ARMmbed/mbed-cloud-client) ⭐ 44 | 🐛 6 | 🌐 C | 📅 2026-03-24 - a library that connects devices to Pelion Device Management service and to Mbed-enabled cloud services from our partners.
...
* [MQTTX ★ 12 ⧗ 0](https://github.com/emqx/MQTTX) ⭐ 5,016 | 🐛 110 | 🌐 TypeScript | 📅 2026-08-13 - MQTTX is a cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows. It allows users to quickly and easily test MQTT / MQTTS connections, publish and subscribe to MQTT messages.
* [PhoneGap NFC ★ 312 ⧗ 2](https://github.com/chariotsolutions/phonegap-nfc) ⭐ 738 | 🐛 92 | 🌐 Java | 📅 2024-08-20 - PhoneGap NFC Plugin
* [PWAify ★ 269 ⧗ 8](https://github.com/vladikoff/PWAify) ⭐ 440 | 🐛 12 | 🌐 JavaScript | 📅 2020-06-07 - Experimental project to convert your PWA (Progressive Web App) into a cross-platform Electron app. Brings PWAs to your desktop.
* [Cordova BLE ★ 149 ⧗ 3](https://github.com/evothings/cordova-ble) ⭐ 244 | 🐛 51 | 🌐 JavaScript | 📅 2018-10-11 - Bluetooth Low Energy plugin for Cordova
...
* [HStreamDB ★ 172](https://github.com/hstreamdb/hstream) ⭐ 721 | 🐛 11 | 🌐 Haskell | 📅 2024-12-26 - The streaming database built for IoT data storage and real-time processing.
* [ReductStore ★ 360](https://github.com/reductstore/reductstore) ⭐ 366 | 🐛 14 | 🌐 Rust | 📅 2026-08-08 - high-performance blob and time-series storage for industrial IoT, with edge deployment, selective replication, and efficient querying of multimodal data.
* [AimDB ★ 2](https://github.com/aimdb-dev/aimdb) ⭐ 98 | 🐛 6 | 🌐 Rust | 📅 2026-08-13 - An async, in-memory data bridge that syncs records across microcontrollers, edge gateways and cloud instances. Define once, stream and sync everywhere.
...
* [Scanners-Box ★ 424 ⧗ 0](https://github.com/We5ter/Scanners-Box) ⭐ 9,008 | 🐛 0 | 📅 2026-08-12 - the toolbox of open source scanners.
...
* [nShield ★ 66 ⧗ 35](https://github.com/fnzv/nShield) ⭐ 250 | 🐛 6 | 🌐 Go | 📅 2021-11-09 - An Easy and Simple Anti-DDoS solution for VPS,Dedicated Servers and IoT devices based on iptables.

* [HookProbe](https://github.com/hookprobe/hookprobe) ⭐ 43 | 🐛 1 | 🌐 Python | 📅 2026-07-27 - Edge-first autonomous SOC and AI-native IDS for IoT network security. Runs on Raspberry Pi.

* [data-act-iot-kit](https://github.com/plusultra-tools/data-act-iot-kit) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-05-19 - EU Data Act Art. 4-5 reference implementation. Drop-in user-data-access HTTP endpoint for connected products, with verbatim-cited compliance manifest. Targets the 2026-09-12 access-by-design obligation.

## OS

* [OpenWrt ★ 230 ⧗ 173](https://github.com/openwrt/openwrt) ⭐ 27,970 | 🐛 4,318 | 🌐 C | 📅 2026-08-13 - OpenWrt is described as a Linux distribution for embedded devices.

* [Zephyr ★ 352 ⧗ 5](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,193 | 🐛 3,811 | 🌐 C | 📅 2026-08-12 -  is a small, scalable real-time operating system for use on resource-constrained systems supporting multiple architectures.

* [RT-Thread ★ 493 ⧗ 0](https://github.com/RT-Thread/rt-thread) ⭐ 12,147 | 🐛 484 | 🌐 C | 📅 2026-08-13 - RT-Thread is an open source real-time operating system for embedded devices from China.

* **[NodeOS ★ 3605 ⧗ 0](https://github.com/nodeos/nodeos) ⭐ 7,347 | 🐛 163 | 🌐 Shell | 📅 2023-03-07** - Lightweight operating system using Node.js as userspace.

* [Tock OS ★ 243 ⧗ 1](https://github.com/helena-project/tock) ⭐ 6,410 | 🐛 212 | 🌐 Rust | 📅 2026-08-13 -  is an operating system designed for running multiple concurrent, mutually distrustful applications on Cortex-M based embedded platforms.

* **[RIOT ★ 748 ⧗ 1](https://github.com/RIOT-OS/RIOT) ⭐ 5,775 | 🐛 868 | 🌐 C | 📅 2026-08-12** - The friendly Operating System for the Internet of Things

* **[seL4 Microkernel ★ 1344 ⧗ 1](https://github.com/seL4/seL4) ⭐ 5,689 | 🐛 208 | 🌐 C | 📅 2026-08-06** - The world's first operating-system kernel with an end-to-end proof of implementation correctness and security enforcement is available as open source.

* [Huawei LiteOS ★ 341 ⧗ 3](https://github.com/LITEOS/LiteOS_Kernel) ⭐ 4,904 | 🐛 51 | 🌐 C | 📅 2022-05-31 - Huawei LiteOS Kernel.

* **[ARM mbed ★ 629 ⧗ 0](https://github.com/mbedmicro/mbed) ⭐ 4,866 | 🐛 211 | 🌐 C | 📅 2024-10-08** - The ARM® mbed™ IoT Device Platform provides the operating system, cloud services, tools and developer ecosystem to make the creation and deployment of commercial, standards-based IoT solutions possible at scale.

* **[Contiki ★ 1813 ⧗ 0](https://github.com/contiki-os/contiki) ⭐ 3,804 | 🐛 649 | 🌐 C | 📅 2024-04-06** - The Open Source OS for the Internet of Things
...
* [Mynewt](https://github.com/apache/mynewt-core) ⭐ 890 | 🐛 101 | 🌐 C | 📅 2026-08-11 is an open-source operating system for tiny embedded devices. Its goal is to make it easy to develop applications for microcontroller environments where power and cost are driving factors.

* [f9-kernel ★ 316 ⧗ 4](https://github.com/f9micro/f9-kernel) ⭐ 762 | 🐛 26 | 🌐 C | 📅 2026-03-25 - An efficient and secure microkernel built for ARM Cortex-M cores, inspired by L4

* [TinyAra ★ 35 ⧗ 1](https://github.com/Samsung/TinyAra) ⭐ 647 | 🐛 207 | 🌐 C | 📅 2026-08-12 - is a lightweight RTOS-based platform to support low-end IoT devices.
...
* [RMP ★ 19 ⧗ 8](https://github.com/EDI-Systems/M5P1_MuProkaron) ⭐ 172 | 🐛 0 | 🌐 C | 📅 2025-06-08 - A single-file rapid development RTOS for IoT with integrated graphics.
...
* **[flask-ask ★ 946 ⧗ 0](https://github.com/johnwheeler/flask-ask) ⭐ 1,909 | 🐛 70 | 🌐 Python | 📅 2023-05-01** - is a Flask extension that makes building Alexa skills for the Amazon Echo easier and much more fun.
...
* **[Thingsboard ★ 5102 ⧗ 1700](https://github.com/thingsboard/thingsboard) ⭐ 22,239 | 🐛 285 | 🌐 Java | 📅 2026-08-10** - Open-source IoT Platform - Device management, data collection, processing and visualization.
* **[PlatformIO ★ 980 ⧗ 0](https://github.com/platformio/platformio) ⭐ 9,398 | 🐛 315 | 🌐 Python | 📅 2026-08-11** - PlatformIO is a cross-platform code builder and the missing library manager.
* [Fuxa SCADA/HMI/Dashboard ★ 2115 ⧗ 632](https://github.com/frangoteam/FUXA) ⭐ 4,904 | 🐛 384 | 🌐 TypeScript | 📅 2026-08-12 - FUXA is a web-based Process Visualization (SCADA/HMI/Dashboard) software. With FUXA you can create modern process visualizations/dashboards with individual designs for your machines/IOT application with real-time data display. Supports MQTT, OPC-UA, Modbus RTU/TCP, Siemens S7 Protocol, BACnet IP, Ethernet/IP (Allen Bradley), WebAPI
* [Mongoose IoT ★ 487 ⧗ 0](https://github.com/cesanta/iot) ⭐ 2,661 | 🐛 97 | 🌐 C | 📅 2026-07-26 -  is a full-stack IoT platform including firmware and cloud components available for ESP8266.
* **[IoT.js ★ 921 ⧗ 0](https://github.com/Samsung/iotjs) ⭐ 2,601 | 🐛 52 | 🌐 C | 📅 2021-06-18** - Platform for Internet of Things with JavaScript.
* [HiveMQ ★ 329 ⧗ 0](https://github.com/hivemq/hivemq-community-edition) ⭐ 1,204 | 🐛 27 | 🌐 Java | 📅 2026-08-12 - is an open source MQTT platform and MQTT broker.
* **[IoT DC3 ★ 650 ⧗ 0](https://github.com/pnoker/iot-dc3) ⭐ 666 | 🐛 34 | 🌐 Java | 📅 2026-08-11** - A fully open-source, distributed industrial IoT platform built on Spring Cloud, evolving for AI scenarios. Enables rapid IoT project development and connected-device management. [(Docs)](https://docs.dc3.site)
* [Lan ★ 105 ⧗ 0](https://github.com/phodal/lan) ⭐ 565 | 🐛 0 | 🌐 JavaScript | 📅 2020-04-28 - Internet of Things Server Layer with CoAP, WebSocket, MQTT, HTTP f
...
* [United Manufacturing Hub ★ 9 ⧗ 0](https://github.com/united-manufacturing-hub/united-manufacturing-hub) ⭐ 389 | 🐛 25 | 🌐 Go | 📅 2026-08-12 - The Open-Source Manufacturing App Platform (combines various open source solutions and packages them in a Helm chart, for example nodered, VerneMQ and timescaleDB)
...
* [Mobius ★ 46 ⧗ 2](https://github.com/IoTKETI/Mobius) ⭐ 151 | 🐛 31 | 🌐 JavaScript | 📅 2026-04-17 -  is the open source IoT server platform based on the oneM2M standard.
* [PharoThings ★ 37 ⧗ 29](https://github.com/pharo-iot/PharoThings) ⭐ 93 | 🐛 3 | 🌐 Smalltalk | 📅 2025-03-15 - is a Live programming platform for IoT projects based on Pharo.
...
* [Simple IoT](https://github.com/dingdaoyi/simple-iot) ⭐ 26 | 🐛 0 | 🌐 Java | 📅 2026-08-03 - Single-binary, self-hosted IoT platform built with Spring Boot 4 + Vue 3. Built-in MQTT broker, visual rule engine, hot-loaded Java/JS/Groovy/Lua protocol scripts, InfluxDB 3 time-series storage. One-command deploy on a 2 GB VPS.
...
* [DeviceChain](https://github.com/devicechain-io/devicechain) ⭐ 3 | 🐛 5 | 🌐 Go | 📅 2026-08-13 - Apache-2.0 self-hosted IoT platform written in Go and React. Multi-tenant microservices on Kubernetes: MQTT/Sparkplug B/LwM2M ingest, TimescaleDB time-series storage, a CEL-based rule engine with alarms and outbound connectors, versioned dashboards, and GraphQL APIs. [(Docs)](https://docs.devicechain.io)
...
* [IoTSharp](https://github.com/IoTSharp/IoTSharp) ⭐ 1,372 | 🐛 5 | 🌐 C# | 📅 2026-07-20 - IoTSharp is an open-source IoT platform.
...
* [ForestHub](https://foresthub.ai) - Edge AI agent platform; its open-source runtime [edge-agents](https://github.com/ForestHubAI/edge-agents) ⭐ 96 | 🐛 0 | 🌐 TypeScript | 📅 2026-07-29 runs AI agents offline on Linux edge gateways with local SLMs, cloud LLMs and MQTT as first-class nodes.

## APIs

* [OGC SensorThings API ★ 21 ⧗ 15](https://github.com/opengeospatial/sensorthings) ⭐ 167 | 🐛 95 | 📅 2026-07-25 - The OGC SensorThings API is an OGC standard specification for providing an open and unified way to interconnect IoT devices, data, and applications over the Web
...
* [Kaa ★ 234 ⧗ 0](https://github.com/kaaproject/kaa) ⭐ 1,435 | 🐛 9 | 📅 2024-11-05 - Kaa open-source middleware platform for building, managing, and integrating connected products with the Internet of Everything.
* [Shifu ★ 312 ⧗ 0](https://github.com/Edgenesis/shifu) ⭐ 1,431 | 🐛 21 | 🌐 Go | 📅 2026-08-12 - Shifu is a Kubernetes native IoT development framework that supports multi-protocol device access.
...
* [SiteWhere ★ 61 ⧗ 0](https://github.com/sitewhere/sitewhere) ⭐ 1,043 | 🐛 124 | 🌐 Java | 📅 2026-07-31 - SiteWhere open-source IoT platform for device connectivity & management, data persistence, processing, integration, and analytics -- both in cloud and on-premise.
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,043 | 🐛 228 | 🌐 Java | 📅 2026-08-13 - A Multi-protocol event-native edge/service proxy that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
* [OpenIoT ★ 205 ⧗ 0](https://github.com/OpenIotOrg/openiot) ⭐ 469 | 🐛 98 | 🌐 Java | 📅 2023-02-22 - The OpenIoT middleware infrastructure will support flexible configuration and deployment of algorithms for collection
...
* [Renode ★ 81 ⧗ 0](https://github.com/renode/renode) ⭐ 2,719 | 🐛 418 | 🌐 RobotFramework | 📅 2026-08-12 - a virtual development tool for multinode embedded networks.
...
* [Electrum ★ 4 ⧗ 1](https://github.com/yoelf22/electrum) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-07-17 - A structured, AI-assisted toolkit for defining hardware products that have software inside — from concept through engineering spec to presentation-ready materials in eight phases.
...
* **[D3.JS ★ 49188 ⧗ 0](https://github.com/mbostock/d3) ⭐ 113,448 | 🐛 20 | 🌐 Shell | 📅 2026-05-28** - A JavaScript visualization library for HTML and SVG
* **[ECharts ★ 11457 ⧗ 0](https://github.com/ecomfe/echarts) ⭐ 67,059 | 🐛 1,560 | 🌐 TypeScript | 📅 2026-08-04** - Echarts is a commercial charting solution originally intended to address the report need of the Company's various business systems.
* **[HighCharts ★ 4949 ⧗ 0](https://github.com/highslide-software/highcharts.com) ⭐ 12,478 | 🐛 657 | 🌐 TypeScript | 📅 2026-08-12** - Highcharts JS, the JavaScript charting framework
...
* **[Freeboard ★ 3034 ⧗ 0](https://github.com/Freeboard/freeboard) ⭐ 6,504 | 🐛 166 | 🌐 JavaScript | 📅 2023-09-23** - A damn-sexy, open source real-time dashboard builder for IOT and other web mashups. A free open-source alternative to Geckoboard.
...
* [PULPino ★ 201 ⧗ 0](https://github.com/pulp-platform/pulpino) ⭐ 1,057 | 🐛 129 | 🌐 C | 📅 2024-02-06 - PULPino is an open-source microcontroller system, based on a small 32-bit RISC-V core developed at ETH Zurich.
...
* [Widora ★ 15 ⧗ 21](https://github.com/widora/openwrt_widora) ⭐ 174 | 🐛 5 | 🌐 C | 📅 2025-09-12 - Widora is open source WiFi development hardware prototype with sound card based on MT7688A running [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 27,970 | 🐛 4,318 | 🌐 C | 📅 2026-08-13.
...
* **[Homebridge ★ 3030 ⧗ 0](https://github.com/nfarina/homebridge) ⭐ 25,443 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-10** - Homebridge is a lightweight NodeJS server you can run on your home network that emulates the iOS HomeKit API.
* [Node-RED](https://github.com/node-red/node-red) ⭐ 23,521 | 🐛 319 | 🌐 JavaScript | 📅 2026-08-01 - Node-RED is a programming tool for wiring together hardware devices, APIs and online services in new and interesting ways.
* **[Smart Mirror ★ 1181 ⧗ 0](https://github.com/evancohen/smart-mirror) ⭐ 2,818 | 🐛 19 | 🌐 JavaScript | 📅 2024-07-02** - The fairest of them all. A DIY voice controlled smart mirror with IoT integration.
...
* **[heimcontrol.js ★ 1306 ⧗ 4](https://github.com/ni-c/heimcontrol.js) ⚠️ Archived** -  Home-Automation with node.js and Raspberry PI
* **[openHAB ★ 2536 ⧗ 0](https://github.com/openhab/openhab-distro) ⭐ 1,389 | 🐛 71 | 🌐 PowerShell | 📅 2026-08-10** - a vendor and technology agnostic open source automation software for your home.
...
* [Pimatic ★ 362 ⧗ 0](https://github.com/pimatic/pimatic) ⭐ 599 | 🐛 202 | 🌐 CoffeeScript | 📅 2022-10-21 - A home automation server and framework for the raspberry pi running on node.js.
...
* [homebridge-blink-security](https://github.com/BitWise-0x/homebridge-blink-security) ⭐ 12 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-07 - Homebridge plugin for Blink cameras, doorbells, and sirens with live streaming, arm/disarm, and motion detection via Apple HomeKit.
* [homebridge-smartrent](https://github.com/BitWise-0x/homebridge-smartrent) ⭐ 4 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-11 - Homebridge plugin for SmartRent locks, thermostats, leak sensors, and switches with real-time WebSocket updates via Apple HomeKit.
* [ZHAC](https://github.com/zhac-project/zhac-platform) ⭐ 0 | 🐛 0 | 🌐 Just | 📅 2026-07-19 - A dual-chip ESP32-P4 + ESP32-S3 Zigbee home automation controller with a Lua rule engine, local web UI, and MQTT gateway.
...
* **[Stino ★ 1280 ⧗ 1](https://github.com/Robot-Will/Stino) ⭐ 1,568 | 🐛 94 | 🌐 Python | 📅 2023-01-21** -  is a Sublime Text plugin that provides an Arduino-like environment for editing, compiling and uploading sketches.
...
* [DevIoT ★ 70 ⧗ 1](https://github.com/gepd/Deviot) ⭐ 310 | 🐛 93 | 🌐 Python | 📅 2024-01-15 - Sublime Text plugin for IoT development.
...
* **[AirSim ★ 2606 ⧗ 1](https://github.com/Microsoft/AirSim) ⭐ 18,393 | 🐛 780 | 🌐 C++ | 📅 2026-06-30** -  is a simulator for drones (and soon other vehicles) built on Unreal Engine.
* **[hubot ★ 10481 ⧗ 0](https://github.com/github/hubot) ⭐ 16,794 | 🐛 6 | 🌐 JavaScript | 📅 2026-07-22** - A customizable life embetterment robot.
* **[artoo ★ 1269 ⧗ 0](https://github.com/hybridgroup/artoo) ⭐ 1,545 | 🐛 21 | 🌐 Ruby | 📅 2023-12-19** - Ruby framework for robotics and the Internet of Things.

## Others

for embedded systems (IoT in mind).

* **[Sonoff-Tasmota ★ 4869 ⧗ 0](https://github.com/arendst/Sonoff-Tasmota) ⭐ 24,688 | 🐛 13 | 🌐 C | 📅 2026-08-12** - Provide ESP8266 based itead Sonoff with Web, MQTT and OTA firmware using Arduino IDE.
* **[Node-RED ★ 2513 ⧗ 0](https://github.com/node-red/node-red) ⭐ 23,521 | 🐛 319 | 🌐 JavaScript | 📅 2026-08-01** - A visual tool for wiring the Internet of Things.
* **[ESP8266 Deauther ★ 3806 ⧗ 0](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,914 | 🐛 99 | 🌐 C | 📅 2024-08-14** -  allows you to perform a deauth attack with an ESP8266 against selected networks.
* [fluent-bit ★ 90 ⧗ 4](https://github.com/fluent/fluent-bit) ⭐ 8,029 | 🐛 768 | 🌐 C | 📅 2026-08-13 - is a data collector for Linux, Embedded Linux, OSX and BSD family operating systems.
...
* [Emul8 ★ 50 ⧗ 71](https://github.com/emul8/emul8) ⭐ 114 | 🐛 2 | 🌐 C# | 📅 2017-11-13 - is an emulator of various embedded systems. With Emul8 you can develop embedded software entirely in a virtual environment that runs within your PC.
...
* [boto3-refresh-session](https://github.com/michaelthomasletts/boto3-refresh-session) ⭐ 52 | 🐛 1 | 🌐 Python | 📅 2026-08-11 - A drop-in replacement for `boto3.session.Session` for automatically refreshing temporary AWS credentials from the AWS IoT Core credential provider (using an X.509 certificate).
...
* [FoundryNet Canonical Schema](https://github.com/FoundryNet/canonical-schema) ⭐ 0 | 🐛 0 | 📅 2026-08-11 - Open universal schema for industrial equipment telemetry normalization. 366 canonical fields, 16,908 cross-vendor mappings across 18 OEM families. MIT licensed.
...
* **[MicroPython ★ 3070 ⧗ 0](https://github.com/micropython/micropython) ⭐ 21,986 | 🐛 1,545 | 🌐 C | 📅 2026-08-13** - MicroPython is a lean and fast implementation of the Python 3 programming language that is optimised to run on a microcontroller.
* **[JerryScript ★ 1244 ⧗ 0](https://github.com/Samsung/jerryscript) ⭐ 7,414 | 🐛 246 | 🌐 C | 📅 2025-10-08** - A JavaScript engine for Internet of Things.
* **[luvit ★ 2237 ⧗ 0](https://github.com/luvit/luvit) ⭐ 3,959 | 🐛 95 | 🌐 Lua | 📅 2026-04-02** - Node.JS for the Lua Inventor.
* **[Terra ★ 1248 ⧗ 0](https://github.com/zdevito/terra) ⭐ 2,900 | 🐛 101 | 🌐 C++ | 📅 2026-08-10** - is a low-level system programming language that is embedded in and meta-programmed by the Lua programming language.
* [AtomVM ★ 390 ⧗ 0](https://github.com/bettio/AtomVM) ⭐ 2,195 | 🐛 178 | 🌐 Erlang | 📅 2026-07-31 - AtomVM is a tiny portable virtual machine that allows Erlang and Elixir code to run on microcontrollers with less than 500KB of RAM such as the ESP32.
* **[PikaScript ★ 660 ⧗ 36](https://github.com/pikasTech/pikaScript) ⭐ 1,743 | 🐛 28 | 🌐 C | 📅 2026-08-07** - PikaScript is a extremely lightweight python engine that can run with less than 4KB of RAM such as stm32g030c8 and stm32f103c8. It is zero dependency, zero configuration, easy to deploy and expand.
...
* [eLua ★ 393 ⧗ 1](https://github.com/elua/elua) ⭐ 980 | 🐛 41 | 🌐 C | 📅 2024-03-25 - Quickly prototype and develop embedded software applications with the power of Lua and run them on a wide range of microcontroller architectures.
* [ESP Basic ★ 144 ⧗ 0](https://github.com/esp8266/Basic) ⭐ 265 | 🐛 14 | 🌐 C | 📅 2017-10-18 - Basic Interpreter for the ESP8266
...
* **[mbed TLS ★ 601 ⧗ 0](https://github.com/ARMmbed/mbedtls) ⭐ 6,868 | 🐛 1,734 | 🌐 C | 📅 2026-08-04** - An open source, portable, easy to use, readable and flexible SSL library
* **[UniK ★ 593 ⧗ 0](https://github.com/emc-advanced-dev/unik) ⭐ 2,820 | 🐛 51 | 🌐 Go | 📅 2023-04-27** -  is a tool for compiling application sources into unikernels (lightweight bootable disk images) rather than binaries.
...
* **[EMQX ★ 10300 ⧗ 1800](https://github.com/emqx/emqx) ⭐ 16,616 | 🐛 253 | 🌐 Erlang | 📅 2026-08-12** - An ultra-scalable open-source MQTT broker. Connect 100M+ IoT devices in one single cluster, move and process real-time IoT data with 1M msg/s throughput at 1ms latency.
* [Mosquitto ★ 158 ⧗ 0](https://github.com/eclipse/mosquitto) ⭐ 11,113 | 🐛 864 | 🌐 C | 📅 2026-07-30 - An Open Source MQTT v3.1/v3.1.1 Broker.
* **[MQTT.js ★ 1359 ⧗ 0](https://github.com/mqttjs/MQTT.js) ⭐ 9,105 | 🐛 34 | 🌐 TypeScript | 📅 2026-07-20** - The MQTT client for Node.js and the browser.
...
* **[VerneMQ ★ 561 ⧗ 1](https://github.com/erlio/vernemq) ⭐ 3,619 | 🐛 161 | 🌐 Erlang | 📅 2026-08-09** - A distributed MQTT message broker.
...
* [moquette ★ 2239 ⧗ 2](https://github.com/moquette-io/moquette) ⭐ 2,450 | 🐛 138 | 🌐 Java | 📅 2026-08-01 - Java MQTT lightweight broker.
* [Eclipse Paho MQTT C client ★ 142 ⧗ 3](https://github.com/eclipse/paho.mqtt.c) ⭐ 2,345 | 🐛 210 | 🌐 C | 📅 2026-07-21 - This code builds libraries which enable applications to connect to an MQTT broker to publish messages, and to subscribe to topics and receive published messages.
...
* [Java mqtt-client ★ 405 ⧗ 2](https://github.com/fusesource/mqtt-client) ⭐ 1,278 | 🐛 91 | 🌐 Java | 📅 2021-09-15 - A Java MQTT Client.
...
* [ESP8266 MQTT ★ 440 ⧗ 0](https://github.com/tuanpmt/esp_mqtt) ⭐ 1,172 | 🐛 41 | 🌐 C | 📅 2020-12-22 - MQTT client library for ESP8266 Soc
* [arduino-mqtt ★ 95 ⧗ 6](https://github.com/256dpi/arduino-mqtt) ⭐ 1,091 | 🐛 24 | 🌐 C | 📅 2026-04-16 - MQTT library for Arduino based on the Eclipse Paho projects.
* [MQTT-C ★ 52 ⧗ 2](https://github.com/LiamBindle/MQTT-C) ⭐ 895 | 🐛 42 | 🌐 C | 📅 2024-05-12 - A portable MQTT C client for embedded systems and PCs alike.
* [WolfSSL MQTT ★ 155 ⧗ 14](https://github.com/wolfSSL/wolfMQTT) ⭐ 590 | 🐛 8 | 🌐 C | 📅 2026-08-12 - A C MQTT library that works with WolfSSL.
...
* [strong-pubsub ★ 97 ⧗ 1](https://github.com/strongloop/strong-pubsub) ⭐ 128 | 🐛 0 | 🌐 JavaScript | 📅 2020-02-06 - PubSub for Node.js, Browser, Mobile and IoT
...
* [Californium ★ 36 ⧗ 0](https://github.com/eclipse/californium) ⭐ 775 | 🐛 19 | 🌐 Java | 📅 2026-08-12 - Californium is a Java implementation of CoAP for the IoT backend and less constrained IoT devices.
* [Node CoAP ★ 176 ⧗ 11](https://github.com/mcollina/node-coap) ⭐ 550 | 🐛 21 | 🌐 TypeScript | 📅 2026-08-12 - node-coap is a client and server library for CoAP modeled after the http module.
...
* [java-coap ★ 3 ⧗ 0](https://github.com/open-coap/java-coap) ⭐ 34 | 🐛 8 | 🌐 Java | 📅 2026-08-03 - Complete CoAP implementation in java (it is a fork with lots of improvements).
...
* [LowCostLoRaGw ★ 161 ⧗ 4](https://github.com/CongducPham/LowCostLoRaGw) ⭐ 745 | 🐛 229 | 🌐 C | 📅 2026-04-21 - Low-cost LoRa IoT & gateway with SX1272/76, Raspberry and Arduino.
* [LoRa Gateway Bridge ★ 78 ⧗ 0](https://github.com/brocaar/lora-gateway-bridge) ⭐ 446 | 🐛 20 | 🌐 Go | 📅 2026-07-10 - is a service which abstracts the packet\_forwarder UDP protocol running on most LoRa gateways into JSON over MQTT.
...
* **[OpenThread ★ 1139 ⧗ 2](https://github.com/openthread/openthread) ⭐ 4,012 | 🐛 165 | 🌐 C++ | 📅 2026-08-13** - OpenThread is an open-source implementation of the Thread networking protocol.
* [OpenThread Border Router ★ 64 ⧗ 0](https://github.com/openthread/borderrouter) ⭐ 562 | 🐛 69 | 🌐 C++ | 📅 2026-08-12 - An open source border router, built to work with OpenThread.

### Others

* **[libimobiledevice ★ 2294 ⧗ 0](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,101 | 🐛 840 | 🌐 C | 📅 2026-06-10** - A library to communicate with services of Apple iOS devices using native protocols.
* **[MeQ ★ 920 ⧗ 1](https://github.com/teamsaas/meq) ⭐ 3,966 | 🐛 46 | 🌐 TypeScript | 📅 2025-03-04** - is a real-time communication service for connecting online devices.
* [Anjay ★ 16 ⧗ 23](https://github.com/AVSystem/Anjay) ⭐ 218 | 🐛 0 | 🌐 C | 📅 2026-07-09 - is a C library that aims to be the reference implementation of the OMA Lightweight Machine-to-Machine (LwM2M) device management protocol.
...
* [libmodbus ★ 2400 ⧗ 50](https://github.com/stephane/libmodbus) ⭐ 4,229 | 🐛 187 | 🌐 C | 📅 2026-07-02 - A Modbus library for Linux, Mac OS, FreeBSD, QNX and Windows, written in C.
* [pymodbus ★ 2400 ⧗ 100](https://github.com/pymodbus-dev/pymodbus) ⭐ 2,751 | 🐛 0 | 🌐 Python | 📅 2026-07-28 - A full Modbus protocol implementation for Python, supporting RTU, TCP, ASCII over serial and network transports.
* [aem-modbus-simulator ★ 0 ⧗ 0](https://github.com/leaberg69/aem-modbus-simulator) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-05-31 - Open-source Modbus RTU/TCP slave simulator for the LRI AEM-60DC8 industrial DC monitor. Mirrors 147 holding registers, supports six baudrates (4,800–115,200), TCP and Serial modes. Useful for SCADA/PLC integration testing without physical hardware.
...
* **[BluetoothSerial ★ 863 ⧗ 0](https://github.com/don/BluetoothSerial) ⭐ 1,086 | 🐛 85 | 🌐 Objective-C | 📅 2024-04-18** - Cordova (PhoneGap) Plugin for Serial Communication over Bluetooth
* [React Native Bluetooth Serial ★ 299 ⧗ 2](https://github.com/rusel1989/react-native-bluetooth-serial) ⭐ 484 | 🐛 92 | 🌐 Objective-C | 📅 2024-05-24 - React Native version of BluetoothSerial plugin. For both android and ios
* [BluetoothLinux](https://github.com/PureSwift/BluetoothLinux) ⭐ 192 | 🐛 2 | 🌐 Swift | 📅 2026-08-09  is a Pure Swift Linux Bluetooth Stack.
* [Theengs gateway](https://gateway.theengs.io) BLE to MQTT gateway compatible with over 90 Bluetooth sensors.

### NFC

* [libnfc ★ 119 ⧗ 4](https://github.com/nfc-tools/libnfc) ⭐ 1,984 | 🐛 120 | 🌐 C | 📅 2025-03-05 - Platform independent Near Field Communication library.
* [RFIDIOt ★ 314 ⧗ 6](https://github.com/AdamLaurie/RFIDIOt) ⭐ 1,115 | 🐛 23 | 🌐 Python | 📅 2024-10-25 - python RFID / NFC library & tools.
...
* [LibLogicalAccess ★ 53 ⧗ 17](https://github.com/islog/liblogicalaccess) ⭐ 271 | 🐛 17 | 🌐 C++ | 📅 2026-08-08 - C++ RFID Library for Windows/Linux/Mac. For PC/SC, NFC, ISO compliant and proprietary hardware.
...
* [rxtx ★ 67 ⧗ 4](https://github.com/rxtx/rxtx) ⭐ 340 | 🐛 22 | 🌐 C | 📅 2024-09-03 - a Java cross platform wrapper library for the serial port

### Others

* **[Servo ★ 7821 ⧗ 0](https://github.com/servo/servo) ⭐ 37,687 | 🐛 3,137 | 🌐 Rust | 📅 2026-08-13** -  is a prototype web browser engine written in the Rust language.
* **[Drake ★ 500 ⧗ 0](https://github.com/RobotLocomotion/drake) ⭐ 4,147 | 🐛 650 | 🌐 C++ | 📅 2026-08-13** -  is a toolbox maintained by the Robot Locomotion Group at the MIT Computer Science and Artificial Intelligence Lab (CSAIL).
* [ShellHub ★ 702 ⧗ 70](https://github.com/shellhub-io/shellhub) ⭐ 2,059 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-12 - Centralized SSH for the the edge and cloud computing.
* [The Things Stack ★ 887 ⧗ 4](https://github.com/TheThingsNetwork/lorawan-stack) ⭐ 1,160 | 🐛 191 | 🌐 Go | 📅 2026-08-12 - The Things Stack, an open source LoRaWAN network server created by The Things Industries. Creators of the global open crowdsourced Internet of Things data network The Things Network.
...
* [Balena ★ 329 ⧗ 3](https://github.com/resin-os/balena) ⭐ 742 | 🐛 95 | 🌐 Go | 📅 2026-08-12 -  is a new container engine purpose-built for embedded and IoT use cases and compatible with Docker containers.
* [WAMP Protocol ★ 228 ⧗ 1](https://github.com/wamp-proto/wamp-proto) ⭐ 489 | 🐛 131 | 🌐 Python | 📅 2026-07-03 - The Web Application Messaging Protocol The Web Application Messaging Protocol.
...
* **[Processing ★ 2644 ⧗ 0](https://github.com/processing/processing) ⭐ 6,485 | 🐛 0 | 🌐 Java | 📅 2026-07-15** - Processing is a flexible software sketchbook and a language for learning how to code within the context of the visual arts.
* [Copper ★ 46 ⧗ 14](https://github.com/mkovatsc/Copper) ⭐ 95 | 🐛 8 | 🌐 JavaScript | 📅 2018-10-18 - A Firefox add-on to browse the Internet of Things

## Tools

* [Smart.js ★ 487 ⧗ 0](https://github.com/cesanta/smart.js) ⭐ 2,661 | 🐛 97 | 🌐 C | 📅 2026-07-26 - Embedded Javascript engine for C/C++ with networking, file, database and device interfaces
...
* [Mer](https://github.com/iotmertech/iot-data-generator) ⭐ 15 | 🐛 0 | 🌐 Rust | 📅 2026-07-03 - A developer-friendly IoT test data generator CLI written in Rust. Supports MQTT, HTTP, and TCP for simulating realistic sensor payloads.
...
* **[Design IoT ★ 594 ⧗ 0](https://github.com/phodal/designiot) ⭐ 2,226 | 🐛 2 | 🌐 HTML | 📅 2021-06-25** - A Ebook to tech your create IoT System step by step.
* [IoT-Firstep ★ 24 ⧗ 9](https://github.com/nladuo/IoT-Firstep) ⭐ 767 | 🐛 0 | 🌐 Java | 📅 2019-04-20 - A Ebook to tech your create IoT System.
* [IPv6-WSN-Book](http://github.com/marcozennaro/IPv6-WSN-book) ⭐ 158 | 🐛 11 | 🌐 HTML | 📅 2018-05-31 - an easy guide to Wireless Sensor Networks (WSN), IPv6 and the Internet of Things (IoT).
...
* **[awesome-mqtt ★ 668 ⧗ 0](https://github.com/hobbyquaker/awesome-mqtt) ⭐ 2,383 | 🐛 0 | 📅 2026-08-10** - Curated list of MQTT related stuff.
...
* [Project Flogo ★ 207 ⧗ 0](https://github.com/TIBCOSoftware/flogo) ⭐ 2,491 | 🐛 128 | 🌐 CSS | 📅 2024-04-24 - is an Open Source Framework for IoT Edge Apps & Integration.
* **[AREG SDK ★ 15 ⧗ 0](https://github.com/aregtech/areg-sdk) ⭐ 362 | 🐛 39 | 🌐 C++ | 📅 2026-08-13** - AREG SDK is a developer-friendly, an interface-centric real-time asynchronous communication engine to enable distributed- and [mist-computing](https://csrc.nist.gov/publications/detail/sp/500-325/final), where connected Things interact and provide services, as if they act like thin distributed servers.
...
* **[NetData ★ 18973 ⧗ 0](https://github.com/firehol/netdata) ⭐ 80,154 | 🐛 382 | 🌐 Go | 📅 2026-08-13** - is a system for distributed real-time performance and health monitoring.
* **[Piwik ★ 5374 ⧗ 0](https://github.com/piwik/piwik) ⭐ 21,761 | 🐛 2,561 | 🌐 PHP | 📅 2026-08-13** - Piwik is the leading Free/Libre open analytics platform.
...
* [Eclipse Ditto](https://github.com/eclipse/ditto) ⭐ 914 | 🐛 100 | 🌐 Java | 📅 2026-08-11 is the open-source project of Eclipse IoT that provides a ready-to-use functionality to manage the state of Digital Twins.
...
* [souliss ★ 137 ⧗ 8](https://github.com/souliss/souliss) ⭐ 303 | 🐛 9 | 🌐 C | 📅 2026-02-21 - Arduino based Distributed Networking Framework for Smart Homes and IoT.
