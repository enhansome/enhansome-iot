...
* [WiringPi ★ 455 ⧗ 11](https://github.com/WiringPi/WiringPi) ⭐ 3,343 | 🐛 40 | 🌐 C | 📅 2026-09-02 - Gordon's Arduino wiring-like WiringPi Library for the Raspberry Pi.
...
* [United Manufacturing Hub ★ 9 ⧗ 0](https://github.com/united-manufacturing-hub/united-manufacturing-hub) ⭐ 392 | 🐛 22 | 🌐 Go | 📅 2026-09-25 - The Open-Source Manufacturing App Platform (combines various open source solutions and packages them in a Helm chart, for example nodered, VerneMQ and timescaleDB)
...
* [Renode ★ 81 ⧗ 0](https://github.com/renode/renode) ⭐ 2,938 | 🐛 457 | 🌐 RobotFramework | 📅 2026-09-25 - a virtual development tool for multinode embedded networks.
...
* [WolfSSL MQTT ★ 155 ⧗ 14](https://github.com/wolfSSL/wolfMQTT) ⭐ 594 | 🐛 6 | 🌐 C | 📅 2026-09-17 - A C MQTT library that works with WolfSSL.
...
* [java-coap ★ 3 ⧗ 0](https://github.com/open-coap/java-coap) ⭐ 34 | 🐛 15 | 🌐 Java | 📅 2026-09-25 - Complete CoAP implementation in java (it is a fork with lots of improvements).
...
* **[awesome-mqtt ★ 668 ⧗ 0](https://github.com/hobbyquaker/awesome-mqtt) ⭐ 2,399 | 🐛 0 | 📅 2026-09-25** - Curated list of MQTT related stuff.
...
* [Eclipse Ditto](https://github.com/eclipse/ditto) ⭐ 928 | 🐛 95 | 🌐 Java | 📅 2026-09-25 is the open-source project of Eclipse IoT that provides a ready-to-use functionality to manage the state of Digital Twins.
