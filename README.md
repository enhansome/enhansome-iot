...
* **[Serverless ★ 7951 ⧗ 0](https://github.com/serverless/serverless) ⭐ 46,921 | 🐛 1,217 | 🌐 JavaScript | 📅 2026-09-03** - Serverless is the application framework for building web, mobile and IoT applications exclusively on Amazon Web Services' Lambda and API Gateway.
* **[ESP-IDF ★ 2542 ⧗ 0](https://github.com/espressif/esp-idf) ⭐ 18,938 | 🐛 1,679 | 🌐 C | 📅 2026-09-03** - The official framework from Espressif to build Wi-Fi, BLE, and BT apps with ESP32.
...
* **[GoBot ★ 2062 ⧗ 1](https://github.com/hybridgroup/gobot) ⭐ 9,460 | 🐛 100 | 🌐 Go | 📅 2026-01-07** - Golang framework for robotics, physical computing, and the Internet of Things.
...
* [Thingsboard IoT Gateway ★ 463 ⧗ 246](https://github.com/thingsboard/thingsboard-gateway) ⭐ 2,180 | 🐛 84 | 🌐 Python | 📅 2026-09-03 - open-source IoT Gateway - integrates devices connected to legacy and third-party systems with Thingsboard IoT Platform using OPC-UA and MQTT protocols.
...
* [Kura ★ 85 ⧗ 1](https://github.com/eclipse/kura) ⭐ 574 | 🐛 20 | 🌐 Java | 📅 2026-09-03 - an open-source framework for development of IoT applications
...
* [Jumpstarter ★ 28 ⧗ 0](https://github.com/jumpstarter-dev/jumpstarter) ⭐ 215 | 🐛 179 | 🌐 Python | 📅 2026-09-03 - Open source hardware-in-the-loop testing framework for automated testing on real and virtual IoT hardware with CI/CD integration.
...
* **[ESP8266 Arduino Core ★ 2588 ⧗ 0](https://github.com/esp8266/Arduino) ⭐ 16,673 | 🐛 404 | 🌐 C++ | 📅 2026-08-27** - Arduino core for ESP8266 WiFi chip.

* [Armbian build SDK ★ 630](https://github.com/armbian/build) ⭐ 5,395 | 🐛 127 | 🌐 Shell | 📅 2026-09-03 - for creating customized kernel and Debian based userspace for popular development boards.

* [Microsoft Azure IoT SDK ★ 203 ⧗ 1](https://github.com/Azure/azure-iot-sdks) ⭐ 856 | 🐛 0 | 📅 2023-07-15 - SDKs for a variety of languages and platforms that help connect devices to Microsoft Azure IoT services.
...
* **[ArduinoJson ★ 873 ⧗ 0](https://github.com/bblanchon/ArduinoJson) ⭐ 7,209 | 🐛 17 | 🌐 C++ | 📅 2026-08-15** - An elegant and efficient JSON library for embedded systems.
* [WiringPi ★ 455 ⧗ 11](https://github.com/WiringPi/WiringPi) ⭐ 3,336 | 🐛 39 | 🌐 C | 📅 2026-09-02 - Gordon's Arduino wiring-like WiringPi Library for the Raspberry Pi.
...
* **[libui ★ 8021 ⧗ 1](https://github.com/andlabs/libui) ⭐ 10,897 | 🐛 249 | 🌐 C | 📅 2024-05-29** - Simple and portable (but not inflexible) GUI library in C that uses the native GUI technologies of each platform it supports.
* [LK ★ 312 ⧗ 0](https://github.com/littlekernel/lk) ⭐ 3,670 | 🐛 93 | 🌐 C | 📅 2026-09-02 - The LK embedded kernel. An SMP-aware kernel designed for small systems.
* [inih ★ 312 ⧗ 3](https://github.com/benhoyt/inih) ⭐ 3,039 | 🐛 6 | 🌐 C++ | 📅 2026-01-30 - is a simple .INI file parser written in C.
...
* **[simbody ★ 540 ⧗ 0](https://github.com/simbody/simbody) ⭐ 2,548 | 🐛 160 | 🌐 C++ | 📅 2026-09-02** - High-performance C++ multibody dynamics/physics library for simulating articulated biomechanical and mechanical systems like vehicles, robots, and the human skeleton.
...
* [btstack ★ 151 ⧗ 1](https://github.com/bluekitchen/btstack) ⭐ 2,133 | 🐛 76 | 🌐 C | 📅 2026-09-03 - Dual-mode Bluetooth stack, with small memory footprint.
* [MCUBoot ★ 43 ⧗ 3](https://github.com/runtimeco/mcuboot) ⭐ 2,063 | 🐛 93 | 🌐 C | 📅 2026-09-03 - is a secure bootloader for 32-bit MCUs.
* [CocoaMQTT ★ 210 ⧗ 0](https://github.com/emqtt/CocoaMQTT) ⭐ 1,751 | 🐛 112 | 🌐 Swift | 📅 2026-07-31 - MQTT for iOS and OS X written with Swift.
* [SPIFFS ★ 174 ⧗ 0](https://github.com/pellepl/spiffs) ⭐ 1,622 | 🐛 104 | 🌐 C | 📅 2026-07-16 - Wear-leveled SPI flash file system for embedded devices.
...
* [xkcptun ★ 104 ⧗ 25](https://github.com/liudf0716/xkcptun) ⭐ 479 | 🐛 11 | 🌐 C | 📅 2026-09-02 - xkcptun is kcp tunnel for OpenWRT\&LEDE, implemented in c language
...
* [MQTTX ★ 12 ⧗ 0](https://github.com/emqx/MQTTX) ⭐ 5,040 | 🐛 111 | 🌐 TypeScript | 📅 2026-08-17 - MQTTX is a cross-platform MQTT desktop client open sourced by EMQ, which supports macOS, Linux, and Windows. It allows users to quickly and easily test MQTT / MQTTS connections, publish and subscribe to MQTT messages.
...
* [AimDB ★ 2](https://github.com/aimdb-dev/aimdb) ⭐ 98 | 🐛 5 | 🌐 Rust | 📅 2026-09-02 - An async, in-memory data bridge that syncs records across microcontrollers, edge gateways and cloud instances. Define once, stream and sync everywhere.
...
* [Scanners-Box ★ 424 ⧗ 0](https://github.com/We5ter/Scanners-Box) ⭐ 9,035 | 🐛 1 | 📅 2026-08-12 - the toolbox of open source scanners.
...
* [OpenWrt ★ 230 ⧗ 173](https://github.com/openwrt/openwrt) ⭐ 28,244 | 🐛 4,434 | 🌐 C | 📅 2026-09-03 - OpenWrt is described as a Linux distribution for embedded devices.

* [Zephyr ★ 352 ⧗ 5](https://github.com/zephyrproject-rtos/zephyr) ⭐ 16,394 | 🐛 3,892 | 🌐 C | 📅 2026-09-03 -  is a small, scalable real-time operating system for use on resource-constrained systems supporting multiple architectures.

* [RT-Thread ★ 493 ⧗ 0](https://github.com/RT-Thread/rt-thread) ⭐ 12,189 | 🐛 493 | 🌐 C | 📅 2026-09-03 - RT-Thread is an open source real-time operating system for embedded devices from China.
...
* [Tock OS ★ 243 ⧗ 1](https://github.com/helena-project/tock) ⭐ 6,434 | 🐛 206 | 🌐 Rust | 📅 2026-09-03 -  is an operating system designed for running multiple concurrent, mutually distrustful applications on Cortex-M based embedded platforms.

* **[RIOT ★ 748 ⧗ 1](https://github.com/RIOT-OS/RIOT) ⭐ 5,783 | 🐛 875 | 🌐 C | 📅 2026-09-03** - The friendly Operating System for the Internet of Things

* **[seL4 Microkernel ★ 1344 ⧗ 1](https://github.com/seL4/seL4) ⭐ 5,732 | 🐛 215 | 🌐 C | 📅 2026-08-25** - The world's first operating-system kernel with an end-to-end proof of implementation correctness and security enforcement is available as open source.
...
* [TinyAra ★ 35 ⧗ 1](https://github.com/Samsung/TinyAra) ⭐ 648 | 🐛 219 | 🌐 C | 📅 2026-09-03 - is a lightweight RTOS-based platform to support low-end IoT devices.
...
* **[Thingsboard ★ 5102 ⧗ 1700](https://github.com/thingsboard/thingsboard) ⭐ 22,356 | 🐛 295 | 🌐 Java | 📅 2026-09-03** - Open-source IoT Platform - Device management, data collection, processing and visualization.
* **[PlatformIO ★ 980 ⧗ 0](https://github.com/platformio/platformio) ⭐ 9,436 | 🐛 314 | 🌐 Python | 📅 2026-08-28** - PlatformIO is a cross-platform code builder and the missing library manager.
* [Fuxa SCADA/HMI/Dashboard ★ 2115 ⧗ 632](https://github.com/frangoteam/FUXA) ⭐ 4,973 | 🐛 397 | 🌐 TypeScript | 📅 2026-09-03 - FUXA is a web-based Process Visualization (SCADA/HMI/Dashboard) software. With FUXA you can create modern process visualizations/dashboards with individual designs for your machines/IOT application with real-time data display. Supports MQTT, OPC-UA, Modbus RTU/TCP, Siemens S7 Protocol, BACnet IP, Ethernet/IP (Allen Bradley), WebAPI
...
* [HiveMQ ★ 329 ⧗ 0](https://github.com/hivemq/hivemq-community-edition) ⭐ 1,207 | 🐛 27 | 🌐 Java | 📅 2026-09-03 - is an open source MQTT platform and MQTT broker.
* **[IoT DC3 ★ 650 ⧗ 0](https://github.com/pnoker/iot-dc3) ⭐ 1,194 | 🐛 33 | 🌐 Java | 📅 2026-09-03** - A fully open-source, distributed industrial IoT platform built on Spring Cloud, evolving for AI scenarios. Enables rapid IoT project development and connected-device management. [(Docs)](https://docs.dc3.site)
...
* [United Manufacturing Hub ★ 9 ⧗ 0](https://github.com/united-manufacturing-hub/united-manufacturing-hub) ⭐ 393 | 🐛 22 | 🌐 Go | 📅 2026-09-03 - The Open-Source Manufacturing App Platform (combines various open source solutions and packages them in a Helm chart, for example nodered, VerneMQ and timescaleDB)
...
* [Mobius ★ 46 ⧗ 2](https://github.com/IoTKETI/Mobius) ⭐ 151 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-03 -  is the open source IoT server platform based on the oneM2M standard.
...
* [DeviceChain](https://github.com/devicechain-io/devicechain) ⭐ 3 | 🐛 6 | 🌐 Go | 📅 2026-09-03 - Apache-2.0 self-hosted IoT platform written in Go and React. Multi-tenant microservices on Kubernetes: MQTT/Sparkplug B/LwM2M ingest, TimescaleDB time-series storage, a CEL-based rule engine with alarms and outbound connectors, versioned dashboards, and GraphQL APIs. [(Docs)](https://docs.devicechain.io)
...
* [IoTSharp](https://github.com/IoTSharp/IoTSharp) ⭐ 1,373 | 🐛 5 | 🌐 C# | 📅 2026-08-26 - IoTSharp is an open-source IoT platform.
...
* [Zilla](https://github.com/aklivity/zilla) ⭐ 1,731 | 🐛 247 | 🌐 Java | 📅 2026-09-03 - A Multi-protocol event-native edge/service proxy that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol.
...
* [SiteWhere ★ 61 ⧗ 0](https://github.com/sitewhere/sitewhere) ⭐ 1,047 | 🐛 124 | 🌐 Java | 📅 2026-07-31 - SiteWhere open-source IoT platform for device connectivity & management, data persistence, processing, integration, and analytics -- both in cloud and on-premise.
...
* [Renode ★ 81 ⧗ 0](https://github.com/renode/renode) ⭐ 2,831 | 🐛 432 | 🌐 RobotFramework | 📅 2026-09-03 - a virtual development tool for multinode embedded networks.
...
* **[D3.JS ★ 49188 ⧗ 0](https://github.com/mbostock/d3) ⭐ 113,602 | 🐛 20 | 🌐 Shell | 📅 2026-05-28** - A JavaScript visualization library for HTML and SVG
* **[ECharts ★ 11457 ⧗ 0](https://github.com/ecomfe/echarts) ⭐ 67,227 | 🐛 1,526 | 🌐 TypeScript | 📅 2026-09-03** - Echarts is a commercial charting solution originally intended to address the report need of the Company's various business systems.
* **[HighCharts ★ 4949 ⧗ 0](https://github.com/highslide-software/highcharts.com) ⭐ 12,485 | 🐛 822 | 🌐 TypeScript | 📅 2026-09-03** - Highcharts JS, the JavaScript charting framework
...
* [Widora ★ 15 ⧗ 21](https://github.com/widora/openwrt_widora) ⭐ 174 | 🐛 5 | 🌐 C | 📅 2025-09-12 - Widora is open source WiFi development hardware prototype with sound card based on MT7688A running [OpenWrt](https://github.com/openwrt/openwrt) ⭐ 28,244 | 🐛 4,434 | 🌐 C | 📅 2026-09-03.
...
* [Node-RED](https://github.com/node-red/node-red) ⭐ 23,615 | 🐛 323 | 🌐 JavaScript | 📅 2026-09-01 - Node-RED is a programming tool for wiring together hardware devices, APIs and online services in new and interesting ways.
...
* **[heimcontrol.js ★ 1306 ⧗ 4](https://github.com/ni-c/heimcontrol.js) ⚠️ Archived** -  Home-Automation with node.js and Raspberry PI
* **[openHAB ★ 2536 ⧗ 0](https://github.com/openhab/openhab-distro) ⭐ 1,390 | 🐛 74 | 🌐 PowerShell | 📅 2026-08-30** - a vendor and technology agnostic open source automation software for your home.
...
* [ble-scale-sync](https://github.com/KristianP26/ble-scale-sync) ⭐ 166 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-01 - Cross-platform Node.js service that reads BLE smart scales, calculates body composition, and exports readings to MQTT with Home Assistant auto-discovery, InfluxDB, Garmin Connect, and webhooks.
...
* [homebridge-blink-security](https://github.com/BitWise-0x/homebridge-blink-security) ⭐ 14 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-02 - Homebridge plugin for Blink cameras, doorbells, and sirens with live streaming, arm/disarm, and motion detection via Apple HomeKit.
* [homebridge-smartrent](https://github.com/BitWise-0x/homebridge-smartrent) ⭐ 4 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-02 - Homebridge plugin for SmartRent locks, thermostats, leak sensors, and switches with real-time WebSocket updates via Apple HomeKit.
...
* **[AirSim ★ 2606 ⧗ 1](https://github.com/Microsoft/AirSim) ⭐ 18,439 | 🐛 780 | 🌐 C++ | 📅 2026-06-30** -  is a simulator for drones (and soon other vehicles) built on Unreal Engine.
...
* **[Sonoff-Tasmota ★ 4869 ⧗ 0](https://github.com/arendst/Sonoff-Tasmota) ⭐ 24,736 | 🐛 17 | 🌐 C | 📅 2026-09-03** - Provide ESP8266 based itead Sonoff with Web, MQTT and OTA firmware using Arduino IDE.
* **[Node-RED ★ 2513 ⧗ 0](https://github.com/node-red/node-red) ⭐ 23,615 | 🐛 323 | 🌐 JavaScript | 📅 2026-09-01** - A visual tool for wiring the Internet of Things.
* **[ESP8266 Deauther ★ 3806 ⧗ 0](https://github.com/spacehuhn/esp8266_deauther) ⭐ 14,953 | 🐛 99 | 🌐 C | 📅 2024-08-14** -  allows you to perform a deauth attack with an ESP8266 against selected networks.
* [fluent-bit ★ 90 ⧗ 4](https://github.com/fluent/fluent-bit) ⭐ 8,075 | 🐛 771 | 🌐 C | 📅 2026-09-03 - is a data collector for Linux, Embedded Linux, OSX and BSD family operating systems.
...
* **[MicroPython ★ 3070 ⧗ 0](https://github.com/micropython/micropython) ⭐ 22,040 | 🐛 1,532 | 🌐 C | 📅 2026-09-03** - MicroPython is a lean and fast implementation of the Python 3 programming language that is optimised to run on a microcontroller.
...
* **[Terra ★ 1248 ⧗ 0](https://github.com/zdevito/terra) ⭐ 2,909 | 🐛 101 | 🌐 C++ | 📅 2026-08-19** - is a low-level system programming language that is embedded in and meta-programmed by the Lua programming language.
* [AtomVM ★ 390 ⧗ 0](https://github.com/bettio/AtomVM) ⭐ 2,222 | 🐛 182 | 🌐 Erlang | 📅 2026-07-31 - AtomVM is a tiny portable virtual machine that allows Erlang and Elixir code to run on microcontrollers with less than 500KB of RAM such as the ESP32.
...
* [eLua ★ 393 ⧗ 1](https://github.com/elua/elua) ⭐ 983 | 🐛 41 | 🌐 C | 📅 2024-03-25 - Quickly prototype and develop embedded software applications with the power of Lua and run them on a wide range of microcontroller architectures.
...
* **[mbed TLS ★ 601 ⧗ 0](https://github.com/ARMmbed/mbedtls) ⭐ 6,936 | 🐛 1,722 | 🌐 C | 📅 2026-09-03** - An open source, portable, easy to use, readable and flexible SSL library
...
* **[EMQX ★ 10300 ⧗ 1800](https://github.com/emqx/emqx) ⭐ 16,686 | 🐛 181 | 🌐 Erlang | 📅 2026-09-03** - An ultra-scalable open-source MQTT broker. Connect 100M+ IoT devices in one single cluster, move and process real-time IoT data with 1M msg/s throughput at 1ms latency.
* [Mosquitto ★ 158 ⧗ 0](https://github.com/eclipse/mosquitto) ⭐ 11,176 | 🐛 877 | 🌐 C | 📅 2026-09-03 - An Open Source MQTT v3.1/v3.1.1 Broker.
* **[MQTT.js ★ 1359 ⧗ 0](https://github.com/mqttjs/MQTT.js) ⭐ 9,110 | 🐛 35 | 🌐 TypeScript | 📅 2026-07-20** - The MQTT client for Node.js and the browser.
...
* **[VerneMQ ★ 561 ⧗ 1](https://github.com/erlio/vernemq) ⭐ 3,626 | 🐛 168 | 🌐 Erlang | 📅 2026-09-02** - A distributed MQTT message broker.
...
* [Eclipse Paho MQTT C client ★ 142 ⧗ 3](https://github.com/eclipse/paho.mqtt.c) ⭐ 2,362 | 🐛 214 | 🌐 C | 📅 2026-07-21 - This code builds libraries which enable applications to connect to an MQTT broker to publish messages, and to subscribe to topics and receive published messages.
...
* [arduino-mqtt ★ 95 ⧗ 6](https://github.com/256dpi/arduino-mqtt) ⭐ 1,092 | 🐛 24 | 🌐 C | 📅 2026-04-16 - MQTT library for Arduino based on the Eclipse Paho projects.
...
* [WolfSSL MQTT ★ 155 ⧗ 14](https://github.com/wolfSSL/wolfMQTT) ⭐ 593 | 🐛 2 | 🌐 C | 📅 2026-08-26 - A C MQTT library that works with WolfSSL.
...
* [java-coap ★ 3 ⧗ 0](https://github.com/open-coap/java-coap) ⭐ 34 | 🐛 8 | 🌐 Java | 📅 2026-09-03 - Complete CoAP implementation in java (it is a fork with lots of improvements).
...
* **[OpenThread ★ 1139 ⧗ 2](https://github.com/openthread/openthread) ⭐ 4,025 | 🐛 164 | 🌐 C++ | 📅 2026-09-03** - OpenThread is an open-source implementation of the Thread networking protocol.
* [OpenThread Border Router ★ 64 ⧗ 0](https://github.com/openthread/borderrouter) ⭐ 566 | 🐛 49 | 🌐 C++ | 📅 2026-09-02 - An open source border router, built to work with OpenThread.

### Others

* **[libimobiledevice ★ 2294 ⧗ 0](https://github.com/libimobiledevice/libimobiledevice) ⭐ 8,171 | 🐛 848 | 🌐 C | 📅 2026-06-10** - A library to communicate with services of Apple iOS devices using native protocols.
...
* [pymodbus ★ 2400 ⧗ 100](https://github.com/pymodbus-dev/pymodbus) ⭐ 2,763 | 🐛 0 | 🌐 Python | 📅 2026-09-02 - A full Modbus protocol implementation for Python, supporting RTU, TCP, ASCII over serial and network transports.
...
* [libnfc ★ 119 ⧗ 4](https://github.com/nfc-tools/libnfc) ⭐ 1,986 | 🐛 120 | 🌐 C | 📅 2025-03-05 - Platform independent Near Field Communication library.
...
* [LibLogicalAccess ★ 53 ⧗ 17](https://github.com/islog/liblogicalaccess) ⭐ 273 | 🐛 17 | 🌐 C++ | 📅 2026-08-17 - C++ RFID Library for Windows/Linux/Mac. For PC/SC, NFC, ISO compliant and proprietary hardware.
...
* **[Servo ★ 7821 ⧗ 0](https://github.com/servo/servo) ⭐ 37,897 | 🐛 3,184 | 🌐 Rust | 📅 2026-09-03** -  is a prototype web browser engine written in the Rust language.
* **[Drake ★ 500 ⧗ 0](https://github.com/RobotLocomotion/drake) ⭐ 4,171 | 🐛 671 | 🌐 C++ | 📅 2026-09-03** -  is a toolbox maintained by the Robot Locomotion Group at the MIT Computer Science and Artificial Intelligence Lab (CSAIL).
* [ShellHub ★ 702 ⧗ 70](https://github.com/shellhub-io/shellhub) ⭐ 2,064 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-03 - Centralized SSH for the the edge and cloud computing.
* [The Things Stack ★ 887 ⧗ 4](https://github.com/TheThingsNetwork/lorawan-stack) ⭐ 1,161 | 🐛 184 | 🌐 Go | 📅 2026-09-03 - The Things Stack, an open source LoRaWAN network server created by The Things Industries. Creators of the global open crowdsourced Internet of Things data network The Things Network.
...
* **[awesome-mqtt ★ 668 ⧗ 0](https://github.com/hobbyquaker/awesome-mqtt) ⭐ 2,390 | 🐛 0 | 📅 2026-09-01** - Curated list of MQTT related stuff.
...
* [100 Days 100 IoT Projects](https://github.com/kritishmohapatra/100_Days_100_IoT_Projects) ⭐ 1,063 | 🐛 0 | 🌐 Python | 📅 2026-07-17 - A 100-day challenge building real-world IoT projects with MicroPython on ESP32, ESP8266 and Raspberry Pi Pico 2W. Step-by-step documented with wiring diagrams and code for beginners.
...
* [CosmoEdge](https://github.com/cosmo-wander-ai/cosmo-edge) ⭐ 653 | 🐛 10 | 🌐 C | 📅 2026-09-03 - Production-oriented C++ edge video AI engine that connects RTSP streams to CV/VLM inference, visual orchestration, alarms, and MQTT/webhook events on Sophon and Rockchip NPUs.
...
* **[NetData ★ 18973 ⧗ 0](https://github.com/firehol/netdata) ⭐ 80,421 | 🐛 404 | 🌐 Go | 📅 2026-09-03** - is a system for distributed real-time performance and health monitoring.
* **[Piwik ★ 5374 ⧗ 0](https://github.com/piwik/piwik) ⭐ 21,837 | 🐛 2,575 | 🌐 PHP | 📅 2026-09-03** - Piwik is the leading Free/Libre open analytics platform.
...
* [Eclipse Ditto](https://github.com/eclipse/ditto) ⭐ 921 | 🐛 87 | 🌐 Java | 📅 2026-09-02 is the open-source project of Eclipse IoT that provides a ready-to-use functionality to manage the state of Digital Twins.
